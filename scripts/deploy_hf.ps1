...
git lfs track "downloads/MiniMax-H3-4Koma-Fused4Step-SLA-Bundle-2026-09-06.zip"
if ($LASTEXITCODE -ne 0) {
...
$HfBytePreservationRules = @(
    "workflows/Super-FURU-AI-4koma-H3-Hybrid-b25-Fused4Step-SLA-2026-09-06.json -text",
    "downloads/MiniMax-H3-4Koma-Fused4Step-SLA-Bundle-2026-09-06.zip.sha256.txt -text"
)
