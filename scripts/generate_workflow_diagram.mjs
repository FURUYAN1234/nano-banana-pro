...
${card({ x: 70, y: 493, w: 654, h: 84, color: '#2475b9', number: '3', title: 'STEP3 Assemble Prompt / 描写を組み立てる', detail: ['Four wide panels stacked; separate printable dialogue from speaker metadata', '横長4コマ縦1列。台詞本文と話者情報を分離し、衣装の連続性を保持'] })}${arrow(397, 578, 397, 598)}
...
${arrow(397, 780, 397, 929, '#219679')}${card({ x: 70, y: 930, w: 654, h: 78, color: '#219679', number: '6', title: 'Generation History & Selection / 生成履歴と選択', detail: ['One final image per run; up to 10 / 生成ごとの最終採用画像を最大10件保持'] })}${arrow(397, 1009, 397, 1029, '#219679')}
...
${card({ x: 70, y: 664, w: 654, h: 83, color: '#8653b8', number: '5', title: 'Build the Rendering Contract / 描画契約を組み立てる', detail: ['Vertical dialogue, speaker routing, stacked panels and wardrobe continuity', '縦書き台詞と話者情報を分離。横長4コマ縦1列・衣装共有・右→左の読順'] })}${arrow(397, 748, 397, 765)}
