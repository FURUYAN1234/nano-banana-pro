...
本ツールは創作支援を目的としたものであり、特定の既存作品の再現や複製を目的とした利用は想定していません。

ユーザーは、本ツールを使用して生成されたコンテンツについて、以下の行為を行ってはなりません。

#### 1. 著作権侵害となる生成行為
- 既存の漫画・アニメ・小説・映画・ゲーム等の著作物を、実質的に再現・模倣する行為
- 特定の作品、キャラクター、作家の作風を識別可能なレベルで再現する行為
- 既存作品の構図、セリフ、デザイン、ストーリー等を無断で流用する行為

#### 2. 権利侵害コンテンツの利用・配布
- 第三者の著作権、商標権、肖像権、パブリシティ権を侵害するコンテンツの公開、販売、共有
- 権利者の許可なく、既存IPに類似したコンテンツを商用利用する行為

#### 3. 不正利用の助長
- 権利侵害を目的としたプロンプト設計やテンプレートの作成・共有
- 他者に対して著作権侵害コンテンツの生成を促す行為
...
ユーザーは、適用される各国の著作権法および関連法規を遵守する責任を負います。
