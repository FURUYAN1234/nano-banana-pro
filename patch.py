...
pattern = re.compile(r'\{\/\* NEW STICKY TOP PROGRESS BAR \*\/}.*?<main className="space-y-8" style=\{\{ filter: apiKey \? \'none\' : \'blur\(10px\)\', pointerEvents: apiKey \? \'auto\' : \'none\', transition: \'filter 0\.5s ease\' \}\}>', re.DOTALL)
            ...
            <div className="flex flex-col items-center w-full md:w-auto">
              ...
              >
                {isFullAutoMode ? (
                  ...
                  <><Zap size={16} className={castList ? "text-yellow-300" : ""} /> 全自動生成モード（STP2~4連鎖）</>
                )}
              </button>
