...
function App() {
  ...
  const SYSTEM_VERSION = "v1.97 Alpha"; // [ZENITH UPGRADE]
...
At the absolute bottom right corner, draw a tiny English watermark text: "Generated by Super FURU AI 4-koma System ${SYSTEM_VERSION}". The text MUST be horizontal and its right edge MUST align perfectly with the right edge of the manga panels.
