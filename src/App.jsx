...
The canvas must have a white background. YOU MUST DRAW THE PANELS AS WIDE AS POSSIBLE, leaving almost NO white margins on the left and right edges. Use thin white gutters between the panels.
At the very top of the page, draw a large, bold, black Japanese text title that says: "${safeTopic}".
At the bottom, draw a tiny English watermark text: "Generated by Super FURU AI 4-koma System ${SYSTEM_VERSION}". The text MUST be horizontal and placed perfectly in the center (NOT aligned to the right).
