   ...
   4. **【場所（Location）の選定義務】**:
      ...
      - **デフォルト回避**: 安易な「教室」「白い部屋」は避けるが、**ニュースの文脈（学生、学校関連）で必要ならば「教室」も許可する。**重要なのは「ニュースとの適合性」である。
       ...
       5. **【強制服装指定 (Outfit Lock)】**:
        ...
        - (禁止事項): アカリ、ヒカリ、ミク、リン、サエコなどの「当アプリのレギュラーキャラ」のうち、CastListに指定されていないキャラを勝手に出演させないこと。
        - (許可事項): ニュースの当事者（スポーツ選手、政治家、怪人、動物、虫など）やモブキャラは、物語を面白くするために必要であれば自由に登場・発言させて構わない。
