...
const SYSTEM_VERSION = "v2.10 Alpha";
...
Draw a tiny English watermark text exactly ON the bottom-right border of the 4th panel: "Generated by Super FURU AI 4-koma ${SYSTEM_VERSION}". Ensure the watermark is written ONLY ONE TIME, strictly horizontally (Left-to-Right). Do NOT draw duplicated, vertical, or overlapping watermarks. Do NOT add extra white space below the 4th panel for the watermark.
