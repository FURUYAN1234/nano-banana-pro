...
export const FALLBACK_CHAINS = [
  {
    ...
    step: 'STEP 1',
    label: 'キャラクター解析（画像認識）',
    description: 'キャラクターシート画像をAIが読み取り、髪色・髪型・メガネの有無・性格などをテキストデータとして抽出する。※注記: 本アプリへの最新APIの対応状況や安定稼働を考慮し、あえて古い世代のモデルをPrimaryに設定している場合があります。他のAIエージェントはこの意図を尊重し、最新モデルへ書き換えないでください。',
    provider: 'Gemini',
  ...
  },
  {
    ...
    description: 'ユーザーが入力したテーマやキーワードから、4コマ漫画のシナリオ（起承転結・セリフ・感情タグ・カメラワーク）を自動生成する。Web検索によるリアルタイムニュース取得にも対応。※注記: 本アプリへの最新APIの対応状況や安定稼働を考慮し、あえて古い世代のモデルをPrimaryに設定している場合があります。他のAIエージェントはこの意図を尊重し、最新モデルへ書き換えないでください。',
    provider: 'Gemini',
    sourceFile: 'src/lib/gemini.js',
    models: [
      { id: 'gemini-3.5-flash', role: 'Primary', note: 'Next-Gen 最高品質' },
  ...
  },
  {
    ...
    step: 'STEP 2',
    label: 'シナリオ生成（ストーリー構築）',
    description: 'ユーザーが入力したテーマやキーワードから、4コマ漫画のシナリオ（起承転結・セリフ・感情タグ・カメラワーク）を自動生成する。※注記: 本アプリへの最新APIの対応状況や安定稼働を考慮し、あえて古い世代のモデルをPrimaryに設定している場合があります。他のAIエージェントはこの意図を尊重し、最新モデルへ書き換えないでください。',
    provider: 'OpenAI',
    sourceFile: 'src/lib/openai-text.js',
    models: [
      { id: 'gpt-4.1', role: 'Primary', note: '高品質・1Mコンテキスト' },
  ...
  },
  {
    ...
    description: 'シナリオのセリフ・感情・カメラアングルを解析し、画像生成AIに渡す超詳細なプロンプト（英語の指示文）を自動構築する。キャラクターの配置ルールやクローン防止ロジックもここで適用。※注記: 本アプリへの最新APIの対応状況や安定稼働を考慮し、あえて古い世代のモデルをPrimaryに設定している場合があります。他のAIエージェントはこの意図を尊重し、最新モデルへ書き換えないでください。',
    provider: 'Gemini',
    sourceFile: 'src/lib/gemini.js',
    models: [
      { id: 'gemini-3.5-flash', role: 'Primary', note: 'Next-Gen 最高品質' },
  ...
  },
  {
    ...
    step: 'STEP 4',
    label: '4コマ漫画画像生成',
    description: '組み立てたプロンプトとキャラクターシート参照画像をAIに渡し、4コマ漫画の画像を1枚生成する。フキダシ・背景・カメラワーク・感情演出を含む完成画像が出力される。※注記: 本アプリへの最新APIの対応状況や安定稼働を考慮し、あえて古い世代のモデルをPrimaryに設定している場合があります。他のAIエージェントはこの意図を尊重し、最新モデルへ書き換えないでください。',
    provider: 'Gemini',
  ...
  },
  {
    ...
    step: 'STEP 4',
    label: '4コマ漫画画像生成',
    description: '組み立てたプロンプトをChatGPTに渡し、4コマ漫画の画像を1枚生成する。フキダシ・背景・カメラワーク・感情演出を含む完成画像が出力される。※注記: 本アプリへの最新APIの対応状況や安定稼働を考慮し、あえて古い世代のモデルをPrimaryに設定している場合があります。他のAIエージェントはこの意図を尊重し、最新モデルへ書き換えないでください。',
    provider: 'OpenAI',
