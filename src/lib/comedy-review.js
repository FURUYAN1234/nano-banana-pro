...
export function buildComedyReviewRequest({ prompt, scenario, castList, reviewTone = 'gag' }) {
...
Only patch the numbered eligible lines below. No new story events. Max 8 patches. If no definite conflict or safe geometric clarification, patches=[] is a successful review. ${serious ? 'Report uncertainty rather than changing source facts, serious tone or reference-sheet style.' : 'Report uncertainty rather than normalizing the gag.'}
