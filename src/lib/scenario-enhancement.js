...
const CATEGORY_DEFINITIONS = Object.freeze({
  ...
  background: {
    label: '背景',
    instruction: '既存のLocationと物語に必要な小道具、場所の形・明暗・奥行きを保ち、見せ場と静かな間に合わせて背景の密度を変える。被写界深度に応じて焦点から遠い背景はぼかしてよい。主役や手元は明瞭にし、遠景の形と空間の連続性を残す。静かなコマを白抜きにする既定は設けず、背景の細部とコントラストを抑える。看板や本などに未指定の文字を追加しない。全コマに同じ量の物や線を追加しない'
  },
  camera: {
    label: 'カメラ',
    instruction: '各コマの[Camera:]だけを編集し、物語の注視対象へ視線を導く。高低差、傾き、遠近感、人物の大きさと余白に強弱を作り、見せ場と静かな間を引き立てる。全コマを極端な画角へ揃えず、明示された固定構図を保つ'
  },
  dialogue: {
    label: 'セリフ',
