...
> 禁止コンテンツタグをチェック中...`,`
> 風刺ロジックを注入中...`,`
> 4コマ構造を最終化中...`];if(!At)return nt;const at=Me[Math.floor(Math.random()*Me.length)];return nt+at})},600);try{const nt=pM({scenario:ft,castList:X,colorMode:D,enableChatGPTMode:lt,bg360Image:Qe,bg360Analysis:Wt,bg360Enabled:jn,bg360CroppedPanels:sn,punchlineType:U,systemVersion:Ql});return await new Promise(Me=>setTimeout(Me,800)),U==="Documentary"&&Et(Me=>Me+`
