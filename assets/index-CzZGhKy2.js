...
- 修正後のプロンプト全文のみを出力してください。説明や前置きは不要です。`,rM=r=>{const{safeTopic:e,watermarkEng:i,styleCore:s,safeLocation:l,bg360Image:c,bg360Analysis:u,bg360Enabled:h,bg360CroppedPanels:m,enableChatGPTMode:p,VAR_CAST_LIST_CHATGPT:g,identityMatrix:v,activeOutfit:x,panelSections:b}=r,M=c&&u&&h?m&&m.length===4&&!p?`
...
`},oM=r=>{const{safeTopic:e,watermarkEng:i,styleCore:s,safeLocation:l,bg360Image:c,bg360Analysis:u,bg360Enabled:h,bg360CroppedPanels:m,VAR_CAST_LIST:p,identityMatrix:g,activeOutfit:v,dynamicCamera:x,panelSections:b}=r,M=c&&u&&h?m&&m.length===4?`
BACKGROUND REFERENCE IMAGES (Per-Panel Cropped Views):
4 background reference images are attached after the text prompt. These are NOT character sheets.
- Image 1 → Background for Panel 1
- Image 2 → Background for Panel 2
...
- Character [${s}]: `,l=!1),!s||((h.includes("**基本")||h.includes("**髪")||h.includes("**顔")||h.includes("**服装")||h.includes("**性格"))&&(l=h.includes("服装")||h.includes("Outfit")),e&&(l||h.includes("服装")||h.includes("Outfit"))))continue;const p=h.match(/\[WEIGHTS?\]:\s*(.*)/i);if(p){let v=p[1].replace(/\|/g,"").trim();v&&v!=="()"&&v!=="-"&&(i+=v+", ");continue}const g=h.match(/\([a-zA-Z\s_-]+:\d+\.?\d*\)/g);g&&g.length>=2&&(i+=g.join(", ")+", ")}return i.trim()||(i=r.trim()),i.trim()},pM=r=>{const e=[...r];for(let i=e.length-1;i>0;i--){const s=Math.floor(Math.random()*(i+1));[e[i],e[s]]=[e[s],e[i]]}return e},mu=(r,e,i)=>{const s=new RegExp(`\\[${e}.*?\\]([\\s\\S]*?)(?=\\[${i}|$)`,"i"),l=r.match(s);return l?l[1].trim():""},mM=({scenario:r,castList:e,colorMode:i,enableChatGPTMode:s,bg360Image:l,bg360Analysis:c,bg360Enabled:u,bg360CroppedPanels:h,punchlineType:m,systemVersion:p})=>{let g=i==="monochrome";if(i==="auto"){const W=e.toLowerCase();g=W.includes("style_tag: monochrome")||W.includes("monochrome")||W.includes("greyscale")||W.includes("screentone")}const v=g?"Draw in a traditional Japanese black and white manga style using G-pen ink lines, screentones, and manual hatching. The artwork should have high-contrast black and white shading without any color, similar to a professionally published comic.":"Draw in a high-budget, vibrant full-color TV anime style. The characters should have delicate and detailed anime features with beautiful eyes, cinematic lighting, and sharp clean ink contours. Ensure the artwork looks like an official Japanese animation illustration.",x=sE;let b=r.match(/## タイトル:\s*(.*?)(\n|$|!)/)?.[1]?.trim()||r.split(`
`)[0].substring(0,20);b=b.replace(/^Topic:\s*/i,"").trim();const M=r.match(/Location:\s*(.*?)(\n|$)/i)?.[1]?.trim(),R=r.match(/Outfit:\s*(.*?)(\n|$)/i)?.[1]?.trim(),S=M||"Generic Detailed Background",y=R&&!/^(なし|キャラシート準拠|none|default)/i.test(R)?R:"";let w=r.replace(/```(?:json|markdown)?/gi,"").trim();w=w.replace(/Generated by.*?$/i,"").trim();const O=mu(w,"1コマ目","2コマ目")||w,D=mu(w,"2コマ目","3コマ目"),z=mu(w,"3コマ目","4コマ目"),L=mu(w,"4コマ目","UNKNOWN"),B=pM(iE).slice(0,4),A={index:0},F=hM(e,y),$=s?cM(F):F,k=S,X=b||"4-koma Manga",te=s?`Generated by ChatGPT with Super FURU AI 4-koma ${p}`:`Generated by Gemini with Super FURU AI 4-koma ${p}`;let oe="";const V=[O,D,z,L];let U="";s?(U=V.map((W,ce)=>`## Panel ${ce+1}
${O_(W)}
...
`),oe=rM({safeTopic:X,watermarkEng:te,styleCore:v,safeLocation:k,bg360Image:l,bg360Analysis:c,bg360Enabled:u,bg360CroppedPanels:h,enableChatGPTMode:s,VAR_CAST_LIST_CHATGPT:$,identityMatrix:hp(e),activeOutfit:y,panelSections:U})):(U=V.map((ce,ge)=>`## Panel ${ge+1}
${O_(ce)}
${pu(ce,e)}
${N_(ce,e)}
Camera: ${lM(ce,B,A)}.
...
> 禁止コンテンツタグをチェック中...`,`
> 風刺ロジックを注入中...`,`
> 4コマ構造を最終化中...`];if(!At)return nt;const at=Me[Math.floor(Math.random()*Me.length)];return nt+at})},600);try{const nt=mM({scenario:ft,castList:X,colorMode:I,enableChatGPTMode:lt,bg360Image:Qe,bg360Analysis:Wt,bg360Enabled:jn,bg360CroppedPanels:sn,punchlineType:D,systemVersion:Ql});return await new Promise(Me=>setTimeout(Me,800)),D==="Documentary"&&Et(Me=>Me+`
...
void main() {
	...
	`}class Rb extends za{constructor(e=1,i={}){super(e,e,i),this.isWebGLCubeRenderTarget=!0;const s={width:e,height:e,depth:1},l=[s,s,s,s,s,s];this.texture=new yb(l),this._setTextureOptions(i),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,i){this.texture.type=i.type,this.texture.colorSpace=i.colorSpace,this.texture.generateMipmaps=i.generateMipmaps,this.texture.minFilter=i.minFilter,this.texture.magFilter=i.magFilter;const s={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},l=new oc(5,5,5),c=new Va({name:"CubemapFromEquirect",uniforms:Wo(s.uniforms),vertexShader:s.vertexShader,fragmentShader:s.fragmentShader,side:Pi,blending:ms});c.uniforms.tEquirect.value=i;const u=new ka(l,c),h=i.minFilter;return i.minFilter===Ir&&(i.minFilter=mi),new zT(1,10,this).update(e,u),i.minFilter=h,u.geometry.dispose(),u.material.dispose(),this}clear(e,i=!0,s=!0,l=!0){const c=e.getRenderTarget();for(let u=0;u<6;u++)e.setRenderTarget(this,u),e.clear(i,s,l);e.setRenderTarget(c)}}function Uw(r){let e=new WeakMap,i=new WeakMap,s=null;function l(x,b=!1){return x==null?null:b?u(x):c(x)}function c(x){if(x&&x.isTexture){const b=x.mapping;if(b===Vu||b===Ch)if(e.has(x)){const M=e.get(x).texture;return h(M,x.mapping)}else{const M=x.image;if(M&&M.height>0){const R=new Rb(M.height);return R.fromEquirectangularTexture(r,x),e.set(x,R),x.addEventListener("dispose",p),h(R.texture,x.mapping)}else return null}}return x}function u(x){if(x&&x.isTexture){const b=x.mapping,M=b===Vu||b===Ch,R=b===Br||b===Xo;if(M||R){let S=i.get(x);const y=S!==void 0?S.texture.pmremVersion:0;if(x.isRenderTargetTexture&&x.pmremVersion!==y)return s===null&&(s=new dv(r)),S=M?s.fromEquirectangular(x,S):s.fromCubemap(x,S),S.texture.pmremVersion=x.pmremVersion,i.set(x,S),S.texture;if(S!==void 0)return S.texture;{const w=x.image;return M&&w&&w.height>0||R&&w&&m(w)?(s===null&&(s=new dv(r)),S=M?s.fromEquirectangular(x):s.fromCubemap(x),S.texture.pmremVersion=x.pmremVersion,i.set(x,S),x.addEventListener("dispose",g),S.texture):null}}}return x}function h(x,b){return b===Vu?x.mapping=Br:b===Ch&&(x.mapping=Xo),x}function m(x){let b=0;const M=6;for(let R=0;R<M;R++)x[R]!==void 0&&b++;return b===M}function p(x){const b=x.target;b.removeEventListener("dispose",p);const M=e.get(b);M!==void 0&&(e.delete(b),M.dispose())}function g(x){const b=x.target;b.removeEventListener("dispose",g);const M=i.get(b);M!==void 0&&(i.delete(b),M.dispose())}function v(){e=new WeakMap,i=new WeakMap,s!==null&&(s.dispose(),s=null)}return{get:l,dispose:v}}function Pw(r){const e={};function i(s){if(e[s]!==void 0)return e[s];const l=r.getExtension(s);return e[s]=l,l}return{has:function(s){return i(s)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(s){const l=i(s);return l===null&&tm("WebGLRenderer: "+s+" extension not supported."),l}}}function Fw(r,e,i,s){const l={},c=new WeakMap;function u(v){const x=v.target;x.index!==null&&e.remove(x.index);for(const M in x.attributes)e.remove(x.attributes[M]);x.removeEventListener("dispose",u),delete l[x.id];const b=c.get(x);b&&(e.remove(b),c.delete(x)),s.releaseStatesOfGeometry(x),x.isInstancedBufferGeometry===!0&&delete x._maxInstanceCount,i.memory.geometries--}function h(v,x){return l[x.id]===!0||(x.addEventListener("dispose",u),l[x.id]=!0,i.memory.geometries++),x}function m(v){const x=v.attributes;for(const b in x)e.update(x[b],r.ARRAY_BUFFER)}function p(v){const x=[],b=v.index,M=v.attributes.position;let R=0;if(M===void 0)return;if(b!==null){const w=b.array;R=b.version;for(let O=0,D=w.length;O<D;O+=3){const z=w[O+0],L=w[O+1],B=w[O+2];x.push(z,L,L,B,B,z)}}else{const w=M.array;R=M.version;for(let O=0,D=w.length/3-1;O<D;O+=3){const z=O+0,L=O+1,B=O+2;x.push(z,L,L,B,B,z)}}const S=new(M.count>=65535?_b:xb)(x,1);S.version=R;const y=c.get(v);y&&e.remove(y),c.set(v,S)}function g(v){const x=c.get(v);if(x){const b=v.index;b!==null&&x.version<b.version&&p(v)}else p(v);return c.get(v)}return{get:h,update:m,getWireframeAttribute:g}}function Bw(r,e,i){let s;function l(v){s=v}let c,u;function h(v){c=v.type,u=v.bytesPerElement}function m(v,x){r.drawElements(s,x,c,v*u),i.update(x,s,1)}function p(v,x,b){b!==0&&(r.drawElementsInstanced(s,x,c,v*u,b),i.update(x,s,b))}function g(v,x,b){if(b===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(s,x,0,c,v,0,b);let R=0;for(let S=0;S<b;S++)R+=x[S];i.update(R,s,1)}this.setMode=l,this.setIndex=h,this.render=m,this.renderInstances=p,this.renderMultiDraw=g}function zw(r){const e={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function s(c,u,h){switch(i.calls++,u){case r.TRIANGLES:i.triangles+=h*(c/3);break;case r.LINES:i.lines+=h*(c/2);break;case r.LINE_STRIP:i.lines+=h*(c-1);break;case r.LINE_LOOP:i.lines+=h*c;break;case r.POINTS:i.points+=h*c;break;default:Jt("WebGLInfo: Unknown draw mode:",u);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:e,render:i,programs:null,autoReset:!0,reset:l,update:s}}function Gw(r,e,i){const s=new WeakMap,l=new Ln;function c(u,h,m){const p=u.morphTargetInfluences,g=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,v=g!==void 0?g.length:0;let x=s.get(h);if(x===void 0||x.count!==v){let F=function(){B.dispose(),s.delete(h),h.removeEventListener("dispose",F)};x!==void 0&&x.texture.dispose();const b=h.morphAttributes.position!==void 0,M=h.morphAttributes.normal!==void 0,R=h.morphAttributes.color!==void 0,S=h.morphAttributes.position||[],y=h.morphAttributes.normal||[],w=h.morphAttributes.color||[];let O=0;b===!0&&(O=1),M===!0&&(O=2),R===!0&&(O=3);let D=h.attributes.position.count*O,z=1;D>e.maxTextureSize&&(z=Math.ceil(D/e.maxTextureSize),D=e.maxTextureSize);const L=new Float32Array(D*z*4*v),B=new pb(L,D,z,v);B.type=Pa,B.needsUpdate=!0;const A=O*4;for(let $=0;$<v;$++){const k=S[$],X=y[$],te=w[$],oe=D*z*4*$;for(let V=0;V<k.count;V++){const U=V*A;b===!0&&(l.fromBufferAttribute(k,V),L[oe+U+0]=l.x,L[oe+U+1]=l.y,L[oe+U+2]=l.z,L[oe+U+3]=0),M===!0&&(l.fromBufferAttribute(X,V),L[oe+U+4]=l.x,L[oe+U+5]=l.y,L[oe+U+6]=l.z,L[oe+U+7]=0),R===!0&&(l.fromBufferAttribute(te,V),L[oe+U+8]=l.x,L[oe+U+9]=l.y,L[oe+U+10]=l.z,L[oe+U+11]=te.itemSize===4?l.w:1)}}x={count:v,texture:B,size:new Ot(D,z)},s.set(h,x),h.addEventListener("dispose",F)}if(u.isInstancedMesh===!0&&u.morphTexture!==null)m.getUniforms().setValue(r,"morphTexture",u.morphTexture,i);else{let b=0;for(let R=0;R<p.length;R++)b+=p[R];const M=h.morphTargetsRelative?1:1-b;m.getUniforms().setValue(r,"morphTargetBaseInfluence",M),m.getUniforms().setValue(r,"morphTargetInfluences",p)}m.getUniforms().setValue(r,"morphTargetsTexture",x.texture,i),m.getUniforms().setValue(r,"morphTargetsTextureSize",x.size)}return{update:c}}function Hw(r,e,i,s,l){let c=new WeakMap;function u(p){const g=l.render.frame,v=p.geometry,x=e.get(p,v);if(c.get(x)!==g&&(e.update(x),c.set(x,g)),p.isInstancedMesh&&(p.hasEventListener("dispose",m)===!1&&p.addEventListener("dispose",m),c.get(p)!==g&&(i.update(p.instanceMatrix,r.ARRAY_BUFFER),p.instanceColor!==null&&i.update(p.instanceColor,r.ARRAY_BUFFER),c.set(p,g))),p.isSkinnedMesh){const b=p.skeleton;c.get(b)!==g&&(b.update(),c.set(b,g))}return x}function h(){c=new WeakMap}function m(p){const g=p.target;g.removeEventListener("dispose",m),s.releaseStatesOfObject(g),i.remove(g.instanceMatrix),g.instanceColor!==null&&i.remove(g.instanceColor)}return{update:u,dispose:h}}const kw={[Qv]:"LINEAR_TONE_MAPPING",[Jv]:"REINHARD_TONE_MAPPING",[eb]:"CINEON_TONE_MAPPING",[tb]:"ACES_FILMIC_TONE_MAPPING",[ib]:"AGX_TONE_MAPPING",[ab]:"NEUTRAL_TONE_MAPPING",[nb]:"CUSTOM_TONE_MAPPING"};function Vw(r,e,i,s,l){const c=new za(e,i,{type:r,depthBuffer:s,stencilBuffer:l,depthTexture:s?new Yo(e,i):void 0}),u=new za(e,i,{type:xs,depthBuffer:!1,stencilBuffer:!1}),h=new ja;h.setAttribute("position",new ga([-1,3,0,-1,-1,0,3,-1,0],3)),h.setAttribute("uv",new ga([0,2,0,0,2,0],2));const m=new DT({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`].filter(Wl).join(`
`)),u=am(u),u=Tv(u,i),u=Av(u,i),h=am(h),h=Tv(h,i),h=Av(h,i),u=wv(u),h=wv(h),i.isRawShaderMaterial!==!0&&(w=`#version 300 es
...
`)+`
`+y);const O=w+S+u,D=w+y+h,z=Sv(l,l.VERTEX_SHADER,O),L=Sv(l,l.FRAGMENT_SHADER,D);l.attachShader(R,z),l.attachShader(R,L),i.index0AttributeName!==void 0?l.bindAttribLocation(R,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(R,0,"position"),l.linkProgram(R);function B(k){if(r.debug.checkShaderErrors){const X=l.getProgramInfoLog(R)||"",te=l.getShaderInfoLog(z)||"",oe=l.getShaderInfoLog(L)||"",V=X.trim(),U=te.trim(),G=oe.trim();let W=!0,ce=!0;if(l.getProgramParameter(R,l.LINK_STATUS)===!1)if(W=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,R,z,L);else{const ge=Mv(l,z,"vertex"),P=Mv(l,L,"fragment");Jt("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(R,l.VALIDATE_STATUS)+`
