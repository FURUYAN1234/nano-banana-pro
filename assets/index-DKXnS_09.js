...
#endif`,LT="gl_FragColor = linearToOutputTexel( gl_FragColor );",IT=`vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ws,depthTest:!1,depthWrite:!1})}function fv(){return new _s({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Gf(),fragmentShader:`
		...
		`,blending:Ws,depthTest:!1,depthWrite:!1})}function dv(){return new _s({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Gf(),fragmentShader:`
	...
	`}class yb extends ps{constructor(e=1,i={}){super(e,e,i),this.isWebGLCubeRenderTarget=!0;const s={width:e,height:e,depth:1},l=[s,s,s,s,s,s];this.texture=new pb(l),this._setTextureOptions(i),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,i){this.texture.type=i.type,this.texture.colorSpace=i.colorSpace,this.texture.generateMipmaps=i.generateMipmaps,this.texture.minFilter=i.minFilter,this.texture.magFilter=i.magFilter;const s={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},l=new zc(5,5,5),c=new _s({name:"CubemapFromEquirect",uniforms:Nl(s.uniforms),vertexShader:s.vertexShader,fragmentShader:s.fragmentShader,side:oa,blending:Ws});c.uniforms.tEquirect.value=i;const f=new xs(l,c),h=i.minFilter;return i.minFilter===_o&&(i.minFilter=Xi),new QM(1,10,this).update(e,f),i.minFilter=h,f.geometry.dispose(),f.material.dispose(),this}clear(e,i=!0,s=!0,l=!0){const c=e.getRenderTarget();for(let f=0;f<6;f++)e.setRenderTarget(this,f),e.clear(i,s,l);e.setRenderTarget(c)}}function qA(r){let e=new WeakMap,i=new WeakMap,s=null;function l(g,y=!1){return g==null?null:y?f(g):c(g)}function c(g){if(g&&g.isTexture){const y=g.mapping;if(y===Sf||y===jh)if(e.has(g)){const T=e.get(g).texture;return h(T,g.mapping)}else{const T=g.image;if(T&&T.height>0){const C=new yb(T.height);return C.fromEquirectangularTexture(r,g),e.set(g,C),g.addEventListener("dispose",p),h(C.texture,g.mapping)}else return null}}return g}function f(g){if(g&&g.isTexture){const y=g.mapping,T=y===Sf||y===jh,C=y===yo||y===Rl;if(T||C){let S=i.get(g);const E=S!==void 0?S.texture.pmremVersion:0;if(g.isRenderTargetTexture&&g.pmremVersion!==E)return s===null&&(s=new cv(r)),S=T?s.fromEquirectangular(g,S):s.fromCubemap(g,S),S.texture.pmremVersion=g.pmremVersion,i.set(g,S),S.texture;if(S!==void 0)return S.texture;{const N=g.image;return T&&N&&N.height>0||C&&N&&m(N)?(s===null&&(s=new cv(r)),S=T?s.fromEquirectangular(g):s.fromCubemap(g),S.texture.pmremVersion=g.pmremVersion,i.set(g,S),g.addEventListener("dispose",_),S.texture):null}}}return g}function h(g,y){return y===Sf?g.mapping=yo:y===jh&&(g.mapping=Rl),g}function m(g){let y=0;const T=6;for(let C=0;C<T;C++)g[C]!==void 0&&y++;return y===T}function p(g){const y=g.target;y.removeEventListener("dispose",p);const T=e.get(y);T!==void 0&&(e.delete(y),T.dispose())}function _(g){const y=g.target;y.removeEventListener("dispose",_);const T=i.get(y);T!==void 0&&(i.delete(y),T.dispose())}function b(){e=new WeakMap,i=new WeakMap,s!==null&&(s.dispose(),s=null)}return{get:l,dispose:b}}function $A(r){const e={};function i(s){if(e[s]!==void 0)return e[s];const l=r.getExtension(s);return e[s]=l,l}return{has:function(s){return i(s)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(s){const l=i(s);return l===null&&dm("WebGLRenderer: "+s+" extension not supported."),l}}}function KA(r,e,i,s){const l={},c=new WeakMap;function f(b){const g=b.target;g.index!==null&&e.remove(g.index);for(const T in g.attributes)e.remove(g.attributes[T]);g.removeEventListener("dispose",f),delete l[g.id];const y=c.get(g);y&&(e.remove(y),c.delete(g)),s.releaseStatesOfGeometry(g),g.isInstancedBufferGeometry===!0&&delete g._maxInstanceCount,i.memory.geometries--}function h(b,g){return l[g.id]===!0||(g.addEventListener("dispose",f),l[g.id]=!0,i.memory.geometries++),g}function m(b){const g=b.attributes;for(const y in g)e.update(g[y],r.ARRAY_BUFFER)}function p(b){const g=[],y=b.index,T=b.attributes.position;let C=0;if(T===void 0)return;if(y!==null){const N=y.array;C=y.version;for(let U=0,D=N.length;U<D;U+=3){const X=N[U+0],L=N[U+1],z=N[U+2];g.push(X,L,L,z,z,X)}}else{const N=T.array;C=T.version;for(let U=0,D=N.length/3-1;U<D;U+=3){const X=U+0,L=U+1,z=U+2;g.push(X,L,L,z,z,X)}}const S=new(T.count>=65535?fb:ub)(g,1);S.version=C;const E=c.get(b);E&&e.remove(E),c.set(b,S)}function _(b){const g=c.get(b);if(g){const y=b.index;y!==null&&g.version<y.version&&p(b)}else p(b);return c.get(b)}return{get:h,update:m,getWireframeAttribute:_}}function ZA(r,e,i){let s;function l(b){s=b}let c,f;function h(b){c=b.type,f=b.bytesPerElement}function m(b,g){r.drawElements(s,g,c,b*f),i.update(g,s,1)}function p(b,g,y){y!==0&&(r.drawElementsInstanced(s,g,c,b*f,y),i.update(g,s,y))}function _(b,g,y){if(y===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(s,g,0,c,b,0,y);let C=0;for(let S=0;S<y;S++)C+=g[S];i.update(C,s,1)}this.setMode=l,this.setIndex=h,this.render=m,this.renderInstances=p,this.renderMultiDraw=_}function QA(r){const e={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function s(c,f,h){switch(i.calls++,f){case r.TRIANGLES:i.triangles+=h*(c/3);break;case r.LINES:i.lines+=h*(c/2);break;case r.LINE_STRIP:i.lines+=h*(c-1);break;case r.LINE_LOOP:i.lines+=h*c;break;case r.POINTS:i.points+=h*c;break;default:on("WebGLInfo: Unknown draw mode:",f);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:e,render:i,programs:null,autoReset:!0,reset:l,update:s}}function JA(r,e,i){const s=new WeakMap,l=new li;function c(f,h,m){const p=f.morphTargetInfluences,_=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,b=_!==void 0?_.length:0;let g=s.get(h);if(g===void 0||g.count!==b){let F=function(){z.dispose(),s.delete(h),h.removeEventListener("dispose",F)};g!==void 0&&g.texture.dispose();const y=h.morphAttributes.position!==void 0,T=h.morphAttributes.normal!==void 0,C=h.morphAttributes.color!==void 0,S=h.morphAttributes.position||[],E=h.morphAttributes.normal||[],N=h.morphAttributes.color||[];let U=0;y===!0&&(U=1),T===!0&&(U=2),C===!0&&(U=3);let D=h.attributes.position.count*U,X=1;D>e.maxTextureSize&&(X=Math.ceil(D/e.maxTextureSize),D=e.maxTextureSize);const L=new Float32Array(D*X*4*b),z=new ob(L,D,X,b);z.type=fs,z.needsUpdate=!0;const w=U*4;for(let $=0;$<b;$++){const k=S[$],W=E[$],de=N[$],se=D*X*4*$;for(let Y=0;Y<k.count;Y++){const I=Y*w;y===!0&&(l.fromBufferAttribute(k,Y),L[se+I+0]=l.x,L[se+I+1]=l.y,L[se+I+2]=l.z,L[se+I+3]=0),T===!0&&(l.fromBufferAttribute(W,Y),L[se+I+4]=l.x,L[se+I+5]=l.y,L[se+I+6]=l.z,L[se+I+7]=0),C===!0&&(l.fromBufferAttribute(de,Y),L[se+I+8]=l.x,L[se+I+9]=l.y,L[se+I+10]=l.z,L[se+I+11]=de.itemSize===4?l.w:1)}}g={count:b,texture:z,size:new Xt(D,X)},s.set(h,g),h.addEventListener("dispose",F)}if(f.isInstancedMesh===!0&&f.morphTexture!==null)m.getUniforms().setValue(r,"morphTexture",f.morphTexture,i);else{let y=0;for(let C=0;C<p.length;C++)y+=p[C];const T=h.morphTargetsRelative?1:1-y;m.getUniforms().setValue(r,"morphTargetBaseInfluence",T),m.getUniforms().setValue(r,"morphTargetInfluences",p)}m.getUniforms().setValue(r,"morphTargetsTexture",g.texture,i),m.getUniforms().setValue(r,"morphTargetsTextureSize",g.size)}return{update:c}}function ew(r,e,i,s,l){let c=new WeakMap;function f(p){const _=l.render.frame,b=p.geometry,g=e.get(p,b);if(c.get(g)!==_&&(e.update(g),c.set(g,_)),p.isInstancedMesh&&(p.hasEventListener("dispose",m)===!1&&p.addEventListener("dispose",m),c.get(p)!==_&&(i.update(p.instanceMatrix,r.ARRAY_BUFFER),p.instanceColor!==null&&i.update(p.instanceColor,r.ARRAY_BUFFER),c.set(p,_))),p.isSkinnedMesh){const y=p.skeleton;c.get(y)!==_&&(y.update(),c.set(y,_))}return g}function h(){c=new WeakMap}function m(p){const _=p.target;_.removeEventListener("dispose",m),s.releaseStatesOfObject(_),i.remove(_.instanceMatrix),_.instanceColor!==null&&i.remove(_.instanceColor)}return{update:f,dispose:h}}const tw={[Xv]:"LINEAR_TONE_MAPPING",[Yv]:"REINHARD_TONE_MAPPING",[Wv]:"CINEON_TONE_MAPPING",[qv]:"ACES_FILMIC_TONE_MAPPING",[Kv]:"AGX_TONE_MAPPING",[Zv]:"NEUTRAL_TONE_MAPPING",[$v]:"CUSTOM_TONE_MAPPING"};function nw(r,e,i,s,l){const c=new ps(e,i,{type:r,depthBuffer:s,stencilBuffer:l,depthTexture:s?new Cl(e,i):void 0}),f=new ps(e,i,{type:$s,depthBuffer:!1,stencilBuffer:!1}),h=new vs;h.setAttribute("position",new Va([-1,3,0,-1,-1,0,3,-1,0],3)),h.setAttribute("uv",new Va([0,2,0,0,2,0],2));const m=new XM({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),p=new xs(h,m),_=new _b(-1,1,1,-1,0,1);let b=null,g=null,y=!1,T,C=null,S=[],E=!1;this.setSize=function(N,U){c.setSize(N,U),f.setSize(N,U);for(let D=0;D<S.length;D++){const X=S[D];X.setSize&&X.setSize(N,U)}},this.setEffects=function(N){S=N,E=S.length>0&&S[0].isRenderPass===!0;const U=c.width,D=c.height;for(let X=0;X<S.length;X++){const L=S[X];L.setSize&&L.setSize(U,D)}},this.begin=function(N,U){if(y||N.toneMapping===hs&&S.length===0)return!1;if(C=U,U!==null){const D=U.width,X=U.height;(c.width!==D||c.height!==X)&&this.setSize(D,X)}return E===!1&&N.setRenderTarget(c),T=N.toneMapping,N.toneMapping=hs,!0},this.hasRenderPass=function(){return E},this.end=function(N,U){N.toneMapping=T,y=!0;let D=c,X=f;for(let L=0;L<S.length;L++){const z=S[L];if(z.enabled!==!1&&(z.render(N,X,D,U),z.needsSwap!==!1)){const w=D;D=X,X=w}}if(b!==N.outputColorSpace||g!==N.toneMapping){b=N.outputColorSpace,g=N.toneMapping,m.defines={},Jt.getTransfer(b)===En&&(m.defines.SRGB_TRANSFER="");const L=tw[g];L&&(m.defines[L]=""),m.needsUpdate=!0}m.uniforms.tDiffuse.value=D.texture,N.setRenderTarget(C),N.render(p,_),C=null,y=!1},this.isCompositing=function(){return y},this.dispose=function(){c.depthTexture&&c.depthTexture.dispose(),c.dispose(),f.dispose(),h.dispose(),m.dispose()}}const Eb=new Yi,pm=new Cl(1,1),Sb=new ob,Mb=new EM,Tb=new pb,hv=[],pv=[],mv=new Float32Array(16),gv=new Float32Array(9),xv=new Float32Array(4);function Ol(r,e,i){const s=r[0];if(s<=0||s>0)return r;const l=e*i;let c=hv[l];if(c===void 0&&(c=new Float32Array(l),hv[l]=c),e!==0){s.toArray(c,0);for(let f=1,h=0;f!==e;++f)h+=i,r[f].toArray(c,h)}return c}function bi(r,e){if(r.length!==e.length)return!1;for(let i=0,s=r.length;i<s;i++)if(r[i]!==e[i])return!1;return!0}function yi(r,e){for(let i=0,s=e.length;i<s;i++)r[i]=e[i]}function Hf(r,e){let i=pv[e];i===void 0&&(i=new Int32Array(e),pv[e]=i);for(let s=0;s!==e;++s)i[s]=r.allocateTextureUnit();return i}function iw(r,e){const i=this.cache;i[0]!==e&&(r.uniform1f(this.addr,e),i[0]=e)}function aw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(r.uniform2f(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(bi(i,e))return;r.uniform2fv(this.addr,e),yi(i,e)}}function sw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(r.uniform3f(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else if(e.r!==void 0)(i[0]!==e.r||i[1]!==e.g||i[2]!==e.b)&&(r.uniform3f(this.addr,e.r,e.g,e.b),i[0]=e.r,i[1]=e.g,i[2]=e.b);else{if(bi(i,e))return;r.uniform3fv(this.addr,e),yi(i,e)}}function rw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(r.uniform4f(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(bi(i,e))return;r.uniform4fv(this.addr,e),yi(i,e)}}function ow(r,e){const i=this.cache,s=e.elements;if(s===void 0){if(bi(i,e))return;r.uniformMatrix2fv(this.addr,!1,e),yi(i,e)}else{if(bi(i,s))return;xv.set(s),r.uniformMatrix2fv(this.addr,!1,xv),yi(i,s)}}function lw(r,e){const i=this.cache,s=e.elements;if(s===void 0){if(bi(i,e))return;r.uniformMatrix3fv(this.addr,!1,e),yi(i,e)}else{if(bi(i,s))return;gv.set(s),r.uniformMatrix3fv(this.addr,!1,gv),yi(i,s)}}function cw(r,e){const i=this.cache,s=e.elements;if(s===void 0){if(bi(i,e))return;r.uniformMatrix4fv(this.addr,!1,e),yi(i,e)}else{if(bi(i,s))return;mv.set(s),r.uniformMatrix4fv(this.addr,!1,mv),yi(i,s)}}function uw(r,e){const i=this.cache;i[0]!==e&&(r.uniform1i(this.addr,e),i[0]=e)}function fw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(r.uniform2i(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(bi(i,e))return;r.uniform2iv(this.addr,e),yi(i,e)}}function dw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(r.uniform3i(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else{if(bi(i,e))return;r.uniform3iv(this.addr,e),yi(i,e)}}function hw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(r.uniform4i(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(bi(i,e))return;r.uniform4iv(this.addr,e),yi(i,e)}}function pw(r,e){const i=this.cache;i[0]!==e&&(r.uniform1ui(this.addr,e),i[0]=e)}function mw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(r.uniform2ui(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(bi(i,e))return;r.uniform2uiv(this.addr,e),yi(i,e)}}function gw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(r.uniform3ui(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else{if(bi(i,e))return;r.uniform3uiv(this.addr,e),yi(i,e)}}function xw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(r.uniform4ui(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(bi(i,e))return;r.uniform4uiv(this.addr,e),yi(i,e)}}function _w(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l);let c;this.type===r.SAMPLER_2D_SHADOW?(pm.compareFunction=i.isReversedDepthBuffer()?wm:Am,c=pm):c=Eb,i.setTexture2D(e||c,l)}function vw(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTexture3D(e||Mb,l)}function bw(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTextureCube(e||Tb,l)}function yw(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTexture2DArray(e||Sb,l)}function Ew(r){switch(r){case 5126:return iw;case 35664:return aw;case 35665:return sw;case 35666:return rw;case 35674:return ow;case 35675:return lw;case 35676:return cw;case 5124:case 35670:return uw;case 35667:case 35671:return fw;case 35668:case 35672:return dw;case 35669:case 35673:return hw;case 5125:return pw;case 36294:return mw;case 36295:return gw;case 36296:return xw;case 35678:case 36198:case 36298:case 36306:case 35682:return _w;case 35679:case 36299:case 36307:return vw;case 35680:case 36300:case 36308:case 36293:return bw;case 36289:case 36303:case 36311:case 36292:return yw}}function Sw(r,e){r.uniform1fv(this.addr,e)}function Mw(r,e){const i=Ol(e,this.size,2);r.uniform2fv(this.addr,i)}function Tw(r,e){const i=Ol(e,this.size,3);r.uniform3fv(this.addr,i)}function Aw(r,e){const i=Ol(e,this.size,4);r.uniform4fv(this.addr,i)}function ww(r,e){const i=Ol(e,this.size,4);r.uniformMatrix2fv(this.addr,!1,i)}function Rw(r,e){const i=Ol(e,this.size,9);r.uniformMatrix3fv(this.addr,!1,i)}function Cw(r,e){const i=Ol(e,this.size,16);r.uniformMatrix4fv(this.addr,!1,i)}function Nw(r,e){r.uniform1iv(this.addr,e)}function Ow(r,e){r.uniform2iv(this.addr,e)}function Dw(r,e){r.uniform3iv(this.addr,e)}function Lw(r,e){r.uniform4iv(this.addr,e)}function Iw(r,e){r.uniform1uiv(this.addr,e)}function Uw(r,e){r.uniform2uiv(this.addr,e)}function Pw(r,e){r.uniform3uiv(this.addr,e)}function Fw(r,e){r.uniform4uiv(this.addr,e)}function Bw(r,e,i){const s=this.cache,l=e.length,c=Hf(i,l);bi(s,c)||(r.uniform1iv(this.addr,c),yi(s,c));let f;this.type===r.SAMPLER_2D_SHADOW?f=pm:f=Eb;for(let h=0;h!==l;++h)i.setTexture2D(e[h]||f,c[h])}function zw(r,e,i){const s=this.cache,l=e.length,c=Hf(i,l);bi(s,c)||(r.uniform1iv(this.addr,c),yi(s,c));for(let f=0;f!==l;++f)i.setTexture3D(e[f]||Mb,c[f])}function Gw(r,e,i){const s=this.cache,l=e.length,c=Hf(i,l);bi(s,c)||(r.uniform1iv(this.addr,c),yi(s,c));for(let f=0;f!==l;++f)i.setTextureCube(e[f]||Tb,c[f])}function Hw(r,e,i){const s=this.cache,l=e.length,c=Hf(i,l);bi(s,c)||(r.uniform1iv(this.addr,c),yi(s,c));for(let f=0;f!==l;++f)i.setTexture2DArray(e[f]||Sb,c[f])}function kw(r){switch(r){case 5126:return Sw;case 35664:return Mw;case 35665:return Tw;case 35666:return Aw;case 35674:return ww;case 35675:return Rw;case 35676:return Cw;case 5124:case 35670:return Nw;case 35667:case 35671:return Ow;case 35668:case 35672:return Dw;case 35669:case 35673:return Lw;case 5125:return Iw;case 36294:return Uw;case 36295:return Pw;case 36296:return Fw;case 35678:case 36198:case 36298:case 36306:case 35682:return Bw;case 35679:case 36299:case 36307:return zw;case 35680:case 36300:case 36308:case 36293:return Gw;case 36289:case 36303:case 36311:case 36292:return Hw}}class Vw{constructor(e,i,s){this.id=e,this.addr=s,this.cache=[],this.type=i.type,this.setValue=Ew(i.type)}}class jw{constructor(e,i,s){this.id=e,this.addr=s,this.cache=[],this.type=i.type,this.size=i.size,this.setValue=kw(i.type)}}class Xw{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,i,s){const l=this.seq;for(let c=0,f=l.length;c!==f;++c){const h=l[c];h.setValue(e,i[h.id],s)}}}const bp=/(\w+)(\])?(\[|\.)?/g;function _v(r,e){r.seq.push(e),r.map[e.id]=e}function Yw(r,e,i){const s=r.name,l=s.length;for(bp.lastIndex=0;;){const c=bp.exec(s),f=bp.lastIndex;let h=c[1];const m=c[2]==="]",p=c[3];if(m&&(h=h|0),p===void 0||p==="["&&f+2===l){_v(i,p===void 0?new Vw(h,r,e):new jw(h,r,e));break}else{let b=i.map[h];b===void 0&&(b=new Xw(h),_v(i,b)),i=b}}}class Cf{constructor(e,i){this.seq=[],this.map={};const s=e.getProgramParameter(i,e.ACTIVE_UNIFORMS);for(let f=0;f<s;++f){const h=e.getActiveUniform(i,f),m=e.getUniformLocation(i,h.name);Yw(h,m,this)}const l=[],c=[];for(const f of this.seq)f.type===e.SAMPLER_2D_SHADOW||f.type===e.SAMPLER_CUBE_SHADOW||f.type===e.SAMPLER_2D_ARRAY_SHADOW?l.push(f):c.push(f);l.length>0&&(this.seq=l.concat(c))}setValue(e,i,s,l){const c=this.map[i];c!==void 0&&c.setValue(e,s,l)}setOptional(e,i,s){const l=i[s];l!==void 0&&this.setValue(e,s,l)}static upload(e,i,s,l){for(let c=0,f=i.length;c!==f;++c){const h=i[c],m=s[h.id];m.needsUpdate!==!1&&h.setValue(e,m.value,l)}}static seqWithValue(e,i){const s=[];for(let l=0,c=e.length;l!==c;++l){const f=e[l];f.id in i&&s.push(f)}return s}}function vv(r,e,i){const s=r.createShader(e);return r.shaderSource(s,i),r.compileShader(s),s}const Ww=37297;let qw=0;function $w(r,e){const i=r.split(`
`),s=[],l=Math.max(e-6,0),c=Math.min(e+6,i.length);for(let f=l;f<c;f++){const h=f+1;s.push(`${h===e?">":" "} ${h}: ${i[f]}`)}return s.join(`
`)}const bv=new Ut;function Kw(r){Jt._getMatrix(bv,Jt.workingColorSpace,r);const e=`mat3( ${bv.elements.map(i=>i.toFixed(4))} )`;switch(Jt.getTransfer(r)){case If:return[e,"LinearTransferOETF"];case En:return[e,"sRGBTransferOETF"];default:return At("WebGLProgram: Unsupported color space: ",r),[e,"LinearTransferOETF"]}}function yv(r,e,i){const s=r.getShaderParameter(e,r.COMPILE_STATUS),c=(r.getShaderInfoLog(e)||"").trim();if(s&&c==="")return"";const f=/ERROR: 0:(\d+)/.exec(c);if(f){const h=parseInt(f[1]);return i.toUpperCase()+`

`+c+`

`+$w(r.getShaderSource(e),h)}else return c}function Zw(r,e){const i=Kw(e);return[`vec4 ${r}( vec4 value ) {`,`	return ${i[1]}( vec4( value.rgb * ${i[0]}, value.a ) );`,"}"].join(`
`)}const Qw={[Xv]:"Linear",[Yv]:"Reinhard",[Wv]:"Cineon",[qv]:"ACESFilmic",[Kv]:"AgX",[Zv]:"Neutral",[$v]:"Custom"};function Jw(r,e){const i=Qw[e];return i===void 0?(At("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+r+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+r+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const xf=new ne;function eR(){Jt.getLuminanceCoefficients(xf);const r=xf.x.toFixed(4),e=xf.y.toFixed(4),i=xf.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
`)}function tR(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Cc).join(`
`)}function nR(r){const e=[];for(const i in r){const s=r[i];s!==!1&&e.push("#define "+i+" "+s)}return e.join(`
`)}function iR(r,e){const i={},s=r.getProgramParameter(e,r.ACTIVE_ATTRIBUTES);for(let l=0;l<s;l++){const c=r.getActiveAttrib(e,l),f=c.name;let h=1;c.type===r.FLOAT_MAT2&&(h=2),c.type===r.FLOAT_MAT3&&(h=3),c.type===r.FLOAT_MAT4&&(h=4),i[f]={type:c.type,location:r.getAttribLocation(e,f),locationSize:h}}return i}function Cc(r){return r!==""}function Ev(r,e){const i=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,i).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Sv(r,e){return r.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const aR=/^[ \t]*#include +<([\w\d./]+)>/gm;function mm(r){return r.replace(aR,rR)}const sR=new Map;function rR(r,e){let i=kt[e];if(i===void 0){const s=sR.get(e);if(s!==void 0)i=kt[s],At('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,s);else throw new Error("Can not resolve #include <"+e+">")}return mm(i)}const oR=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Mv(r){return r.replace(oR,lR)}function lR(r,e,i,s){let l="";for(let c=parseInt(e);c<parseInt(i);c++)l+=s.replace(/\[\s*i\s*\]/g,"[ "+c+" ]").replace(/UNROLLED_LOOP_INDEX/g,c);return l}function Tv(r){let e=`precision ${r.precision} float;
...
#define LOW_PRECISION`),e}const cR={[Ef]:"SHADOWMAP_TYPE_PCF",[Rc]:"SHADOWMAP_TYPE_VSM"};function uR(r){return cR[r.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const fR={[yo]:"ENVMAP_TYPE_CUBE",[Rl]:"ENVMAP_TYPE_CUBE",[Ff]:"ENVMAP_TYPE_CUBE_UV"};function dR(r){return r.envMap===!1?"ENVMAP_TYPE_CUBE":fR[r.envMapMode]||"ENVMAP_TYPE_CUBE"}const hR={[Rl]:"ENVMAP_MODE_REFRACTION"};function pR(r){return r.envMap===!1?"ENVMAP_MODE_REFLECTION":hR[r.envMapMode]||"ENVMAP_MODE_REFLECTION"}const mR={[jv]:"ENVMAP_BLENDING_MULTIPLY",[eM]:"ENVMAP_BLENDING_MIX",[tM]:"ENVMAP_BLENDING_ADD"};function gR(r){return r.envMap===!1?"ENVMAP_BLENDING_NONE":mR[r.combine]||"ENVMAP_BLENDING_NONE"}function xR(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const i=Math.log2(e)-2,s=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:s,maxMip:i}}function _R(r,e,i,s){const l=r.getContext(),c=i.defines;let f=i.vertexShader,h=i.fragmentShader;const m=uR(i),p=dR(i),_=pR(i),b=gR(i),g=xR(i),y=tR(i),T=nR(c),C=l.createProgram();let S,E,N=i.glslVersion?"#version "+i.glslVersion+`
...
`)+`
`+E);const U=N+S+f,D=N+E+h,X=vv(l,l.VERTEX_SHADER,U),L=vv(l,l.FRAGMENT_SHADER,D);l.attachShader(C,X),l.attachShader(C,L),i.index0AttributeName!==void 0?l.bindAttribLocation(C,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(C,0,"position"),l.linkProgram(C);function z(k){if(r.debug.checkShaderErrors){const W=l.getProgramInfoLog(C)||"",de=l.getShaderInfoLog(X)||"",se=l.getShaderInfoLog(L)||"",Y=W.trim(),I=de.trim(),G=se.trim();let ee=!0,me=!0;if(l.getProgramParameter(C,l.LINK_STATUS)===!1)if(ee=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,C,X,L);else{const Ae=yv(l,X,"vertex"),P=yv(l,L,"fragment");on("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(C,l.VALIDATE_STATUS)+`
...
> ⏳ AI応答を待機中... (${Math.floor(lt*.8)}秒経過)`,Me=/\n> ⏳ AI応答を待機中\.\.\.\s*\(\d+秒経過\)/;return Me.test(Ye)?Ye.replace(Me,"")+He:Ye+He})},800),bt=[];let ht=null;for(let Ye=0;Ye<le.length;Ye++){const Oe=le[Ye],He=await new Promise(at=>{const Ot=new FileReader;Ot.onload=gi=>{const qr=gi.target.result,Kn=new Uint8Array(qr);let wt=!1;const Di="equirectangular";let Ti=0;for(let hn=0;hn<Math.min(Kn.length,65536);hn++)if(Kn[hn]===Di.charCodeAt(Ti)){if(Ti++,Ti===Di.length){wt=!0;break}}else Ti=0;const Zn=new Image;Zn.onload=()=>{const hn=Zn.naturalWidth/Zn.naturalHeight,_n=Math.abs(hn-2)<.15;at(_n&&wt)},Zn.onerror=()=>at(!1),Zn.src=URL.createObjectURL(Oe)};const jt=Oe.slice(0,65536);Ot.readAsArrayBuffer(jt)}),Me=new FileReader;Me.readAsDataURL(Oe),await new Promise(at=>{Me.onload=()=>{He&&!ht?(ht={base64:Me.result,mimeType:Oe.type},Yt(Ot=>Ot+`
> 🌐 360°背景画像を検出 (アスペクト比 2:1)。キャラシートとは分離して処理します...`)):(bt.push(Me.result),oe(Ot=>[...Ot,Me.result])),at()}})}if(ht)try{ln(!0),te(ht.base64);const Ye=ht.base64.split(",")[1],Oe={inlineData:{mimeType:ht.mimeType,data:Ye}};$e(Oe),ft(!0),Yt(Ot=>Ot+`
> 🌐 360°空間解析を実行中... (API通信保護のため順次処理)`);const at=(await co(`この360度パノラマ画像（equirectangular形式）を分析し、以下の情報を**必ずJSON形式**で返答してください。それ以外のテキストは一切出力しないでください。
...
}`,[Oe],null,()=>{})).text.match(/\{[\s\S]*\}/)?.[0];if(at){const Ot=JSON.parse(at);Ze(Ot),y(Ot.location),St(`🌐 360°背景を検出: ${Ot.location}`),Yt(jt=>jt+`
> 🌐 空間解析完了: ${Ot.location}`)}else Ze({location:"360°パノラマ画像",lighting:"自動解析",spatialType:"unknown",objects:"",mood:""}),y("360°パノラマ画像")}catch(Ye){console.warn("[360° BG] Analysis failed:",Ye),Ze({location:"360°パノラマ画像",lighting:"不明",spatialType:"unknown",objects:"",mood:""}),y("360°パノラマ画像（解析失敗）")}finally{ft(!1)}if(bt.length===0&&ht){clearInterval(nt),Ce(!1),Yt(Ye=>Ye+`
> 🌐 360°背景画像のみが検出されました。キャラクターシートも一緒にドロップしてください。`),St("360°背景画像を検出しました。キャラクターシートを追加してください。");return}if(bt.length===0){clearInterval(nt),Ce(!1);return}St(`思考モード: ${bt.length}枚のキャラクター設定画を同時解析中...${ht?"（+ 360°背景1枚検出済み）":""}`);try{const Ye=bt.map(Me=>{const at=Me.split(",")[1];return{inlineData:{mimeType:Me.split(";")[0].split(":")[1],data:at}}}),He=await co(`
...
--- ✅ 解析完了 ---
`,Ot=He.thought&&He.thought!=="通常処理が完了しました（思考トレースは利用不可）。"?`> [思考トレース]
${He.thought}`:"> 通常処理が完了しました（思考トレースは利用不可）。";return Me+at+Ot}),St("全キャラクターの解析が完了しました。"),Hn&&(Mi.current?(Pt(!1),si(0),wa(!1),St("⏹ フルオートを中断しました。")):kr(Me=>Me+1))}catch(Ye){console.error(Ye);const Oe=Vh(Ye.message);Yt(He=>He+`

[システムエラー]: ${Ye.message}
--------------------------------------------------
${Oe}`),St("解析エラー: "+Ye.message),Hn&&(Pt(!1),si(0),wa(!1))}finally{clearInterval(nt),Ce(!1)}},Hc=async()=>{if(!se||se.length<20)return St("先にシナリオを生成してください。");if(!(dt||Tt||Re||Ge||Se||ct||tn))return St("少なくとも1つの強化カテゴリをONにしてください。");if(Yn)return;Qa(!0),Ni("> [START] シナリオ強化を開始します..."),Mn||(ii(se),Ni(Ye=>Ye+`
...
> [API] ${l==="openai"?"OpenAI":"Gemini"} にシナリオ強化をリクエスト中...`);const Ye=await co(ht,[],W,Oe=>{Ni(He=>He+`
...
> [ERROR] ${Ye.message}`),St("強化エラー: "+Ye.message)}finally{clearInterval(bt),Qa(!1)}},zi=()=>{Mn&&(Y(Mn),ii(""),Ni(le=>le+`
> [REVERT] 元のシナリオに復元しました。`),St("シナリオを元に戻しました"))},is=async le=>{if(!W)return St("先にキャラクターを解析してください。");if(Ve)return;const lt=Array.isArray(le)?le:L;if(f==="manual"&&!m.trim()){alert("自由入力トピックを入力してください。");return}if(f==="news"&&!lt.find(Oe=>Oe.checked)){alert("少なくとも1つのカテゴリを選択してください。");return}gt(!0),H(""),me(""),Oi(null),Mt(""),be([]),ii(""),Ni("");let nt="";if(f==="manual")nt="手動入力",Y(""),H(`> コンテキスト強制リブート: 開始
 > モード: 手動入力 
 ...
 > 対象日付: ${$} 
 > Google Grounding で検索中...`)):nt="最新ニュース"}const bt=`${nt} -AI -人工知能 -ChatGPT -Gemini -生成AI -ロボット -テクノロジー -スマホ -IT`;let ht=0;const Ye=setInterval(()=>{ht++,H(Oe=>{if(ht<=8){const Ot=[".",".",".",`
> グローバルニュースデータベースをスキャン中...`,`
> トレンドトピックをクロスリファレンス中...`,`
> 関連記事をフィルタリング中...`,`
> ナラティブフレームワークを構築中...`];return Oe+Ot[Math.floor(Math.random()*Ot.length)]}const Me=`
   ...
   4. **【場所（Location）の選定義務】**:
      ...
      - **デフォルト回避**: 安易な「教室」「白い部屋」は避けるが、**ニュースの文脈（学生、学校関連）で必要ならば「教室」も許可する。**重要なのは「ニュースとの適合性」である。
       ...
       6. **【環境・リアクションのディテール注入 (Local RAG)】**:
        ...
        `,Kn=await co(gi,Xe&&pt?[Xe]:[],W,vn=>{H(Li=>Li+`
 > [API] ${vn} `)});P(Kn.model);let wt={topic:nt,scenario:""};try{const vn=Kn.text.match(/Topic:\s*(.+)/i),Li=Kn.text.match(/Logline:\s*(.+)/i),Ai=Kn.text.match(/Location:\s*(.+)/i),kn=Kn.text.match(/Outfit:\s*(.+)/i),ua=Kn.text.match(/Punchline:\s*(.+)/i),Bn=Kn.text.match(/Scenario:\s*([\s\S]+)/i);if(Bn)wt.topic=vn?vn[1].trim():nt,wt.topic=wt.topic.replace(/^Topic:\s*/i,"").trim(),wt.logline=Li?Li[1].trim():"",wt.location=Ai?Ai[1].trim():"Generic Background",wt.outfit=kn?kn[1].trim():"",wt.punchline=ua?ua[1].trim():"",wt.scenario=Bn[1].trim();else{const Ca=Kn.text.match(/\{[\s\S]*\}/);if(Ca){const Ht=JSON.parse(Ca[0]);wt.topic=Ht.topic||nt,wt.location=Ht.location||"Generic Background",wt.scenario=Ht.scenario||Kn.text}else{if(Kn.text.length<20)throw new Error("AI returned empty or invalid response.");wt.topic=f==="manual"?m||"Custom Scenario":_||"Generated Scenario",wt.scenario=Kn.text}}}catch(vn){console.warn("Parse warning:",vn),wt.scenario=Kn.text,wt.topic="Generated Scenario"}const Di=vn=>vn;wt.scenario=Di(wt.scenario),Y(wt.scenario);const Ti=wt.logline?`
Logline: ${wt.logline}`:"",Zn=T.trim()||wt.outfit?`
...
}`,Ai=(await co(vn,[Xe],null,kn=>{H(ua=>ua+`
 > [Camera AI] ${kn}`)})).text.match(/\{[\s\S]*\}/)?.[0];if(Ai){const kn=JSON.parse(Ai);We(kn);const ua=Ht=>["北(正面)","北東","東(右)","南東","南(背面)","南西","西(左)","北西"][Math.round((Ht%360+360)%360/45)%8],Bn=Ht=>({establishing_shot:"ロングショット",wide_shot:"ワイドショット",medium_shot:"ミドルショット",close_up:"クローズアップ",extreme_close_up:"超クローズアップ",over_the_shoulder:"肩越しショット",bird_eye:"俯瞰",worm_eye:"アオリ"})[Ht]||Ht;let Ca=`
 > 🎬 ══════ 360° カメラワーク設計完了 ══════`;kn.panels.forEach(Ht=>{Ca+=`
 > 🎬 コマ${Ht.panel}: ${ua(Ht.yaw)} (yaw:${Ht.yaw}°) / ${Bn(Ht.camera)} / FOV:${Ht.fov}°`,Ca+=`
 >    └─ ${Ht.reasoning}`}),Ca+=`
 > 🎬 ══════════════════════════════════`,H(Ht=>Ht+Ca),St("🎬 360°カメラワーク設計完了！背景クロップを開始...");try{H(On=>On+`
 > 🔲 [Crop] 360°画像から各コマの方角ビューをクロップ中...`);const Ht=[];for(const On of kn.panels){const Gi=await la(K,On.yaw,On.pitch||0,On.fov||90);Ht.push(Gi)}Bt(Ht),H(On=>On+`
...
🎬 360° Camera Work:`,kn.panels.forEach(Ht=>{sn+=`
  Panel${Ht.panel}: ${ua(Ht.yaw)}(${Ht.yaw}°) ${Bn(Ht.camera)} FOV${Ht.fov}° — ${Ht.reasoning}`})}else console.warn("[360° Camera AI] JSON parse failed, skipping camera work"),H(kn=>kn+`
...
Location: ${wt.location||"Unspecified"}${Zn}${hn}${_n}${sn}

${wt.scenario} `;return Y(Fn),Fn}catch(Oe){console.error(Oe);const He=Vh(Oe.message);return H(Me=>Me+`
...
`).forEach(rt=>{const st=rt.match(/^(.*?)(?:[:：]|「)/);if(st&&st[1].trim()){const Ct=st[1].replace(/^[【\[（(]/,"").replace(/[】\]）)]$/,"").trim();Ct&&!It.includes(Ct)&&It.push(Ct)}}),It.length>=2&&Qe.styleMulti){let rt=`
...
- Each bubble MUST point to its speaker. Flow: Right → Center → Left.`}else if(ke.length>=2){const Ke=Ot(ke[0]),rt=Ot(ke[1]);return`CRITICAL PLACEMENT & IDENTITY:
...
- Each bubble MUST point to its speaker. Do NOT swap bubble positions.`}else if(ke.length===1){const Ke=Ot(ke[0]);return`CRITICAL PLACEMENT & IDENTITY: [${ke[0]}] (${Ke||"see reference"}) is the main focus of this panel.`}return"CRITICAL PLACEMENT: Follow the natural dialogue flow."},Qi=xt=>{const Rt=xt.split(`
`),Qe=[],It={};W.split(`
`).forEach(yt=>{const en=yt.replace(/\*\*/g,"").trim().match(/^##\s*(?:\d+\.\s*)?(.*)/);if(en){const Vn=en[1].trim(),ei=Vn.split("(")[0].trim().split("（")[0].trim();ei&&(Qe.push(ei),It[ei]={name:ei,full:Vn})}});const ke=[];Rt.forEach(yt=>{const en=yt.match(/^(.*?)(?:[:：]|「)/);if(en&&en[1].trim()){let Vn=en[1].replace(/^(SFX|効果音|BGM|Action|状況|\(.*?\))/gi,"").replace(/^[【\[（(]/,"").replace(/[】\]）)]$/,"").trim();Vn&&!ke.includes(Vn)&&Qe.includes(Vn)&&ke.push(Vn)}});const Ke=[...ke],rt=xt;Qe.forEach(yt=>{!Ke.includes(yt)&&rt.includes(yt)&&Ke.push(yt)});let st=0;Rt.forEach(yt=>{const en=yt.trim();(en.includes("「")&&en.includes("」")||/^[^（(【\[]*?[:：]\s*「/.test(en))&&st++});const Ct=ke.slice(0,3).map(yt=>`[${yt}]`),Jn=Qe.filter(yt=>!Ke.includes(yt));Jn.length>0&&Jn.forEach(yt=>{Ke.includes(yt)||Ke.push(yt)});const rn=Ke.map(yt=>`[${yt}]`);if(Ct.length>0){let yt=`ANTI-CLONE REMINDER: ${rn.join(", ")} — each appears EXACTLY ONCE. If a character is mentioned in both the placement rule AND the visual action, they are the SAME person — do NOT draw a second copy.`;Ke.length===1&&st<=1?yt+=`
SOLO SHOT (SINGLE CHARACTER SCENE): Since only ${rn[0]} is listed, THIS IS A SOLO SHOT. Do NOT draw ANY other person. Do NOT draw a second copy of ${rn[0]}. Leave the surrounding space empty rather than adding people.`:Ke.length===1&&st>=2&&(yt+=`
NOTE: Multiple speech bubbles in this panel are ALL spoken by ${rn[0]} (monologue/soliloquy). Draw only ${rn[0]} — do NOT add a second character just because there are multiple bubbles.`);const en=Ct.join(" and "),Vn=rn.filter(Ms=>!Ct.includes(Ms)),ei=Vn.length>0?Vn.join(", "):"NO ONE ELSE",Na=`
...
${yt}${Na}`}else return"CRITICAL CAST PLACEMENT: Follow the panel's action naturally. NEVER draw the exact same character twice."};let tr="",nr="";const Il=W.split(`
...
Action (Visual ONLY): ${wi(Gi(hn,Qn(hn)))}.
...
Camera: ${Bn(_n)}.
[LENS]: (ABOVE CAMERA DISTORTION MAX:2.9), (NEVER normal photograph:3.0), (extreme severe perspective warp:2.7), (violently tilted horizon:2.6). Break normal camera angle.
Action (Visual ONLY): ${wi(Gi(_n,Qn(_n)))}.
...
Camera: ${Bn(sn)}.
[LENS]: (ABOVE CAMERA DISTORTION MAX:2.9), (NEVER normal photograph:3.0), (extreme severe perspective warp:2.7), (violently tilted horizon:2.6). Break normal camera angle.
Action (Visual ONLY): ${wi(Gi(sn,Qn(sn)))}.
...
Camera: ${Bn(Fn)}.
[LENS]: (ABOVE CAMERA DISTORTION MAX:2.9), (NEVER normal photograph:3.0), (extreme severe perspective warp:2.7), (violently tilted horizon:2.6). Break normal camera angle.
Action (Visual ONLY): ${wi(Gi(Fn,Qn(Fn)))}.
...
`+ir),await new Promise(xt=>setTimeout(xt,800));let Oo=OS(ir.trim());return D==="Documentary"&&(Oo=DS(Oo),Mt(xt=>xt+`
...
- "to"の表現は元と同程度の長さ・ディテールを維持すること。短縮・省略禁止。`,bt=await co(nt,[],null,Me=>{we(at=>at+`
> ${Me}`)});if(we(Me=>Me+`
> [Phase 3/5] AIの応答を受信・解析中...`),!bt.text||bt.text.trim().length<10){we(Me=>Me+`
> [ERROR] AIからの応答が空です。エラー情報をより詳しく入力して再試行してください。`);return}we(Me=>Me+`
> [Phase 4/5] 置換テーブルをプロンプトに適用中...`);let ht=[];try{let Me=bt.text.trim();const at=Me.match(/```(?:json)?\s*([\s\S]*?)```/);at&&(Me=at[1].trim());const Ot=Me.indexOf("["),jt=Me.lastIndexOf("]");Ot!==-1&&jt!==-1&&(Me=Me.substring(Ot,jt+1)),ht=JSON.parse(Me)}catch(Me){console.error("JSON parse error:",Me,"Raw:",bt.text),we(at=>at+`
...
- 修正後のプロンプト全文のみを出力してください。説明や前置きは不要です。`,lt=await co(le,[],null,nt=>{we(bt=>bt+`
...
> [Fallback ERROR] ${le.message}`)}};Ne.useEffect(()=>{To>0&&!Mi.current&&Vf()},[To]);const Vf=async()=>{if(!W||W.length<20){St("先にキャラクターシートをアップロードしてください。"),Pt(!1);return}Mi.current=!1,Pt(!0),Ea(!1),si(2);const le=[...L].sort(()=>Math.random()-.5),lt=Math.random()>.5?2:1,nt=le.slice(0,lt).map(He=>He.id),bt=L.map(He=>({...He,checked:nt.includes(He.id)}));z(bt),y(""),C(""),h("news"),await new Promise(He=>setTimeout(He,200)),Ao.current?.scrollIntoView({behavior:"smooth",block:"start"});const ht=await is(bt);if(Mi.current||!ht){Pt(!1),si(0),wa(!1),Mi.current&&St("⏹ フルオートを中断しました。");return}si(3),Dl.current?.scrollIntoView({behavior:"smooth",block:"start"}),await new Promise(He=>setTimeout(He,300));const Ye=await er(!0,ht);if(Mi.current||!Ye){Pt(!1),si(0),wa(!1),Mi.current&&St("⏹ フルオートを中断しました。");return}si(4),window.scrollTo({top:document.body.scrollHeight,behavior:"smooth"}),await new Promise(He=>setTimeout(He,300));const Oe=await Vc(!0,Ye);await new Promise(He=>setTimeout(He,800)),Ra.current?.scrollIntoView({behavior:"smooth",block:"center"}),an.current?Mi.current?(Pt(!1),si(0),wa(!1),St("⏹ 連続生成を中断しました。")):(St("🔄 連続生成モードON：次の作品を生成します..."),setTimeout(()=>{Mi.current||kr(He=>He+1)},2e3)):(Pt(!1),si(0),wa(!1),Oe&&St("🎉 フルオート生成完了！4コマ漫画が生成されました！"))},jf=()=>{if(Hn){Mi.current=!0,Si>0||Ee||Ve||et||vt?(wa(!0),St("⚠️ 中断処理中...（現在のステップが完了するまでお待ちください）")):(Pt(!1),si(0),wa(!1),St("フルオートを解除しました。"));return}Mi.current=!1,wa(!1),Pt(!0),W&&W.length>=20?kr(le=>le+1):St("🚀 フルオート待機中: キャラクターシートをドロップしてください")},Gt=!W||W.length<1?1:!se||se.length<1?2:ee?Zi?5:4:3;return x.jsxs("div",{className:"min-h-screen bg-[#0a0c10] text-slate-100 font-sans selection:bg-blue-500/30 overflow-x-hidden",children:[x.jsx(Lv,{isOpen:i,onSave:Gc,provider:"google"}),x.jsx(Lv,{isOpen:Hr,onSave:le=>{const lt=le.trim(),nt=Nf();lt===""&&nt?(Sa(!0),St("🔑 既存のOpenAI APIキーを適用しました。"),Ma(!1)):lt.startsWith("sk-")?(Hh(lt),Sa(!0),St("🔑 新しいOpenAI APIキーをセキュアに保存しました。"),Ma(!1)):alert("エラー：APIキーは 'sk-' から始まる文字列である必要があります。")},onClose:()=>{Ma(!1),Nf()||Sa(!1)},provider:"openai"}),x.jsxs("div",{className:"fixed top-0 left-0 right-0 z-[100] bg-[#0f1115] border-b border-white/10 px-2 md:px-8 py-2 md:py-3 shadow-xl w-full flex flex-col gap-2 md:gap-3 overflow-x-hidden",children:[x.jsxs("div",{className:"flex flex-wrap xl:flex-nowrap items-center justify-center max-w-7xl mx-auto w-full gap-y-3",children:[x.jsxs("div",{className:`flex flex-wrap items-center justify-center gap-2 md:gap-4 shrink-0 transition-opacity duration-300 ${r?"opacity-100":"opacity-30"}`,children:[x.jsxs("div",{className:`flex items-center gap-1.5 ${Gt>=1?"opacity-100":"opacity-40"}`,children:[x.jsx("div",{className:`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm ${Gt===1?"bg-blue-500 text-white shadow-[0_0_10px_rgba(59,130,246,0.6)]":Gt>1?"bg-blue-600/50 text-blue-200":"bg-white/10 text-white/50"}`,children:Gt>1?x.jsx(sl,{size:16}):"1"}),x.jsx("span",{className:"text-sm font-bold text-white tracking-wider",children:"解析"})]}),x.jsx(_c,{size:14,className:"text-white/30 shrink-0 mx-0.5 sm:mx-1"}),x.jsxs("div",{className:`flex items-center gap-1.5 ${Gt>=2?"opacity-100":"opacity-40"}`,children:[x.jsx("div",{className:`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm ${Gt===2?"bg-purple-500 text-white shadow-[0_0_10px_rgba(168,85,247,0.6)]":Gt>2?"bg-purple-600/50 text-purple-200":"bg-white/10 text-white/50"}`,children:Gt>2?x.jsx(sl,{size:16}):"2"}),x.jsx("span",{className:"text-sm font-bold text-white tracking-wider",children:"シナリオ"})]}),x.jsx(_c,{size:14,className:"text-white/30 shrink-0 mx-0.5 sm:mx-1"}),x.jsxs("div",{className:`flex items-center gap-1.5 ${Gt>=3?"opacity-100":"opacity-40"}`,children:[x.jsx("div",{className:`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm ${Gt===3?"bg-orange-500 text-white shadow-[0_0_10px_rgba(249,115,22,0.6)]":Gt>3?"bg-orange-600/50 text-orange-200":"bg-white/10 text-white/50"}`,children:Gt>3?x.jsx(sl,{size:16}):"3"}),x.jsx("span",{className:"text-sm font-bold text-white tracking-wider",children:"プロンプト"})]}),x.jsx(_c,{size:14,className:"text-white/30 shrink-0 mx-0.5 sm:mx-1"}),x.jsxs("div",{className:`flex items-center gap-1.5 ${Gt>=4?"opacity-100":"opacity-40"}`,children:[x.jsx("div",{className:`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm ${Gt===4?"bg-green-500 text-white shadow-[0_0_10px_rgba(34,197,94,0.6)]":Gt>4?"bg-green-600/50 text-green-200 shadow-[0_0_10px_rgba(34,197,94,0.3)]":"bg-white/10 text-white/50"}`,children:Gt>4?x.jsx(sl,{size:16}):"4"}),x.jsx("span",{className:"text-sm font-bold text-white tracking-wider",children:"画像生成　"})]})]}),x.jsx("div",{className:"hidden xl:block w-12 lg:w-16 shrink-0"}),x.jsxs("div",{className:"flex flex-wrap sm:flex-nowrap items-center justify-center gap-4 lg:gap-6 shrink-0 max-w-full",children:[x.jsxs("button",{disabled:!r||Ki,onClick:()=>{const le=!xn;ca(le),an.current=le},title:"ONにすると、フルオート完了時に同じキャラクターで永遠にシナリオ生成と画像生成を繰り返します。完全停止するにはフルオート中断を押してください。",style:{color:xn?"#dc2626":"#ffffff"},className:`min-w-[160px] flex items-center justify-center gap-1.5 px-4 py-3 rounded-xl text-sm font-black tracking-widest transition-all duration-100 border-2 border-b-4 select-none shrink-0 active:border-b-2 active:translate-y-0.5 ${xn?"bg-red-50 border-red-300 shadow-lg":"bg-[#2d3a4d] border-[#4a5568] hover:bg-[#3d4f66]"} disabled:opacity-50 disabled:cursor-not-allowed`,children:[x.jsx(o_,{size:14,className:xn?"animate-spin":"",style:{animationDuration:"3s"}}),x.jsx("span",{className:"whitespace-nowrap",children:xn?"無限ループ設定 解除":"無限ループ設定 ON"})]}),x.jsxs("button",{disabled:!r||Ki,onClick:jf,title:"画像をドロップするだけで4コマを全自動生成。完了後は自動OFF。生成中に押すと即中断。",style:{color:Hn?Ki?"#ffffff":"#dc2626":"#ffffff"},className:`min-w-[160px] flex items-center justify-center gap-1.5 px-4 py-3 rounded-xl text-sm font-black tracking-widest transition-all duration-100 border-2 border-b-4 select-none shrink-0 active:border-b-2 active:translate-y-0.5 ${Hn?Ki?"bg-slate-700 border-slate-500 shadow-none cursor-wait opacity-100":"bg-red-50 border-red-300 shadow-lg":"bg-[#2d3a4d] border-[#4a5568] hover:bg-[#3d4f66]"} ${!r&&!Ki?"opacity-50 cursor-not-allowed":""}`,children:[Hn?Ki?x.jsx(za,{size:14,className:"animate-spin"}):x.jsx(DE,{size:14,fill:"currentColor"}):x.jsx(vf,{size:14}),Hn?Ki?"停止処理中...":"フルオート中断":"⚡ フルオート ON"]}),x.jsx("div",{className:"hidden sm:block w-6 shrink-0"}),x.jsxs("div",{className:`flex flex-col justify-center text-[10.5px] leading-relaxed max-w-[600px] text-center sm:text-left transition-opacity duration-300 ${r?"text-slate-400":"text-slate-600 opacity-40"}`,children:[x.jsx("span",{className:"whitespace-normal",children:"　【⚡ フルオート ON】にして画像をドロップ、もしくはドロップ後に押す→全自動で生成。完了後は自動OFF。　"}),x.jsx("span",{className:"whitespace-normal",children:"　生成中は同ボタンで中断（以降はSTEPボタンで進行）。中断後再度押すと新シナリオで再生成を始めます。　"}),x.jsx("span",{className:"whitespace-normal",children:"　※「無限ループ設定」をONにしてフルオートを開始すると、完了後に自動で次の作品の生成を永遠に繰り返します。　"})]})]})]}),(l==="openai"||Wn)&&x.jsx("div",{className:"flex justify-center w-full max-w-7xl mx-auto px-2 pb-1",children:x.jsxs("button",{onClick:()=>{navigator.clipboard.writeText(`[ 🎨 ANTIGRAVITY EMOTIONAL CINEMA ENGINE v2.0 ]
...
- SELF-REVIEW: After drawing, carefully verify finger count on all hands (exactly 5), check for text errors, and fix internally before displaying the final result.`),Ro(!0),setTimeout(()=>Ro(!1),2e3)},title:"Web版ChatGPT用の1枚絵エモーショナル演出プロンプトをクリップボードにコピーします。指示内容の感情を自動検知し、カメラ・ライティング・表情・VFXを最適化します。",className:`w-full flex flex-wrap items-center justify-center gap-2 sm:gap-4 px-4 py-2.5 sm:py-3 rounded-xl text-sm font-black tracking-widest transition-all duration-100 border-2 border-b-4 select-none active:border-b-2 active:translate-y-0.5 shadow-lg ${Ss?"bg-white border-green-500 text-green-600":"bg-white border-slate-300 hover:bg-slate-50 text-[#2d3a4d]"}`,children:[x.jsxs("div",{className:"flex items-center gap-1.5 shrink-0",children:[Ss?x.jsx(sl,{size:16}):x.jsx(vc,{size:16}),x.jsx("span",{className:"whitespace-nowrap",children:Ss?"コピー完了！":"🎬 1枚絵 ChatGPT用 感情シネマプロンプトをコピー"})]}),x.jsx("span",{className:"text-[10px] md:text-[11px] font-normal tracking-normal whitespace-normal text-center text-slate-500",children:"【1枚絵用】ChatGPTにキャラ画像を添付→指示を書く→このプロンプトを貼り付けて送信。指示の文脈からエモーショナルな演出を自動で適用します。"})]})}),x.jsx("div",{className:"absolute bottom-0 left-0 h-[2px] bg-white/10 w-full",children:x.jsx("div",{className:`h-full transition-all duration-700 ease-out
          ...
          `})})]}),x.jsxs("div",{className:"fixed inset-0 pointer-events-none overflow-hidden z-0",children:[x.jsx("div",{className:"absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-blue-900/10 blur-[120px] rounded-full"}),x.jsx("div",{className:"absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-purple-900/10 blur-[120px] rounded-full"})]}),x.jsxs("div",{className:"relative z-10 max-w-5xl mx-auto px-4 pb-4 pt-[130px] md:px-10 md:pb-10 md:pt-[150px] space-y-8",children:[x.jsxs("header",{className:"flex flex-col items-center justify-center gap-6 bg-[#0f1115] p-6 md:p-8 rounded-xl border border-white/5 shadow-2xl relative overflow-hidden group",children:[x.jsx("div",{className:"absolute top-0 right-0 w-64 h-64 bg-blue-500/5 blur-[80px] rounded-full pointer-events-none"}),x.jsx("div",{className:"flex flex-col items-center text-center z-10 w-full",children:x.jsx("div",{className:"flex flex-col items-center justify-center gap-2 mb-2 w-full max-w-full overflow-hidden",children:x.jsxs("div",{className:"flex flex-col items-center text-center max-w-full",children:[x.jsxs("div",{className:"flex flex-row items-center justify-center gap-3 flex-nowrap text-center",children:[x.jsx("div",{className:"p-2 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-xl shadow-lg shadow-blue-500/20 shrink-0",children:x.jsx(Sp,{size:28,className:"text-white"})}),x.jsxs("h1",{className:"text-xl md:text-4xl font-black tracking-tighter text-blue-400 drop-shadow-[0_0_10px_rgba(59,130,246,0.8)] whitespace-nowrap",children:["Super FURU AI ",x.jsx("span",{className:"text-white text-lg md:text-3xl ml-1 tracking-widest",children:"4-koma System"})," ",x.jsx("span",{className:"text-lg md:text-3xl text-yellow-500 font-mono ml-2",children:mo})]})]}),x.jsxs("div",{className:"flex flex-col md:flex-row items-center justify-center gap-3 mt-2",children:[x.jsx("p",{className:"text-[10px] font-bold text-slate-400 uppercase tracking-[0.4em]",children:"Social Satire Engine [ 演出強化版 ]"}),x.jsxs("div",{className:`flex items-center gap-1.5 px-2.5 py-1 rounded-full border text-[10px] font-black tracking-wider ${r?l==="openai"?"bg-emerald-500/15 border-emerald-500/40 text-emerald-400":"bg-green-500/15 border-green-500/40 text-green-400":"bg-red-500/15 border-red-500/40 text-red-400 animate-pulse"}`,children:[x.jsx("span",{className:`w-1.5 h-1.5 rounded-full ${r?l==="openai"?"bg-emerald-400 shadow-[0_0_6px_rgba(16,185,129,0.8)]":"bg-green-400 shadow-[0_0_6px_rgba(74,222,128,0.8)]":"bg-red-400"}`}),r?l==="openai"?"✅ ChatGPT Engine":"✅ Gemini Engine":"⚠ 未接続"]}),r&&x.jsxs("div",{className:"flex items-center gap-2",children:[x.jsxs("button",{onClick:Xr,className:"flex items-center gap-1.5 bg-white/5 hover:bg-white/10 text-slate-300 px-3 py-1.5 rounded-lg text-xs font-bold transition-colors border border-white/10",title:"キャラクター解析を保持したまま、シナリオ・プロンプト・画像をリセットします",children:[x.jsx(o_,{size:12})," シナリオから再生成"]}),x.jsxs("button",{onClick:kf,className:"flex items-center gap-1.5 bg-red-950/50 hover:bg-red-900/60 text-red-300 px-3 py-1.5 rounded-lg text-xs font-bold transition-colors border border-red-500/20",title:"全データを消去してAPIキーの再入力画面に戻ります（エンジン切替もこちら）",children:[x.jsx(AE,{size:12})," エンジン変更・全リセット"]})]})]}),Ae&&(()=>{const le=De(Ae);return le?x.jsxs("div",{className:`mt-3 inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/10 ${le.color} shadow-lg animate-in fade-in slide-in-from-top-2 cursor-help group/badge relative`,children:[x.jsx("span",{className:"text-[10px] font-black uppercase tracking-widest",children:le.label}),x.jsx("span",{className:"w-[1px] h-3 bg-white/40"}),x.jsx("span",{className:"text-[10px] font-bold truncate max-w-[150px] md:max-w-none",children:le.desc}),x.jsxs("div",{className:"absolute left-0 top-full mt-2 w-64 p-3 bg-[#0f1115] border border-white/20 rounded-xl text-[10px] text-slate-300 z-50 invisible group-hover/badge:visible shadow-2xl backdrop-blur-xl",children:[x.jsx("p",{className:"font-bold text-white mb-1 border-b border-white/10 pb-1",children:"AIモデル品質情報"}),x.jsxs("p",{children:["現在 ",x.jsx("span",{className:"font-mono text-blue-300",children:Ae})," を使用中。"]}),le.tier==="Lite"&&x.jsxs("div",{className:"mt-2 text-yellow-500 bg-yellow-500/10 p-2 rounded relative",children:[x.jsx(c_,{size:10,className:"absolute top-2 right-2"}),x.jsx("span",{className:"font-bold block mb-1",children:"⚠️ 品質制限モード"}),"API制限(429)回避のため、軽量モデルを使用中。生成品質が低下する場合があります。上限解除までお待ちください。"]})]})]}):null})()]})})})]}),x.jsxs("main",{className:"space-y-8",style:{filter:r?"none":"blur(10px)",pointerEvents:r?"auto":"none",transition:"filter 0.5s ease"},children:[x.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-8",children:[x.jsxs("section",{onDragOver:le=>{le.preventDefault(),r&&Q(!0)},onDragLeave:()=>Q(!1),onDrop:le=>{le.preventDefault(),Q(!1),r&&Js(le.dataTransfer.files)},className:`group p-8 rounded-xl border-2 transition-all flex flex-col relative overflow-hidden duration-500 min-h-[300px] justify-center
      ...
      `,children:[(Gt<2||Ee)&&x.jsx("div",{style:{position:"absolute",inset:-2,zIndex:200,backgroundColor:"rgba(10,12,16,0.92)",backdropFilter:"blur(8px)",WebkitBackdropFilter:"blur(8px)",pointerEvents:"auto",borderRadius:"0.875rem"}}),x.jsx("div",{className:"flex items-center justify-between",children:x.jsxs("div",{className:`flex items-center gap-3 text-xs font-black uppercase tracking-widest ${Gt===2?"text-purple-400":"text-slate-500"} `,children:[x.jsx(yE,{size:18})," STEP 02: シナリオ構築設定 (Scenario Settings)"]})}),x.jsxs("div",{className:"flex flex-col gap-6 mt-4",children:[x.jsxs("div",{className:"grid grid-cols-2 gap-4 p-1 bg-slate-900/50 rounded-2xl border border-white/5",children:[x.jsxs("button",{onClick:()=>h("news"),className:`py-4 rounded-xl text-sm font-black tracking-widest transition-all 
