...
`).filter(h=>{const m=h.trim();return/^\[EMOTION:/i.test(m)||/^状況(?:演出)?[：:]/i.test(m)||/^\[\d+コマ目/i.test(m)?!1:m.includes("：")||m.includes(":")||m.includes("「")}),l=[],c={};e.split(`
