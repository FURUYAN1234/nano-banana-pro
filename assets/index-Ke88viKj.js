...
- 修正後のプロンプト全文のみを出力してください。説明や前置きは不要です。`,sM=r=>{const{safeTopic:e,watermarkEng:i,styleCore:s,safeLocation:l,bg360Image:c,bg360Analysis:u,bg360Enabled:h,bg360CroppedPanels:m,enableChatGPTMode:p,VAR_CAST_LIST_CHATGPT:x,identityMatrix:v,activeOutfit:g,panelSections:b}=r,M=c&&u&&h?m&&m.length===4&&!p?`
...
`},rM=r=>{const{safeTopic:e,watermarkEng:i,styleCore:s,safeLocation:l,bg360Image:c,bg360Analysis:u,bg360Enabled:h,bg360CroppedPanels:m,VAR_CAST_LIST:p,identityMatrix:x,activeOutfit:v,dynamicCamera:g,panelSections:b}=r,M=c&&u&&h?m&&m.length===4?`
BACKGROUND REFERENCE IMAGES (Per-Panel Cropped Views):
4 background reference images are attached after the text prompt. These are NOT character sheets.
- Image 1 → Background for Panel 1
- Image 2 → Background for Panel 2
...
`)[0].substring(0,20);b=b.replace(/^Topic:\s*/i,"").trim();const M=r.match(/Location:\s*(.*?)(\n|$)/i)?.[1]?.trim(),A=r.match(/Outfit:\s*(.*?)(\n|$)/i)?.[1]?.trim(),S=M||"Generic Detailed Background",y=A&&!/^(なし|キャラシート準拠|none|default)/i.test(A)?A:"";let R=r.replace(/```(?:json|markdown)?/gi,"").trim();R=R.replace(/Generated by.*?$/i,"").trim();const O=mu(R,"1コマ目","2コマ目")||R,U=mu(R,"2コマ目","3コマ目"),G=mu(R,"3コマ目","4コマ目"),I=mu(R,"4コマ目","UNKNOWN"),B=hM(nE).slice(0,4),w={index:0},F=dM(e,y),$=s?lM(F):F,k=S,X=b||"4-koma Manga",te=s?`Generated by ChatGPT with Super FURU AI 4-koma ${p}`:`Generated by Gemini with Super FURU AI 4-koma ${p}`;let oe="";const V=[O,U,G,I];let L="";s?(L=V.map((W,ce)=>`## Panel ${ce+1}
${N_(W)}
...
`),oe=sM({safeTopic:X,watermarkEng:te,styleCore:v,safeLocation:k,bg360Image:l,bg360Analysis:c,bg360Enabled:u,bg360CroppedPanels:h,enableChatGPTMode:s,VAR_CAST_LIST_CHATGPT:$,identityMatrix:hp(e),activeOutfit:y,panelSections:L})):(L=V.map((ce,ge)=>`## Panel ${ge+1}
${N_(ce)}
${pu(ce,e)}
${C_(ce,e)}
Camera: ${oM(ce,B,w)}.
...
[システムエラー]: ${Me.message}
--------------------------------------------------
${at}`),gt("解析エラー: "+Me.message),Gi.current&&(Fn(!1),bi(0),Zn(!1))}finally{clearInterval(ut),Ge(!1)}},Jo=async()=>{if(!oe||oe.length<20)return gt("先にシナリオを生成してください。");if(!(Fe||We||rn||Kn||Fi||ta||In))return gt("少なくとも1つの強化カテゴリをONにしてください。");if(En)return;li(!0),Un("> [START] シナリオ強化を開始します..."),ci||(zi(oe),Un(lt=>lt+`
> [SAVE] 元のシナリオを保存しました（元に戻すボタンで復元可能）`));const Ut=[];Fe&&Ut.push("【表情データベースによる表情の強化】各キャラの表情描写を限界まで大げさ・劇的にしてください（基準ウェイト2.5〜3.0相当）。..."),We&&Ut.push("【ボディランゲージの強化】棒立ちの状態を禁止します。通常の2倍以上の過剰なアクションで全身で感情を表現してください（基準ウェイト2.5〜3.0相当）。"),rn&&Ut.push("【照明・演出の強化】各コマの「状況」欄に映画的・劇画的な演出効果を限界突破レベルで追加してください。"),Kn&&Ut.push("【背景の強化】各コマの背景描写に奥行きと空間の説得力を追加してください。"),Fi&&Ut.push("【カメラワークの強化】各コマに極限的なカメラアングル指示を追加してください。"),ta&&Ut.push("【セリフ・ギャグの強化 — お笑い構造メソッド適用】4コマ漫画の笑いの構造を根本から再設計してください。"),Un(lt=>lt+`
...
--- ✅ シナリオ強化完了 (思考トレース) ---
`+lt.thought:nt}),Re(!1),it(!1),Dt(!1),Ln(!1),ea(!1),Bi(!1),gn(!1),gt("シナリオ強化完了！")):(Un(wt=>wt+`
...
> 禁止コンテンツタグをチェック中...`,`
> 風刺ロジックを注入中...`,`
> 4コマ構造を最終化中...`];if(!St)return nt;const at=Me[Math.floor(Math.random()*Me.length)];return nt+at})},600);try{const nt=pM({scenario:ut,castList:X,colorMode:D,enableChatGPTMode:lt,bg360Image:Qe,bg360Analysis:Wt,bg360Enabled:jn,bg360CroppedPanels:sn,punchlineType:U,systemVersion:Ql});return await new Promise(Me=>setTimeout(Me,800)),U==="Documentary"&&At(Me=>Me+`
...
[システムエラー]: ${nt.message}
--------------------------------------------------
${Me}`),gt("生成エラー: "+nt.message),null}finally{clearInterval(wt),dt(!1)}};Ce.useEffect(()=>{W&&!St&&uc>=3&&kr()},[xi]);const hf=()=>{V(""),ce(""),Rn(null),Et(""),At(""),ye([]),Fn(!1),bi(0),b(""),A(""),pt(null),Lt(null),Ft(null),Zt(null),vi(null),ti(!1),B(Th),p(""),v(""),y(""),O(""),ui(!1),G("Auto"),h("news"),zi(""),Re(!1),it(!1),Dt(!1),Ln(!1),ea(!1),Bi(!1),gn(!1),li(!1),Un(""),xa(!1),fe(""),Le(!1),Ne(""),rt(!1),ct(!1),Pe.current="",He(!1),Be(!1),gt("シナリオ以降をリセットしました。キャラクター解析は保持しています。")},pf=()=>{te(""),V(""),ce(""),Oe([]),Rn(null),kt(""),Et(""),At(""),Fn(!1),bi(0),b(""),A(""),pt(null),Lt(null),Ft(null),Zt(null),vi(null),ti(!1),P(null),ys([]),ye([]),B(Th),p(""),v(""),y(""),O(""),ui(!1),G("Auto"),h("news"),zi(""),Re(!1),it(!1),Dt(!1),Ln(!1),ea(!1),Bi(!1),gn(!1),li(!1),Un(""),xa(!1),fe(""),Le(!1),Ne(""),rt(!1),ct(!1),Pe.current="",ne(!1),He(!1),Be(!1),e(""),Hu(""),fp(""),Ah(""),c(""),Ti(!1),Mi(!1),s(!0),gt("全データをリセットしました。APIキーを再入力してください。")},[mf,Vr]=Ce.useState(!1),[gf,xf]=Ce.useState(!1),[_f,vf]=Ce.useState(!1),bf=()=>{W&&(navigator.clipboard.writeText(W),Vr(!0),setTimeout(()=>Vr(!1),2e3),Ie||Pe.current?(rt(!0),ct(!1),gt("📋 コピーしました → Web版に貼り付けて、下の🛡️救済パネルで手動対応できます")):gt("クリップボードにコピーしました！"))},jr=async(Mt=!1,Ut=null)=>{const xt=Ut||W;if(Ve||!Mt&&!xt)return!1;Pt(!0),mn(!1),fe(""),Pe.current="",ct(!1);const ut=["[1/5] プロンプトパラメータをロック中...","[2/5] セーフティフィルターを検証中..."];xi&&(l==="openai"?ut.push("[2.5/5] ✅ ChatGPT Engine: プロンプト最適化を適用中..."):ut.push("[2.5/5] ⚠️ [ChatGPT Mode] 有効: プロンプト構造の特殊最適化を適用中...")),ye(ut);let lt=0;const wt=setInterval(()=>{lt++;const nt=Math.floor(lt*1.5);ye(Me=>{const at=Me.findIndex(jt=>jt.startsWith("[WAIT]"));if(at!==-1){const jt=[...Me];return jt[at]=`[WAIT] ⏳ 画像生成API応答を待機中... (${nt}秒経過)`,jt}return[...Me,`[WAIT] ⏳ 画像生成API応答を待機中... (${nt}秒経過)`]})},1500);await new Promise(nt=>setTimeout(nt,800));try{gt(xn?"OpenAI (ChatGPT Images 2.0) に送信中...":"Google AI (Gemini/Imagen) に送信中..."),ye(st=>[...st,"[3/5] クラウドAPIへ接続中...","[3/5] プロンプトデータをアップロード中..."]),await new Promise(st=>setTimeout(st,1e3));const nt=st=>{ye(Qt=>[...Qt,st])};let Me,at;if(xn){nt("[INFO] ⏳ gpt-image-2 の画像生成には通常2〜5分かかります。しばらくお待ちください...");const st=await eE(xt,nt);Me=st.base64Img,at=st.usedModel}else{const st=sn&&jn&&sn.length===4?sn:[];st.length>0&&nt(`[REF] 360°背景クロップ画像 ${st.length}枚を参照画像として添付`);const Qt=await VE(xt,nt,st);Me=Qt.base64Img,at=Qt.usedModel}ye(st=>[...st,`[4/5] データストリーム受信完了 (Model: ${at})`,"[5/5] Base64画像データをデコード・レンダリング中..."]);const jt=`data:image/png;base64,${Me}`;Rn(jt),ys(st=>[{id:Date.now(),img:jt},...st]);const tt=at&&at.startsWith("gpt-");return at&&!at.startsWith("gemini-3")&&!tt?(_e(!0),ye(st=>[...st,"[WARNING] 最新モデル(Nano Banana 2)への接続がタイムアウト等で失敗しました。","[WARNING] 代わりに下位APIで妥協版を出力したため、描写が大きく崩れている可能性があります。","[GUIDE] ★手動生成を推奨します★","[GUIDE] 1. 「プロンプトをコピー」ボタンを押す",`[GUIDE] 2. ${xn?"ChatGPT":"Gemini"}(Web版)を開く: ${xn?"https://chatgpt.com/":"https://gemini.google.com/app"}`,"[GUIDE] 3. 「元となるキャラクターシート画像」を一緒に添付する",`[GUIDE] 4. 貼り付けて${xn?"送信する":"「思考モード」で送信する"}`,"[COMPLETE] Image successfully generated (with warnings)."])):(_e(!1),ye(st=>[...st,"[COMPLETE] Image successfully generated."])),gt("画像生成完了！"),!0}catch(nt){console.error(nt),mn(!0),Rn(null);const Me=nt.message||"";let at=[];return Me.includes("Unknown parameter")||Me.includes("Invalid parameter")?at=[`[ERROR GUIDE] ⚙️ APIパラメータの形式が不正です（${xn?"OpenAI":"Google"}側の仕様変更の可能性）。`,"[ERROR GUIDE] 【原因】AIモデルの仕様更新により、送信パラメータが合わなくなっている可能性があります。","[ERROR GUIDE] 【対処法】お手数ですが以下の手動手順で画像を生成してください。","[ERROR GUIDE] 1. 画面左下の「プロンプトをコピーする」ボタンを押します。",`[ERROR GUIDE] 2. ${xn?"ChatGPTウェブ版":"Geminiウェブ版"} を開きます: ${xn?"https://chatgpt.com/":"https://gemini.google.com/app"}`,"[ERROR GUIDE] 3. コピーしたプロンプトを貼り付け、元の「キャラクター設定画像」を一緒に添付して送信してください。"]:Me.includes("sensitive")||Me.includes("Responsible AI")||Me.includes("content_policy_violation")||Me.includes("400")&&(Me.includes("safety")||Me.includes("policy")||Me.includes("violation")||Me.includes("sensitive"))?(fe(Me),Pe.current=Me,ct(!0),at=["[ERROR GUIDE] 🚨 表現の一部がAIの安全基準（ポリシー）に触れたため、生成がスキップされました。","[ERROR GUIDE] 【自動修正】「自動修正して再生成する」を押すと、安全な言葉に書き換えて自動で作り直します。","[ERROR GUIDE] 【手動生成】プロンプトをコピーし、公式のウェブ版チャット等に貼り付けて直接お試しください。"]):Me.includes("not found")||Me.includes("not supported")||Me.includes("404")||Me.includes("403")||Me.includes("401")?(Ai&&(ni.current=!0),at=[`[ERROR GUIDE] 🔑 現在のAPIキーでは、本アプリ経由での画像生成が許可されていないか、無効になっています（${xn?"OpenAI":"Google"}の権限設定）。`,"[ERROR GUIDE] 【対処法】本アプリでの自動生成は一旦諦め、以下の手順で公式ウェブ版から手動で生成してください。","[ERROR GUIDE] 1. 画面左下の「プロンプトをコピーする」ボタンを押します。",`[ERROR GUIDE] 2. ${xn?"ChatGPTウェブ版":"Geminiウェブ版"} を開きます: ${xn?"https://chatgpt.com/":"https://gemini.google.com/app"}`,"[ERROR GUIDE] 3. コピーしたプロンプトを貼り付け、元の「キャラクター設定画像」を一緒に添付して送信してください。"]):at=[`[ERROR GUIDE] ⏲️ 接続タイムアウト、または一時的な通信エラーで生成に失敗しました（${xn?"OpenAI":"Google"}サーバーの混雑など）。`,"[ERROR GUIDE] 【対処法】数分時間を置いてから「画像を生成する」を再度試すか、以下の手順で公式ウェブ版から生成してください。","[ERROR GUIDE] 1. 画面左下の「プロンプトをコピーする」ボタンを押します。",`[ERROR GUIDE] 2. ${xn?"ChatGPTウェブ版":"Geminiウェブ版"} を開きます: ${xn?"https://chatgpt.com/":"https://gemini.google.com/app"}`,"[ERROR GUIDE] 3. コピーしたプロンプトを貼り付け、元の「キャラクター設定画像」を一緒に添付して送信してください。"],ye(jt=>[...jt,`[ERROR] ${nt.message} `,"[SYSTEM] Sequence Aborted.","--------------------------------------------------",...at]),gt(`生成エラー: ${nt.message} `),!1}finally{clearInterval(wt),Pt(!1)}},yf=async()=>{if(!W||!Ie.trim())return;Le(!0),Ne("> [Phase 0/5] コンテンツポリシーアドバイザーを起動中...");let Mt=0;const Ut=setInterval(()=>{Mt++,Ne(xt=>{const lt=`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:gs,depthTest:!1,depthWrite:!1})}function hv(){return new Va({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:uf(),fragmentShader:`
		...
		`,blending:gs,depthTest:!1,depthWrite:!1})}function pv(){return new Va({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:uf(),fragmentShader:`
...
`].filter(Wl).join(`
`)),u=am(u),u=Mv(u,i),u=Tv(u,i),h=am(h),h=Mv(h,i),h=Tv(h,i),u=Av(u),h=Av(h),i.isRawShaderMaterial!==!0&&(R=`#version 300 es
...
`)+`
`+y);const O=R+S+u,U=R+y+h,G=yv(l,l.VERTEX_SHADER,O),I=yv(l,l.FRAGMENT_SHADER,U);l.attachShader(A,G),l.attachShader(A,I),i.index0AttributeName!==void 0?l.bindAttribLocation(A,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(A,0,"position"),l.linkProgram(A);function B(k){if(r.debug.checkShaderErrors){const X=l.getProgramInfoLog(A)||"",te=l.getShaderInfoLog(G)||"",oe=l.getShaderInfoLog(I)||"",V=X.trim(),L=te.trim(),z=oe.trim();let W=!0,ce=!0;if(l.getProgramParameter(A,l.LINK_STATUS)===!1)if(W=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,A,G,I);else{const ge=Ev(l,G,"vertex"),P=Ev(l,I,"fragment");Jt("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(A,l.VALIDATE_STATUS)+`
