...
`),s=[],l={};e.split(`
`).forEach(M=>{const A=M.replace(/\*\*/g,"").trim().match(/^##\s*(?:\d+\.\s*)?(.*)/);if(A){const S=A[1].trim(),y=S.split("(")[0].trim().split("（")[0].trim();if(y){s.includes(y)||s.push(y),l[y]={name:y,full:S};const R=S.match(/[\(（]\s*(.*?)\s*[\)）]/);if(R){const D=R[1].trim();s.includes(D)||s.push(D),l[D]={name:y,full:S}}}}});const c=[];i.forEach(M=>{const A=M.match(/^(.*?)(?:[:：]|「)/);if(A&&A[1].trim()){let S=A[1].replace(/^(SFX|効果音|BGM|Action|状況(?:演出)?|[\(（].*?[\)）])/gi,"").replace(/^[【\[（(]/,"").replace(/[】\]）)]$/,"").trim();if(S){if(S==="全員"||S==="Speaker")return;const y=s.find(R=>S===R||S.includes(R)||R.includes(S));if(y){const R=l[y].name;c.includes(R)||c.push(R)}else Vo(S,s)&&(c.includes(S)||c.push(S))}}});const u=[];i.forEach(M=>{const A=M.match(/^(.*?)(?:[:：]|「)/);let S=!1;if(A&&A[1].trim()){let y=A[1].replace(/^(SFX|効果音|BGM|Action)/i,"").trim();y=y.replace(/^[【\[（(]/,"").replace(/[】\]）)]$/,"").trim();const R=/[がをにでへはもとからまでより]/.test(y)&&y.length>5,D=y.length>12,U=/^(Camera|Location|Outfit|EMOTION|状況(?:演出)?|Action|リアクション|Reaction|設定|聴覚|触覚|嗅覚|体内感覚|視覚|物理描写|SFX|効果音|BGM|ナレーション|テロップ|背景|Background|カメラワーク|CameraWork|Camera\s*Work)$/i.test(y),G=/^[^a-zA-Z]*([\u3040-\u309F\u30A0-\u30FF\u4E00-\u9FFF])([ーッっ]*\1){1,}[ーッっ！!ン]*$/u.test(y.replace(/[（(].*$/,"").trim()),I=/[（(]\s*リアクション/i.test(A[1]);R||D||U||G||I||(Vo(y,s)||y==="全員"||y==="Speaker"||A[0].trim().endsWith(":")||A[0].trim().endsWith("："))&&(S=!0)}else if(!M.trim().startsWith("%NOTHING%")){if(M.trim().startsWith("「")){const y=M.trim();if(/^「[^」]+」[？！。、!?\s]*$/.test(y)){const D=y.match(/^「([^」]+)」/)?.[1]||"",U=/(?:ポーズ|表情|リアクション|アクション|身振り|手振り|仕草|動作|姿勢|佇まい|構え|目線|視線|沈黙|間|無言|独白|ジェスチャー|モーション|立ち姿|座り|しぐさ|ため息|溜息|息|うなずき|頷き|首振り|指差し|腕組み|ガッツポーズ|ドヤ顔|苦笑い|苦笑|微笑|爆笑|号泣|絶叫|フリーズ|硬直|脱力|崩れ落ち|土下座|敬礼|拍手|握手|ハイタッチ|決めポーズ|威圧|威嚇|震え|よろめき|のけぞり|ずっこけ|ツッコミ|突っ込み)/.test(D),G=D.length<=4&&!/[がをにでへはもとからよねわ！？!?…。、]/.test(D);!U&&!G&&(S=!0)}}}S||u.push(M)});const h=u.join(`
...
Do NOT draw ${g.map(G=>`[${G}]`).join(", ")} in this panel. They are completely absent from this scene.`);const D=`
...
${M}${D}`}else{let M="";return v.length>0&&(M=`
...
`)[0].substring(0,20);b=b.replace(/^Topic:\s*/i,"").trim();const M=r.match(/Location:\s*(.*?)(\n|$)/i)?.[1]?.trim(),A=r.match(/Outfit:\s*(.*?)(\n|$)/i)?.[1]?.trim(),S=M||"Generic Detailed Background",y=A&&!/^(なし|キャラシート準拠|none|default)/i.test(A)?A:"";let R=r.replace(/```(?:json|markdown)?/gi,"").trim();R=R.replace(/Generated by.*?$/i,"").trim();const D=mu(R,"1コマ目","2コマ目")||R,U=mu(R,"2コマ目","3コマ目"),G=mu(R,"3コマ目","4コマ目"),I=mu(R,"4コマ目","UNKNOWN"),B=pM(iE).slice(0,4),w={index:0},F=hM(e,y),$=s?cM(F):F,k=S,X=b||"4-koma Manga",te=s?`Generated by ChatGPT with Super FURU AI 4-koma ${p}`:`Generated by Gemini with Super FURU AI 4-koma ${p}`;let oe="";const V=[D,U,G,I];let L="";s?(L=V.map((W,ce)=>`## Panel ${ce+1}
${O_(W)}
...
}`,W=(await Fr(L,[g],null,A)).text.match(/\{[\s\S]*\}/)?.[0];if(W){oe=JSON.parse(W),A("🔲 [Crop] 360°画像から各コマの方角ビューをクロップ中..."),V=[];for(const ce of oe.panels){const ge=await QE(p,ce.yaw,ce.pitch||0,ce.fov||90);V.push(ge)}}}catch(L){console.warn("[360° Camera AI] Camera work design failed:",L),A(`⚠️ [Camera AI] カメラワーク設計に失敗しました: ${L.message}`)}return{topic:te.topic,logline:te.logline,location:te.location,outfit:te.outfit,punchline:te.punchline,scenario:te.scenario,cameraWork:oe,croppedPanels:V,usedModel:X.model,thought:X.thought}}async function xM({scenario:r,enhanceCategories:e,castList:i,styleJson:s,onProgress:l}){const c=nM(r,e,s),u=await Fr(c,[],i,l);return{text:u.text.trim(),usedModel:u.model,thought:u.thought}}async function Rh({finalPrompt:r,policyErrorMsg:e,onProgress:i,selectedEngine:s}){if(!r||!e)throw new Error("プロンプトとエラーメッセージが必要です。");i("[Phase 1/5] エラーメッセージを解析中..."),i("[Phase 2/5] 問題箇所の特定をAIにリクエスト中...");const l=aM(e.trim(),r),c=await Fr(l,[],null,i);if(i("[Phase 3/5] AIの応答を受信・解析中..."),!c.text||c.text.trim().length<10)throw new Error("AIからの応答が空です。エラー情報をより詳しく入力して再試行してください。");i("[Phase 4/5] 置換テーブルをプロンプトに適用中...");let u=[],h=!1;try{let x=c.text.trim();const v=x.match(/```(?:json)?\s*([\s\S]*?)```/);v&&(x=v[1].trim());const g=x.indexOf("["),b=x.lastIndexOf("]");g!==-1&&b!==-1&&(x=x.substring(g,b+1)),u=JSON.parse(x),h=Array.isArray(u)&&u.length>0}catch(x){console.warn("JSON parse error, falling back to full regeneration:",x)}if(h){let x=r,v=0,g=0;for(const b of u)!b.from||!b.to||(x.includes(b.from)?(x=x.replace(b.from,b.to),v++,i(`✅ "${b.from.substring(0,40)}..." → "${b.to.substring(0,40)}..." (${b.reason||""})`)):(g++,i(`⚠️ 未発見（スキップ）: "${b.from.substring(0,50)}..."`)));if(v>0)return{success:!0,method:"replacement",modifiedPrompt:x,appliedCount:v,failedCount:g}}i("[Fallback] 全文再生成モードで修正中...");const m=sM(e.trim(),r),p=await Fr(m,[],null,i);if(p.text&&p.text.length>100)return{success:!0,method:"regeneration",modifiedPrompt:p.text.trim()};throw new Error("フォールバックでも適切な応答が得られませんでした。")}function _M(){console.log("System Version Loaded:",Ql);const[r,e]=Re.useState(""),[i,s]=Re.useState(!1),[l,c]=Re.useState("gemini"),[u,h]=Re.useState("news"),[m,p]=Re.useState(""),[x,v]=Re.useState(""),[g,b]=Re.useState(""),[M,A]=Re.useState(""),[S,y]=Re.useState(""),[R,D]=Re.useState(""),[U,G]=Re.useState("Auto"),[I,B]=Re.useState(Th),w=Tt=>{B(Pt=>Pt.map(_t=>_t.id===Tt?{..._t,checked:!_t.checked}:_t))},F=()=>{const Tt=new Date;return Tt.setHours(Tt.getHours()+9),Tt.toISOString().split("T")[0]},[$,k]=Re.useState(F()),[X,te]=Re.useState(""),[oe,V]=Re.useState(""),[L,z]=Re.useState(""),[W,ce]=Re.useState(""),[ge,P]=Re.useState(null),[Z,_e]=Re.useState(!1);Re.useEffect(()=>{const Tt=cm();Tt?(Hu(Tt),e(Tt)):s(!0)},[]);const[Te,Ne]=Re.useState([]),[ee,Ee]=Re.useState(null),[Ae,Ge]=Re.useState(!1),[Ze,Ke]=Re.useState(!1),[wt,ft]=Re.useState(!1),[Ve,Ft]=Re.useState(!1),[xt,mn]=Re.useState(!1),[Kt,Yt]=Re.useState(""),[q,vt]=Re.useState(""),[yt,Et]=Re.useState(""),[Ie,ot]=Re.useState(""),[O,T]=Re.useState("auto"),[Q,me]=Re.useState(!1),[Me,be]=Re.useState([]),[Pe,fe]=Re.useState(""),[pe,Oe]=Re.useState(!1),[Be,Ce]=Re.useState(""),[De,it]=Re.useState(!1),[dt,lt]=Re.useState(!1),[j,Le]=Re.useState(!1),he=3,Ue=Re.useRef(""),[Fe,we]=Re.useState(!1),[We,at]=Re.useState(!1),[rn,Lt]=Re.useState(!1),[Kn,In]=Re.useState(!1),[Bi,ea]=Re.useState(!1),[ta,zi]=Re.useState(!1),[Un,gn]=Re.useState(!1),[En,li]=Re.useState(!1),[na,Cn]=Re.useState(""),[wa,xa]=Re.useState(!1),[ci,Mi]=Re.useState(""),[xi,Ti]=Re.useState(!1),[xn,Ai]=Re.useState(!1),[yn,Ra]=Re.useState(!1),[C,K]=Re.useState(""),[le,ne]=Re.useState(!1),[ie,He]=Re.useState(!1),[Xe,ze]=Re.useState(!1),[qe,Ye]=Re.useState(!1),[Qe,mt]=Re.useState(null),[Je,It]=Re.useState(null),[Wt,Bt]=Re.useState(null),[zt,Nt]=Re.useState(!1),[je,ei]=Re.useState(""),[Ut,Pn]=Re.useState(!1),[jn,ui]=Re.useState(!1),[_i,Zt]=Re.useState(null),[sn,vi]=Re.useState(null),[en,Zn]=Re.useState(!1),[wi,Fn]=Re.useState(!1),Gi=Re.useRef(!1);Re.useEffect(()=>{Gi.current=wi},[wi]);const[$o,Ko]=Re.useState(!1),_a=Re.useRef(!1),[vs,bi]=Re.useState(0),[lc,df]=Re.useState(0),[bs,Hi]=Re.useState(0),ti=Re.useRef(!1),[ar,ni]=Re.useState(!1),Hr=Re.useRef(null),sr=Re.useRef(null),cc=Re.useRef(null),rr=Re.useRef(null),Xa=Re.useRef(null);Re.useEffect(()=>{Xa.current&&(Xa.current.scrollTop=Xa.current.scrollHeight)},[Me]),wt||!X||X.length<20||!oe||oe.length<20;const[Zo,Mn]=Re.useState(""),[Ya,ys]=Re.useState([]),or=Tt=>{const Pt=Tt.replace(/[^\u0000-\u007F]/g,"").trim();Pt!==Tt&&bt("APIキーに含まれる不要な文字を自動削除しました。"),Pt.startsWith("sk-")?(fp(Pt),Ah("openai"),c("openai"),Ai(!0),Ti(!0),e("openai-engine-active"),s(!1),bt("✅ ChatGPT Engine 接続完了！全ステップがChatGPT APIで動作します。"),console.log("[Dual Engine] Switched to OpenAI/ChatGPT mode")):(Hu(Pt),e(Pt),Ah("gemini"),c("gemini"),s(!1),bt("✅ Gemini Engine 接続完了！キャラクターシートをアップロードして開始してください。"),console.log("[Dual Engine] Using Gemini mode (default)")),window.scrollTo({top:0,behavior:"instant"})},bt=Tt=>{ot(Tt),setTimeout(()=>ot(""),4e3)},Qo=async Tt=>{if(!r){bt("先にAPIキーを入力してシステムに接続してください！"),s(!0);return}if(Tt.length===0)return;const Pt=X;Ge(!0),Yt(`キャラクター解析プロトコルを開始しました...
> ピクセルデータをスキャン中...
> キャラクター形態を識別中...`);let _t=0;const ht=setInterval(()=>{_t++,Yt(ye=>{if(_t<=10){const rt=[".",".",".",`
> 顔の特徴点を抽出中...`,`
> 髪型トポロジーを解析中...`,`
> ファッション属性を検出中...`];return ye+rt[Math.floor(Math.random()*rt.length)]}const Vt=`
> ⏳ AI応答を待機中... (${Math.floor(_t*.8)}秒経過)`,et=/\n> ⏳ AI応答を待機中\.\.\..*\(\d+秒経過\)/;return et.test(ye)?ye.replace(et,"")+Vt:ye+Vt})},800),ut=[];let Rt=null,nt=null;for(let ye=0;ye<Tt.length;ye++){const st=Tt[ye];if(st.name.endsWith(".json")||st.type==="application/json"){try{const rt=await st.text(),Qt=JSON.parse(rt);Qt.style_name&&Qt.reproduction_prompt?(nt=Qt,Ee(Qt),bt(`作風を適用: ${Qt.style_name}`),Yt(Ri=>Ri+`
> 🎭 作風JSONを検出: ${Qt.style_name}`)):(bt("⚠️ 無効なJSONです。作風解析エンジンの出力を使用してください。"),Yt(Ri=>Ri+`
> ⚠️ 読み込まれたJSONは作風解析エンジン用ではありませんでした。`))}catch{bt("⚠️ JSONファイルの読み込みに失敗しました。")}continue}const Vt=await new Promise(rt=>{const Qt=new FileReader;Qt.onload=Bn=>{const yi=Bn.target.result,Tn=new Uint8Array(yi);let Nn=!1;const ur="equirectangular";let fr=0;for(let dr=0;dr<Math.min(Tn.length,65536);dr++)if(Tn[dr]===ur.charCodeAt(fr)){if(fr++,fr===ur.length){Nn=!0;break}}else fr=0;const ia=new Image;ia.onload=()=>{const dr=ia.naturalWidth/ia.naturalHeight,Tf=Math.abs(dr-2)<.15;rt(Tf&&Nn)},ia.onerror=()=>rt(!1),ia.src=URL.createObjectURL(st)};const Ri=st.slice(0,65536);Qt.readAsArrayBuffer(Ri)}),et=new FileReader;et.readAsDataURL(st),await new Promise(rt=>{et.onload=()=>{Vt&&!Rt?(Rt={base64:et.result,mimeType:st.type},Yt(Qt=>Qt+`
> 🌐 360°背景画像を検出 (アスペクト比 2:1)。キャラシートとは分離して処理します...`)):(ut.push(et.result),Ne(Qt=>[...Qt,et.result])),rt()}})}if(Rt)try{ui(!0),mt(Rt.base64);const ye=Rt.base64.split(",")[1],st={inlineData:{mimeType:Rt.mimeType,data:ye}};It(st),Nt(!0),Yt(rt=>rt+`
> 🌐 360°空間解析を実行中... (API通信保護のため順次処理)`);const Vt=await Fr(JE(),[st],null,()=>{}),et=eM(Vt.text);Bt(et),b(et.location),bt(`🌐 360°背景を検出: ${et.location}`),Yt(rt=>rt+`
> 🌐 空間解析完了: ${et.location}`)}catch(ye){console.warn("[360° BG] Analysis failed:",ye),Bt({location:"360°パノラマ画像",lighting:"不明",spatialType:"unknown",objects:"",mood:""}),b("360°パノラマ画像（解析失敗）")}finally{Nt(!1)}if(ut.length===0&&Rt){clearInterval(ht),Ge(!1),Yt(ye=>ye+`
> 🌐 360°背景画像のみが検出されました。キャラクターシートも一緒にドロップしてください。`),bt("360°背景画像を検出しました。キャラクターシートを追加してください。");return}if(ut.length===0){clearInterval(ht),Ge(!1),nt&&Yt(ye=>ye+`
> ✅ 作風JSONを読み込みました。`);return}bt(`思考モード: ${ut.length}枚のキャラクター設定画を同時解析中...${Rt?"（+ 360°背景1枚検出済み）":""}`);try{const ye=ut.map(et=>{const rt=et.split(",")[1];return{inlineData:{mimeType:et.split(";")[0].split(":")[1],data:rt}}});let st=tM();Pt&&Pt.trim().length>10&&(st+=`
...
【既存のキャストリスト】
${Pt}`);const Vt=await Fr(st,ye,null,et=>{Yt(rt=>rt+`
> ${et}`)});te(Vt.text),P(Vt.model),Yt(et=>{const rt=`

--- ✅ 解析完了 ---
`,Qt=Vt.thought&&Vt.thought!=="通常処理が完了しました（思考トレースは利用不可）。"?`> [思考トレース]
${Vt.thought}`:"> 通常処理が完了しました（思考トレースは利用不可）。";return et+rt+Qt}),bt("全キャラクターの解析が完了しました。"),Gi.current&&(ti.current?(Fn(!1),bi(0),ni(!1),bt("⏹ フルオートを中断しました。")):Hi(et=>et+1))}catch(ye){console.error(ye);const st=wh(ye.message);Yt(Vt=>Vt+`

[システムエラー]: ${ye.message}
--------------------------------------------------
${st}`),bt("解析エラー: "+ye.message),Gi.current&&(Fn(!1),bi(0),ni(!1))}finally{clearInterval(ht),Ge(!1)}},Jo=async()=>{if(!oe||oe.length<20)return bt("先にシナリオを生成してください。");if(!(Fe||We||rn||Kn||Bi||ta||Un))return bt("少なくとも1つの強化カテゴリをONにしてください。");if(En)return;li(!0),Cn("> [START] シナリオ強化を開始します..."),ci||(Mi(oe),Cn(ut=>ut+`
> [SAVE] 元のシナリオを保存しました（元に戻すボタンで復元可能）`));const Pt=[];Fe&&Pt.push("【表情データベースによる表情の強化】各キャラの表情描写を限界まで大げさ・劇的にしてください（基準ウェイト2.5〜3.0相当）。..."),We&&Pt.push("【ボディランゲージの強化】棒立ちの状態を禁止します。通常の2倍以上の過剰なアクションで全身で感情を表現してください（基準ウェイト2.5〜3.0相当）。"),rn&&Pt.push("【照明・演出の強化】各コマの「状況」欄に映画的・劇画的な演出効果を限界突破レベルで追加してください。"),Kn&&Pt.push("【背景の強化】各コマの背景描写に奥行きと空間の説得力を追加してください。"),Bi&&Pt.push("【カメラワークの強化】各コマに極限的なカメラアングル指示を追加してください。"),ta&&Pt.push("【セリフ・ギャグの強化 — お笑い構造メソッド適用】4コマ漫画の笑いの構造を根本から再設計してください。"),Cn(ut=>ut+`
> [CONFIG] 強化カテゴリ: ${Pt.length}個`);let _t=0;const ht=setInterval(()=>{_t++,Cn(ut=>{const nt=`
> ⏳ AI応答を待機中... (${Math.floor(_t*.8)}秒経過)`,ye=/\n> ⏳ AI応答を待機中\.\.\..*\(\d+秒経過\)/;return ye.test(ut)?ut.replace(ye,"")+nt:ut+nt})},800);try{Cn(Rt=>Rt+`
> [API] ${l==="openai"?"OpenAI":"Gemini"} にシナリオ強化をリクエスト中...`);const ut=await xM({scenario:oe,enhanceCategories:Pt,castList:X,styleJson:ee,onProgress:Rt=>Cn(nt=>nt+`
> [API] ${Rt}`)});ut&&ut.text&&ut.text.length>50?(V(ut.text),Cn(Rt=>{const nt=Rt+`
> [SUCCESS] シナリオを強化しました！（${ut.text.length}文字）
> [INFO] 「元に戻す」ボタンで強化前のシナリオに戻せます。`;return ut.thought?nt+`

--- ✅ シナリオ強化完了 (思考トレース) ---
`+ut.thought:nt}),we(!1),at(!1),Lt(!1),In(!1),ea(!1),zi(!1),gn(!1),bt("シナリオ強化完了！")):(Cn(Rt=>Rt+`
> [ERROR] AIの応答が短すぎます。もう一度お試しください。`),bt("強化失敗: AIの応答が不十分です"))}catch(ut){Cn(Rt=>Rt+`
> [ERROR] ${ut.message}`),bt("強化エラー: "+ut.message)}finally{clearInterval(ht),li(!1)}},lr=()=>{ci&&(V(ci),Mi(""),Cn(Tt=>Tt+`
> [REVERT] 元のシナリオに復元しました。`),bt("シナリオを元に戻しました"))},cr=async(Tt,Pt=null)=>{if(!X)return bt("先にキャラクターを解析してください。");if(Ze)return;const _t=Array.isArray(Tt)?Tt:I,ht=Pt||u;if(ht==="manual"&&!m.trim()){alert("自由入力トピックを入力してください。");return}if(ht==="news"&&!_t.find(ye=>ye.checked)){alert("少なくとも1つのカテゴリを選択してください。");return}Ke(!0),vt(""),ce(""),Mn(null),Et(""),be([]),Mi(""),Cn("");let ut="";if(ht==="manual")ut="手動入力",V(""),vt(`> コンテキスト強制リブート: 開始
 > モード: 手動入力 
 > 対象: ${m.substring(0,30)}...`);else{const ye=_t.filter(st=>st.checked);ye.length>0?(ut=ye.map(st=>st.keywords).join(" "),bt(`カテゴリ「${ye.map(st=>st.label).join("・")}」で最新ニュースを検索中... (${$})`),V(""),vt(`> コンテキスト強制リブート: 開始
 > 対象カテゴリ: ${ye.map(st=>st.label).join("、")} (キーワード: ${ut}) 
 > 対象日付: ${$} 
 > Google Grounding で検索中...`)):ut="最新ニュース"}let Rt=0;const nt=setInterval(()=>{Rt++,vt(ye=>{if(Rt<=8){const rt=[".",".",".",`
> グローバルニュースデータベースをスキャン中...`,`
> トレンドトピックをクロスリファレンス中...`,`
> 関連記事をフィルタリング中...`,`
> ナラティブフレームワークを構築中...`];return ye+rt[Math.floor(Math.random()*rt.length)]}const Vt=`
> ⏳ AI応答を待機中... (${Math.floor(Rt*.8)}秒経過)`,et=/\n> ⏳ AI応答を待機中\.\.\..*\(\d+秒経過\)/;return et.test(ye)?ye.replace(et,"")+Vt:ye+Vt})},800);try{const ye=await gM({castList:X,categories:_t,inputMode:ht,manualTopic:m,searchTopic:x,targetDate:$,customLocation:g,customOutfit:M,punchlineType:U,bg360Image:Qe,bg360Analysis:Wt,bg360Enabled:jn,bg360ImageParts:Je,styleJson:ee,onProgress:Bn=>vt(yi=>yi+`
 > [API] ${Bn} `),onCameraProgress:Bn=>{Bn.startsWith("🎬")?(vt(yi=>yi+`
 > ${Bn}`),Bn.includes("開始")?Zn(!0):(Bn.includes("完了")||Bn.includes("失敗"))&&Zn(!1)):vt(yi=>yi+`
 > [Camera AI] ${Bn}`)}});if(P(ye.usedModel),y(g.trim()||ye.location||"Unspecified"),D(M.trim()||ye.outfit||""),ye.cameraWork){Zt(ye.cameraWork);const Bn=Nn=>["北(正面)","北東","東(右)","南東","南(背面)","南西","西(左)","北西"][Math.round((Nn%360+360)%360/45)%8],yi=Nn=>({establishing_shot:"ロングショット",wide_shot:"ワイドショット",medium_shot:"ミドルショット",close_up:"クローズアップ",extreme_close_up:"超クローズアップ",over_the_shoulder:"肩越しショット",bird_eye:"俯瞰",worm_eye:"アオリ"})[Nn]||Nn;let Tn=`
 > 🎬 ══════ 360° カメラワーク設計完了 ══════`;ye.cameraWork.panels.forEach(Nn=>{Tn+=`
 > 🎬 コマ${Nn.panel}: ${Bn(Nn.yaw)} (yaw:${Nn.yaw}°) / ${yi(Nn.camera)} / FOV:${Nn.fov}°`,Tn+=`
 >    └─ ${Nn.reasoning}`}),Tn+=`
 > 🎬 ══════════════════════════════════`,vt(Nn=>Nn+Tn)}ye.croppedPanels&&(vi(ye.croppedPanels),vt(Bn=>Bn+`
 > 🔲 [Crop] ✅ ${ye.croppedPanels.length}枚のクロップ画像を生成しました`));const st=ye.logline?`
Logline: ${ye.logline}`:"",Vt=M.trim()||ye.outfit?`
Outfit: ${M.trim()||ye.outfit}`:"",et=ye.punchline?`
Punchline: ${ye.punchline}`:"",rt=Qe?jn?`
🌐 360°背景: ON (${Wt?.location||"解析済み"} / ${Wt?.spatialType==="indoor"?"室内":Wt?.spatialType==="outdoor"?"屋外":"複合"}) — 添付ファイル: キャラシート＋360°画像`:`
🌐 360°背景: OFF — 背景はAIが自由選定 / 添付ファイル: キャラシートのみ`:"";let Qt="";if(ye.cameraWork){const Bn=Tn=>["北(正面)","北東","東(右)","南東","南(背面)","南西","西(左)","北西"][Math.round((Tn%360+360)%360/45)%8],yi=Tn=>({establishing_shot:"ロングショット",wide_shot:"ワイドショット",medium_shot:"ミドルショット",close_up:"クローズアップ",extreme_close_up:"超クローズアップ",over_the_shoulder:"肩越しショット",bird_eye:"俯瞰",worm_eye:"アオリ"})[Tn]||Tn;Qt=`
🎬 360° Camera Work:`,ye.cameraWork.panels.forEach(Tn=>{Qt+=`
  Panel${Tn.panel}: ${Bn(Tn.yaw)}(${Tn.yaw}°) ${yi(Tn.camera)} FOV${Tn.fov}° — ${Tn.reasoning}`})}const Ri=`## タイトル: ${ye.topic} !?${st}
Location: ${ye.location||"Unspecified"}${Vt}${et}${rt}${Qt}

${ye.scenario} `;return V(Ri),z(ye.topic||""),bt("シナリオの生成が完了しました！"),Zn(!1),ye.thought&&vt(Bn=>Bn+`

--- ✅ シナリオ生成完了 (思考トレース) ---
`+ye.thought),Ri}catch(ye){console.error(ye);const st=wh(ye.message);return vt(Vt=>Vt+`

[システムエラー]: ${ye.message}
--------------------------------------------------
${st}`),bt("シナリオ生成エラー"),Zn(!1),null}finally{clearInterval(nt),Ke(!1)}},kr=async(Tt=!1,Pt=null,_t=null)=>{const ht=Pt||oe;if(!Tt&&(!X||!ht))return bt("キャストとシナリオが必要です。");ft(!0),ce(""),be([]),fe(""),Ce(""),it(!1),lt(!1),Ue.current="",Et("スーパーフル・プロトコル v121.3 (Universal Master) を起動中... 全データの整合性をチェックしています...");const ut=typeof _t=="boolean"?_t:xi,Rt=setInterval(()=>{Et(nt=>{if(nt.length>800)return nt;const ye=[".",".",".",`
> 物語ベクトルを最適化中...`,`
> ジオメトリロックを調整中...`,`
> キャラクタースタイルの重みを同期中...`,`
> パネル枠線を適用中...`,`
> 禁止コンテンツタグをチェック中...`,`
> 風刺ロジックを注入中...`,`
> 4コマ構造を最終化中...`];if(!wt)return nt;const st=ye[Math.floor(Math.random()*ye.length)];return nt+st})},600);try{const nt=mM({scenario:ht,castList:X,colorMode:O,enableChatGPTMode:ut,bg360Image:Qe,bg360Analysis:Wt,bg360Enabled:jn,bg360CroppedPanels:sn,punchlineType:U,systemVersion:Ql});return await new Promise(ye=>setTimeout(ye,800)),U==="Documentary"&&Et(ye=>ye+`
> [ドキュメンタリーモード] コンテンツセーフティ・サニタイザー適用済み (危険ワードを安全な言い換えに自動変換)`),Et(ye=>ye+`
...
>   ✅ 出力前チェックリスト追加`),ce(nt),Et(ye=>ye+`
> セーフティ年齢フィルター: 適用済み
> 最適化ベクトル: 計算完了
> 構造ロック: 有効
> 風刺ロジック: 強化済み
> [完了] 最終プロンプトを構築しました。`),bt("最終プロンプトの構築が完了しました。画像生成を開始します..."),nt}catch(nt){console.error(nt);const ye=wh(nt.message);return Et(st=>st+`

[システムエラー]: ${nt.message}
--------------------------------------------------
${ye}`),bt("生成エラー: "+nt.message),null}finally{clearInterval(Rt),ft(!1)}};Re.useEffect(()=>{W&&!wt&&uc>=3&&kr()},[xi]);const hf=()=>{V(""),ce(""),Mn(null),vt(""),Et(""),be([]),Fn(!1),bi(0),b(""),A(""),mt(null),It(null),Bt(null),Zt(null),vi(null),Zn(!1),B(Th),p(""),v(""),y(""),D(""),ui(!1),G("Auto"),h("news"),Mi(""),we(!1),at(!1),Lt(!1),In(!1),ea(!1),zi(!1),gn(!1),li(!1),Cn(""),xa(!1),fe(""),Oe(!1),Ce(""),it(!1),lt(!1),Ue.current="",He(!1),ze(!1),bt("シナリオ以降をリセットしました。キャラクター解析は保持しています。")},pf=()=>{te(""),V(""),ce(""),Ne([]),Mn(null),Yt(""),vt(""),Et(""),Fn(!1),bi(0),b(""),A(""),mt(null),It(null),Bt(null),Zt(null),vi(null),Zn(!1),P(null),ys([]),be([]),B(Th),p(""),v(""),y(""),D(""),ui(!1),G("Auto"),h("news"),Mi(""),we(!1),at(!1),Lt(!1),In(!1),ea(!1),zi(!1),gn(!1),li(!1),Cn(""),xa(!1),fe(""),Oe(!1),Ce(""),it(!1),lt(!1),Ue.current="",ne(!1),He(!1),ze(!1),e(""),Hu(""),fp(""),Ah(""),c(""),Ai(!1),Ti(!1),s(!0),bt("全データをリセットしました。APIキーを再入力してください。")},[mf,Vr]=Re.useState(!1),[gf,xf]=Re.useState(!1),[_f,vf]=Re.useState(!1),bf=()=>{W&&(navigator.clipboard.writeText(W),Vr(!0),setTimeout(()=>Vr(!1),2e3),Pe||Ue.current?(it(!0),lt(!1),bt("📋 コピーしました → Web版に貼り付けて、下の🛡️救済パネルで手動対応できます")):bt("クリップボードにコピーしました！"))},jr=async(Tt=!1,Pt=null)=>{const _t=Pt||W;if(Ve||!Tt&&!_t)return!1;Ft(!0),mn(!1),fe(""),Ue.current="",lt(!1);const ht=["[1/5] プロンプトパラメータをロック中...","[2/5] セーフティフィルターを検証中..."];xi&&(l==="openai"?ht.push("[2.5/5] ✅ ChatGPT Engine: プロンプト最適化を適用中..."):ht.push("[2.5/5] ⚠️ [ChatGPT Mode] 有効: プロンプト構造の特殊最適化を適用中...")),be(ht);let ut=0;const Rt=setInterval(()=>{ut++;const nt=Math.floor(ut*1.5);be(ye=>{const st=ye.findIndex(Vt=>Vt.startsWith("[WAIT]"));if(st!==-1){const Vt=[...ye];return Vt[st]=`[WAIT] ⏳ 画像生成API応答を待機中... (${nt}秒経過)`,Vt}return[...ye,`[WAIT] ⏳ 画像生成API応答を待機中... (${nt}秒経過)`]})},1500);await new Promise(nt=>setTimeout(nt,800));try{bt(xn?"OpenAI (ChatGPT Images 2.0) に送信中...":"Google AI (Gemini/Imagen) に送信中..."),be(rt=>[...rt,"[3/5] クラウドAPIへ接続中...","[3/5] プロンプトデータをアップロード中..."]),await new Promise(rt=>setTimeout(rt,1e3));const nt=rt=>{be(Qt=>[...Qt,rt])};let ye,st;if(xn){nt("[INFO] ⏳ gpt-image-2 の画像生成には通常2〜6分かかります。しばらくお待ちください...");const rt=await tE(_t,nt);ye=rt.base64Img,st=rt.usedModel}else{const rt=sn&&jn&&sn.length===4?sn:[];rt.length>0&&nt(`[REF] 360°背景クロップ画像 ${rt.length}枚を参照画像として添付`);const Qt=await jE(_t,nt,rt);ye=Qt.base64Img,st=Qt.usedModel}be(rt=>[...rt,`[4/5] データストリーム受信完了 (Model: ${st})`,"[5/5] Base64画像データをデコード・レンダリング中..."]);const Vt=`data:image/png;base64,${ye}`;Mn(Vt),ys(rt=>[{id:Date.now(),img:Vt},...rt]);const et=st&&st.startsWith("gpt-");return st&&!st.startsWith("gemini-3")&&!et?(_e(!0),be(rt=>[...rt,"[WARNING] 最新モデル(Nano Banana 2)への接続がタイムアウト等で失敗しました。","[WARNING] 代わりに下位APIで妥協版を出力したため、描写が大きく崩れている可能性があります。","[GUIDE] ★手動生成を推奨します★","[GUIDE] 1. 「プロンプトをコピー」ボタンを押す",`[GUIDE] 2. ${xn?"ChatGPT":"Gemini"}(Web版)を開く: ${xn?"https://chatgpt.com/":"https://gemini.google.com/app"}`,"[GUIDE] 3. 「元となるキャラクターシート画像」を一緒に添付する",`[GUIDE] 4. 貼り付けて${xn?"送信する":"「思考モード」で送信する"}`,"[COMPLETE] Image successfully generated (with warnings)."])):(_e(!1),be(rt=>[...rt,"[COMPLETE] Image successfully generated."])),bt("画像生成完了！"),!0}catch(nt){console.error(nt),mn(!0),Mn(null);const ye=nt.message||"";let st=[];return ye.includes("Unknown parameter")||ye.includes("Invalid parameter")?st=[`[ERROR GUIDE] ⚙️ APIパラメータの形式が不正です（${xn?"OpenAI":"Google"}側の仕様変更の可能性）。`,"[ERROR GUIDE] 【原因】AIモデルの仕様更新により、送信パラメータが合わなくなっている可能性があります。","[ERROR GUIDE] 【対処法】お手数ですが以下の手動手順で画像を生成してください。","[ERROR GUIDE] 1. 画面左下の「プロンプトをコピーする」ボタンを押します。",`[ERROR GUIDE] 2. ${xn?"ChatGPTウェブ版":"Geminiウェブ版"} を開きます: ${xn?"https://chatgpt.com/":"https://gemini.google.com/app"}`,"[ERROR GUIDE] 3. コピーしたプロンプトを貼り付け、元の「キャラクター設定画像」を一緒に添付して送信してください。"]:ye.includes("sensitive")||ye.includes("Responsible AI")||ye.includes("content_policy_violation")||ye.includes("400")&&(ye.includes("safety")||ye.includes("policy")||ye.includes("violation")||ye.includes("sensitive"))?(fe(ye),Ue.current=ye,lt(!0),st=["[ERROR GUIDE] 🚨 表現の一部がAIの安全基準（ポリシー）に触れたため、生成がスキップされました。","[ERROR GUIDE] 【自動修正】「自動修正して再生成する」を押すと、安全な言葉に書き換えて自動で作り直します。","[ERROR GUIDE] 【手動生成】プロンプトをコピーし、公式のウェブ版チャット等に貼り付けて直接お試しください。"]):ye.includes("not found")||ye.includes("not supported")||ye.includes("404")||ye.includes("403")||ye.includes("401")?(wi&&(ti.current=!0),st=[`[ERROR GUIDE] 🔑 現在のAPIキーでは、本アプリ経由での画像生成が許可されていないか、無効になっています（${xn?"OpenAI":"Google"}の権限設定）。`,"[ERROR GUIDE] 【対処法】本アプリでの自動生成は一旦諦め、以下の手順で公式ウェブ版から手動で生成してください。","[ERROR GUIDE] 1. 画面左下の「プロンプトをコピーする」ボタンを押します。",`[ERROR GUIDE] 2. ${xn?"ChatGPTウェブ版":"Geminiウェブ版"} を開きます: ${xn?"https://chatgpt.com/":"https://gemini.google.com/app"}`,"[ERROR GUIDE] 3. コピーしたプロンプトを貼り付け、元の「キャラクター設定画像」を一緒に添付して送信してください。"]):st=[`[ERROR GUIDE] ⏲️ 接続タイムアウト、または一時的な通信エラーで生成に失敗しました（${xn?"OpenAI":"Google"}サーバーの混雑など）。`,"[ERROR GUIDE] 【対処法】数分時間を置いてから「画像を生成する」を再度試すか、以下の手順で公式ウェブ版から生成してください。","[ERROR GUIDE] 1. 画面左下の「プロンプトをコピーする」ボタンを押します。",`[ERROR GUIDE] 2. ${xn?"ChatGPTウェブ版":"Geminiウェブ版"} を開きます: ${xn?"https://chatgpt.com/":"https://gemini.google.com/app"}`,"[ERROR GUIDE] 3. コピーしたプロンプトを貼り付け、元の「キャラクター設定画像」を一緒に添付して送信してください。"],be(Vt=>[...Vt,`[ERROR] ${nt.message} `,"[SYSTEM] Sequence Aborted.","--------------------------------------------------",...st]),bt(`生成エラー: ${nt.message} `),!1}finally{clearInterval(Rt),Ft(!1)}},yf=async()=>{if(!W||!Pe.trim())return;Oe(!0),Ce("> [Phase 0/5] コンテンツポリシーアドバイザーを起動中...");let Tt=0;const Pt=setInterval(()=>{Tt++,Ce(_t=>{const ut=`
> ⏳ AI分析中... (${Math.floor(Tt*1)}秒経過)`,Rt=/\n> ⏳ AI分析中\.\.\..*\(\d+秒経過\)/;return Rt.test(_t)?_t.replace(Rt,ut):_t+ut})},1e3);try{const _t=await Rh({finalPrompt:W,policyErrorMsg:Pe,selectedEngine:l,onProgress:ht=>Ce(ut=>ut+`
> ${ht}`)});_t.success&&_t.modifiedPrompt&&(ce(_t.modifiedPrompt),_t.method==="replacement"?Ce(ht=>ht+`
> [Phase 5/5] ✅ ${_t.appliedCount}箇所を修正しました（${_t.failedCount}箇所はスキップ）。STEP3のプロンプト欄に反映済みです。`):Ce(ht=>ht+`
> [SUCCESS] フォールバック方式で配慮版プロンプトを生成しました。STEP3のプロンプト欄に反映済みです。`),Ce(ht=>ht+`
> [GUIDE] 再度STEP4で画像生成するか、「プロンプトをコピー」して${l==="openai"?"ChatGPT":"Gemini"} Web版で生成してください。`),fe(""),Ue.current="")}catch(_t){console.error(_t),Ce(ht=>ht+`
> [ERROR] ${_t.message}`)}finally{clearInterval(Pt),Oe(!1)}},Sf=async()=>{const Tt=Ue.current||Pe;if(!W||!Tt.trim())return;lt(!1),Le(!0),be(ht=>[...ht,"[POLICY AUTO-FIX] 🔄 自動修正を開始します..."]),Ce("> [AUTO-FIX] コンテンツポリシーアドバイザーを起動中..."),Oe(!0);let Pt=0;const _t=setInterval(()=>{Pt++,Ce(ht=>{const Rt=`
> ⏳ AI分析中... (${Math.floor(Pt*1)}秒経過)`,nt=/\n> ⏳ AI分析中\.\.\..*\(\d+秒経過\)/;return nt.test(ht)?ht.replace(nt,Rt):ht+Rt})},1e3);try{const ht=await Rh({finalPrompt:W,policyErrorMsg:Tt,selectedEngine:l,onProgress:ut=>Ce(Rt=>Rt+`
> ${ut}`)});if(clearInterval(_t),ht.success&&ht.modifiedPrompt){ce(ht.modifiedPrompt);const ut=ht.method==="replacement"?`✅ ${ht.appliedCount}箇所を修正（${ht.failedCount}箇所スキップ）`:"✅ フォールバック方式で配慮版プロンプトを生成";Ce(nt=>nt+`
> ${ut}`),be(nt=>[...nt,`[POLICY AUTO-FIX] ${ut}。修正プロンプトで再生成します...`]),fe(""),Ue.current="",Oe(!1),await jr(!0,ht.modifiedPrompt)&&be(nt=>[...nt,"[POLICY AUTO-FIX] ✅ 自動修正＆再生成が成功しました！"])}else throw new Error("AIがプロンプトを修正できませんでした。")}catch(ht){clearInterval(_t),console.error("[POLICY AUTO-FIX] Error:",ht),Ce(ut=>ut+`
> [ERROR] ${ht.message}`),be(ut=>[...ut,`[POLICY AUTO-FIX] ❌ 自動修正に失敗: ${ht.message}`]),lt(!0)}finally{Oe(!1),Le(!1)}},Ef=()=>{lt(!1),it(!0),fe(""),Ue.current="",W&&navigator.clipboard.writeText(W);const Tt=xn?"https://chatgpt.com/":"https://gemini.google.com/app",Pt=xn?"ChatGPT":"Gemini";be(_t=>[..._t,"[POLICY WEB-SWITCH] 📋 プロンプトをクリップボードにコピーしました。",`[POLICY WEB-SWITCH] 🌐 ${Pt} Web版で画像を生成してください: ${Tt}`,"[POLICY WEB-SWITCH] 💡 Web版に貼り付け時、キャラクターシート画像も一緒に添付すると再現性が高まります。"]),bt(`📋 プロンプトをコピーしました → ${Pt} Web版に貼り付けてください`)};Re.useEffect(()=>{bs>0&&!ti.current&&Mf()},[bs]);const Mf=async()=>{if(!X||X.length<20){bt("先にキャラクターシートをアップロードしてください。"),Fn(!1);return}ti.current=!1,Fn(!0),Ti(!1),V(""),ce(""),Mn(null),vt(""),Et(""),be([]),Mi(""),Cn(""),fe(""),Ue.current="",lt(!1),bi(2);const Tt=[...I].sort(()=>Math.random()-.5),Pt=Math.random()>.5?2:1,_t=Tt.slice(0,Pt).map(et=>et.id),ht=I.map(et=>({...et,checked:_t.includes(et.id)}));B(ht),b(""),A(""),h("news"),await new Promise(et=>setTimeout(et,400)),Hr.current?.scrollIntoView({behavior:"smooth",block:"start"}),await new Promise(et=>setTimeout(et,600));const ut=await cr(ht,"news");if(ti.current||!ut){Fn(!1),bi(0),ni(!1),ti.current&&bt("⏹ フルオートを中断しました。");return}bi(3),sr.current?.scrollIntoView({behavior:"smooth",block:"start"}),await new Promise(et=>setTimeout(et,300));const Rt=await kr(!0,ut,!1);if(ti.current||!Rt){Fn(!1),bi(0),ni(!1),ti.current&&bt("⏹ フルオートを中断しました。");return}bi(4),window.scrollTo({top:document.body.scrollHeight,behavior:"smooth"}),await new Promise(et=>setTimeout(et,300));let nt=!1,ye=0,st=Rt;for(;!nt&&ye<=he&&!ti.current;)if(nt=await jr(!0,st),!nt&&Ue.current&&ye<he){ye++,lt(!1),Oe(!0),be(et=>[...et,`[FULL-AUTO POLICY-FIX] 🔄 コンテンツポリシー自動修正 (${ye}/${he})...`]),Ce(`> [FULL-AUTO ${ye}/${he}] コンテンツポリシーアドバイザーを起動中...`);try{const et=await Rh({finalPrompt:st,policyErrorMsg:Ue.current,selectedEngine:l,onProgress:rt=>Ce(Qt=>Qt+`
> ${rt}`)});if(et.success&&et.modifiedPrompt){st=et.modifiedPrompt,ce(et.modifiedPrompt),fe(""),Ue.current="",Oe(!1);const rt=et.method==="replacement"?`✅ ${et.appliedCount}箇所を修正`:"✅ フォールバック方式で修正";be(Qt=>[...Qt,`[FULL-AUTO POLICY-FIX] ${rt}。修正プロンプトで再生成します...`])}else{Oe(!1),be(rt=>[...rt,"[FULL-AUTO POLICY-FIX] ❌ AIがプロンプトを修正できませんでした。"]);break}}catch(et){Oe(!1),console.error("[FULL-AUTO POLICY-FIX] Error:",et),be(rt=>[...rt,`[FULL-AUTO POLICY-FIX] ❌ 自動修正エラー: ${et.message}`]);break}}else if(!nt)break;Oe(!1);const Vt=!!Ue.current;!nt&&Vt?(be(et=>[...et,`[FULL-AUTO POLICY-FIX] ⚠️ ポリシーエラーのため自動生成を停止しました（リトライ: ${ye}/${he}回）。`,_a.current?"[FULL-AUTO] 次の作品に進みます...":"[FULL-AUTO] ユーザーに判断を委ねます。メッセージボックスを表示します。"]),_a.current||lt(!0)):(lt(!1),Ue.current=""),await new Promise(et=>setTimeout(et,800)),rr.current?.scrollIntoView({behavior:"smooth",block:"center"}),_a.current?ti.current?(Fn(!1),bi(0),ni(!1),bt("⏹ 連続生成を中断しました。")):(bt(nt?"🔄 連続生成モードON：次の作品を生成します...":Vt?"🔄 ポリシーエラーのため次の作品に進みます...":"🔄 生成エラーのため次の作品に進みます..."),setTimeout(()=>{ti.current||Hi(et=>et+1)},2e3)):(Fn(!1),bi(0),ni(!1),nt&&bt("🎉 フルオート生成完了！4コマ漫画が生成されました！"))},el=()=>{if(wi){ti.current=!0,Ke(!1),ft(!1),Ft(!1),Oe(!1),Zn(!1),Fn(!1),bi(0),ni(!1),bt("⏹ フルオートを中断しました。");return}ti.current=!1,ni(!1),Fn(!0),X&&X.length>=20?Hi(Tt=>Tt+1):bt("🚀 フルオート待機中: キャラクターシートをドロップしてください")},uc=!X||X.length<1?1:!oe||oe.length<1?2:W?Zo?5:4:3;return{analyzeThought:Kt,apiKey:r,assemblePrompt:kr,assembleThought:yt,bg360Analysis:Wt,bg360CameraWork:_i,bg360CroppedPanels:sn,bg360Enabled:jn,bg360Image:Qe,castList:X,categories:I,colorMode:O,copyPrompt:bf,currentStep:uc,customLocation:g,customOutfit:M,enableChatGPTMode:xi,enableOpenAIApi:xn,enhanceBackgrounds:Kn,enhanceBodyLang:We,enhanceCameraWork:Bi,enhanceDialogue:ta,enhanceEffects:rn,enhanceExpressions:Fe,enhanceLog:na,enhanceScenario:Jo,finalPrompt:W,fullAutoStep:vs,genLog:Me,genLogRef:Xa,generateScenarioFromNews:cr,generatedImage:Zo,generationHistory:Ya,handleFullAutoToggle:el,handleSetKey:or,hardReset:pf,imageResultRef:rr,images:Te,inputMode:u,is360Analyzing:zt,is360CameraWorking:en,isAborting:ar,isAnalyzing:Ae,isAssembling:wt,isCastListCopied:le,isCopied:mf,isDragging:Q,isEndlessMode:$o,isEndlessModeRef:_a,isEnhancePanelOpen:wa,isEnhancing:En,isFallbackUsed:Z,isFixPromptCopied:gf,isFixingPolicy:pe,isFullAutoMode:wi,isGeneratingImage:Ve,isMetaSaved:Xe,isPolicyCopied:_f,isPolicyPanelOpen:De,showPolicyChoice:dt,policyAutoRetrying:j,handlePolicyAutoFix:Sf,handlePolicySwitchToWeb:Ef,MAX_POLICY_RETRIES:he,isScenarioCopied:ie,isSearching:Ze,mangaTitle:L,manualTopic:m,originalScenario:ci,outputRef:cc,partialReset:hf,policyErrorMsg:Pe,policyFixLog:Be,processFiles:Qo,punchlineType:U,regenerateImage:jr,regenerateSafePrompt:yf,revertScenario:lr,scenario:oe,scenarioThought:q,selectedEngine:l,setBg360Enabled:ui,setCastList:te,setCustomLocation:b,setCustomOutfit:A,setEnableOpenAIApi:Ai,setEnhanceBackgrounds:In,setEnhanceBodyLang:at,setEnhanceCameraWork:ea,setEnhanceDialogue:zi,setEnhanceEffects:Lt,setEnhanceExpressions:we,setGeneratedImage:Mn,setGenerationHistory:ys,setImages:Ne,setInputMode:h,setIsCastListCopied:ne,setIsDragging:me,setIsEndlessMode:Ko,setIsEnhancePanelOpen:xa,setIsFixPromptCopied:xf,setIsMetaSaved:ze,setIsPolicyCopied:vf,setIsPolicyPanelOpen:it,setIsScenarioCopied:He,setManualTopic:p,setPolicyErrorMsg:fe,setPunchlineType:G,setScenario:V,setShowModal:s,setShowOpenAIKeyModal:Ra,setStyleJson:Ee,setTargetDate:k,showModal:i,showOpenAIKeyModal:yn,showStatus:bt,status:Ie,step2Ref:Hr,step3Ref:sr,styleJson:ee,targetDate:$,toggleCategory:w,usedModel:ge}}const D_=({isOpen:r,onSave:e,onClose:i,provider:s="google"})=>{const[l,c]=Re.useState(""),[u,h]=Re.useState("");if(Re.useEffect(()=>{r&&(c(""),h(""))},[r]),!r)return null;const m=()=>{if(!l.trim()){h("APIキーを入力してください");return}h(""),e(l)},p=s==="google",x=s==="openai",v=p,g=l.trim().startsWith("sk-"),b=x?"OpenAI API Key が必要です":v?"AI Engine を選択":"API Key が必要です",M=v?"Gemini AI Key または OpenAI Key (sk-...) を入力...":x?"sk-proj-...":"Google AI API Key を入力...",A="https://aistudio.google.com/app/apikey",S="https://platform.openai.com/api-keys",y=x?S:A,R=x?"🔑 OpenAI キーを取得":"🔑 キーを取得",D=v&&g||x?"emerald":"blue",U=D==="emerald"?"bg-emerald-600":"bg-blue-600",G=D==="emerald"?"border-emerald-500/30":"border-blue-500/30",I=D==="emerald"?"shadow-emerald-500/10":"shadow-blue-500/10",B=D==="emerald"?"bg-emerald-600 hover:bg-emerald-500":"bg-blue-600 hover:bg-blue-500",w=D==="emerald"?"focus:border-emerald-500":"focus:border-blue-500",F=D==="emerald"?"focus:shadow-[0_0_12px_rgba(16,185,129,0.2)]":"focus:shadow-[0_0_12px_rgba(59,130,246,0.2)]";return _.jsx("div",{className:"fixed top-0 left-0 right-0 z-[99999] animate-in slide-in-from-top duration-300",children:_.jsx("div",{className:"max-w-5xl mx-auto px-4 md:px-10 pt-4 relative",children:_.jsxs("div",{className:`bg-[#0f1115]/95 backdrop-blur-2xl border ${G} rounded-xl shadow-2xl ${I} p-4 flex flex-col gap-4 relative pr-10 transition-all duration-300`,children:[i&&_.jsx("button",{onClick:i,className:"absolute top-2 right-2 text-slate-500 hover:text-white p-1 rounded-full hover:bg-white/10 transition-colors",title:"キャンセル",children:_.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[_.jsx("line",{x1:"18",y1:"6",x2:"6",y2:"18"}),_.jsx("line",{x1:"6",y1:"6",x2:"18",y2:"18"})]})}),_.jsxs("div",{className:"flex flex-col md:flex-row items-center gap-4",children:[_.jsxs("div",{className:"flex items-center gap-3 shrink-0",children:[_.jsx("div",{className:`p-2 ${U} rounded-lg animate-pulse transition-colors duration-300`,children:_.jsx(Zu,{size:18,className:"text-white"})}),_.jsxs("div",{children:[_.jsx("p",{className:"text-sm font-bold text-white",children:b}),_.jsx("p",{className:"text-[10px] text-slate-500",children:"ブラウザメモリ内のみ保持・外部送信なし"})]})]}),_.jsxs("div",{className:"flex-1 w-full md:w-auto",children:[_.jsx("div",{className:"flex gap-2",children:_.jsxs("form",{onSubmit:$=>{$.preventDefault(),m()},action:g?"/openai-key":"/gemini-key",method:"dialog",className:"flex gap-2 flex-1",autoComplete:"off",children:[_.jsx("input",{id:"dual-engine-api-key-input",name:g?"openai-api-key":"gemini-api-key",autoComplete:"off","data-lpignore":"true","data-form-type":"other",type:"password",value:l,onChange:$=>c($.target.value),placeholder:M,className:`flex-1 bg-black/50 text-white placeholder:text-slate-600 px-4 py-2.5 rounded-lg border border-white/10 ${w} outline-none font-mono text-sm tracking-wider transition-all ${F}`,onKeyDown:$=>$.key==="Enter"&&m(),autoFocus:!0}),_.jsx("button",{onClick:m,className:`${B} text-white font-bold px-6 py-2.5 rounded-lg transition-all text-sm whitespace-nowrap active:scale-95`,children:"接続"})]})}),u&&_.jsx("p",{className:"text-red-400 text-[10px] mt-1 pl-1",children:u})]})]}),v?_.jsxs("div",{className:"flex flex-col md:flex-row items-center justify-between gap-3 border-t border-white/5 pt-3",children:[_.jsxs("div",{className:"flex items-center gap-3",children:[_.jsxs("div",{className:`flex items-center gap-1.5 px-3 py-1 rounded-full border text-[10px] font-bold transition-all duration-300 ${g?"bg-emerald-500/15 border-emerald-500/40 text-emerald-400":l.trim()?"bg-blue-500/15 border-blue-500/40 text-blue-400":"bg-white/5 border-white/10 text-slate-500"}`,children:[_.jsx("span",{className:`w-1.5 h-1.5 rounded-full transition-all duration-300 ${g?"bg-emerald-400":l.trim()?"bg-blue-400":"bg-slate-600"}`}),g?"🟢 ChatGPT Engine で起動":l.trim()?"🔵 Gemini Engine で起動":"入力待ち..."]}),g&&_.jsx("span",{className:"text-[9px] text-amber-400/70",children:"⚠ 従量課金（OpenAI API）"})]}),_.jsxs("div",{className:"flex items-center gap-4",children:[_.jsx("a",{href:A,target:"_blank",rel:"noreferrer",className:"text-[11px] text-cyan-400 hover:text-cyan-300 underline decoration-cyan-400/30 whitespace-nowrap",children:"🔵 Gemini キー取得（無料）"}),_.jsx("span",{className:"text-slate-600 text-[10px]",children:"|"}),_.jsx("a",{href:S,target:"_blank",rel:"noreferrer",className:"text-[11px] text-emerald-400 hover:text-emerald-300 underline decoration-emerald-400/30 whitespace-nowrap",children:"🟢 OpenAI キー取得（従量課金）"})]})]}):_.jsx("div",{className:"flex justify-end",children:_.jsx("a",{href:y,target:"_blank",rel:"noreferrer",className:`text-[11px] ${D==="emerald"?"text-emerald-400 hover:text-emerald-300 decoration-emerald-400/30":"text-cyan-400 hover:text-cyan-300 decoration-cyan-400/30"} underline whitespace-nowrap shrink-0`,children:R})})]})})})};class Kv extends Uv.Component{constructor(e){super(e),this.state={hasError:!1,error:null,errorInfo:null}}static getDerivedStateFromError(e){return{hasError:!0,error:e}}componentDidCatch(e,i){this.setState({errorInfo:i}),console.error("CRITICAL ERROR:",e,i)}render(){return this.state.hasError?_.jsxs("div",{style:{padding:40,background:"#111",color:"#f55",minHeight:"100vh"},children:[_.jsxs("h1",{children:["⚠️ SYSTEM CRASH (",Ql,")"]}),_.jsxs("pre",{style:{background:"#000",padding:20,whiteSpace:"pre-wrap"},children:[this.state.error?.toString(),_.jsx("br",{}),this.state.errorInfo?.componentStack]}),_.jsx("button",{onClick:()=>window.location.reload(),style:{padding:10,marginTop:20},children:"RETRY"})]}):this.props.children}}const Ju=({thought:r,containerHeight:e="h-[180px]",scrollHeight:i="h-[120px]",placeholder:s=""})=>{const l=Re.useRef(null);Re.useEffect(()=>{l.current&&(l.current.scrollTop=l.current.scrollHeight)},[r]);const c=r||s;return!c&&!s?null:_.jsxs("div",{className:`w-full bg-[#050505] border border-blue-500/20 rounded-2xl p-6 font-mono text-xs overflow-hidden relative group mt-4 animate-in fade-in slide-in-from-top-4 ${e}`,children:[_.jsx("div",{className:"absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-600 to-purple-600 animate-pulse"}),_.jsxs("div",{className:"flex items-center gap-2 text-blue-400 mb-4 uppercase tracking-widest font-bold text-[11px]",children:[_.jsx(rm,{size:16})," Neural Process (Thinking Mode)"]}),_.jsxs("div",{ref:l,className:`${i} overflow-y-auto custom-scrollbar leading-relaxed whitespace-pre-wrap font-mono text-[11px] scroll-smooth ${r?"text-blue-100":"text-blue-300/30"}`,children:[c||"> ボタンを押すとAI処理ログがここに表示されます...",r&&_.jsx("span",{className:"inline-block w-2 h-4 bg-blue-500 ml-1 animate-pulse"})]})]})};function vM({apiKey:r,isDragging:e,setIsDragging:i,processFiles:s,images:l,setImages:c,bg360Image:u,bg360Enabled:h,isAnalyzing:m,analyzeThought:p,castList:x,setCastList:v,isCastListCopied:g,setIsCastListCopied:b,currentStep:M,setShowModal:A,styleJson:S,setStyleJson:y}){return _.jsxs("section",{onDragOver:R=>{R.preventDefault(),r&&i(!0)},onDragLeave:()=>i(!1),onDrop:R=>{R.preventDefault(),i(!1),r&&s(R.dataTransfer.files)},className:`group p-8 rounded-xl border-2 transition-all flex flex-col relative overflow-hidden duration-500 min-h-[300px] justify-center
...
`)}const zR={[Qv]:"Linear",[Jv]:"Reinhard",[eb]:"Cineon",[tb]:"ACESFilmic",[ib]:"AgX",[ab]:"Neutral",[nb]:"Custom"};function GR(r,e){const i=zR[e];return i===void 0?(gt("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+r+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+r+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Bu=new ae;function HR(){$t.getLuminanceCoefficients(Bu);const r=Bu.x.toFixed(4),e=Bu.y.toFixed(4),i=Bu.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+y);const D=R+S+u,U=R+y+h,G=Sv(l,l.VERTEX_SHADER,D),I=Sv(l,l.FRAGMENT_SHADER,U);l.attachShader(A,G),l.attachShader(A,I),i.index0AttributeName!==void 0?l.bindAttribLocation(A,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(A,0,"position"),l.linkProgram(A);function B(k){if(r.debug.checkShaderErrors){const X=l.getProgramInfoLog(A)||"",te=l.getShaderInfoLog(G)||"",oe=l.getShaderInfoLog(I)||"",V=X.trim(),L=te.trim(),z=oe.trim();let W=!0,ce=!0;if(l.getProgramParameter(A,l.LINK_STATUS)===!1)if(W=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,A,G,I);else{const ge=Mv(l,G,"vertex"),P=Mv(l,I,"fragment");Jt("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(A,l.VALIDATE_STATUS)+`
...
}`,SC=[new ae(1,0,0),new ae(-1,0,0),new ae(0,1,0),new ae(0,-1,0),new ae(0,0,1),new ae(0,0,-1)],EC=[new ae(0,-1,0),new ae(0,-1,0),new ae(0,0,1),new ae(0,0,-1),new ae(0,-1,0),new ae(0,-1,0)],Dv=new Wn,Xl=new ae,rp=new ae;function MC(r,e,i){let s=new bb;const l=new Dt,c=new Dt,u=new Ln,h=new LT,m=new IT,p={},x=i.maxTextureSize,v={[tr]:Pi,[Pi]:tr,[hs]:hs},g=new Va({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Dt},radius:{value:4}},vertexShader:bC,fragmentShader:yC}),b=g.clone();b.defines.HORIZONTAL_PASS=1;const M=new ja;M.setAttribute("position",new Ga(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const A=new ka(M,g),S=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ku;let y=this.type;this.render=function(I,B,w){if(S.enabled===!1||S.autoUpdate===!1&&S.needsUpdate===!1||I.length===0)return;this.type===SM&&(gt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=ku);const F=r.getRenderTarget(),$=r.getActiveCubeFace(),k=r.getActiveMipmapLevel(),X=r.state;X.setBlending(ms),X.buffers.depth.getReversed()===!0?X.buffers.color.setClear(0,0,0,0):X.buffers.color.setClear(1,1,1,1),X.buffers.depth.setTest(!0),X.setScissorTest(!1);const te=y!==this.type;te&&B.traverse(function(oe){oe.material&&(Array.isArray(oe.material)?oe.material.forEach(V=>V.needsUpdate=!0):oe.material.needsUpdate=!0)});for(let oe=0,V=I.length;oe<V;oe++){const L=I[oe],z=L.shadow;if(z===void 0){gt("WebGLShadowMap:",L,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;l.copy(z.mapSize);const W=z.getFrameExtents();l.multiply(W),c.copy(z.mapSize),(l.x>x||l.y>x)&&(l.x>x&&(c.x=Math.floor(x/W.x),l.x=c.x*W.x,z.mapSize.x=c.x),l.y>x&&(c.y=Math.floor(x/W.y),l.y=c.y*W.y,z.mapSize.y=c.y));const ce=r.state.buffers.depth.getReversed();if(z.camera._reversedDepth=ce,z.map===null||te===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===Yl){if(L.isPointLight){gt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new za(l.x,l.y,{format:zr,type:xs,minFilter:mi,magFilter:mi,generateMipmaps:!1}),z.map.texture.name=L.name+".shadowMap",z.map.depthTexture=new Yo(l.x,l.y,Pa),z.map.depthTexture.name=L.name+".shadowMapDepth",z.map.depthTexture.format=_s,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=oi,z.map.depthTexture.magFilter=oi}else L.isPointLight?(z.map=new Rb(l.x),z.map.depthTexture=new wT(l.x,Ha)):(z.map=new za(l.x,l.y),z.map.depthTexture=new Yo(l.x,l.y,Ha)),z.map.depthTexture.name=L.name+".shadowMap",z.map.depthTexture.format=_s,this.type===ku?(z.map.depthTexture.compareFunction=ce?_m:xm,z.map.depthTexture.minFilter=mi,z.map.depthTexture.magFilter=mi):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=oi,z.map.depthTexture.magFilter=oi);z.camera.updateProjectionMatrix()}const ge=z.map.isWebGLCubeRenderTarget?6:1;for(let P=0;P<ge;P++){if(z.map.isWebGLCubeRenderTarget)r.setRenderTarget(z.map,P),r.clear();else{P===0&&(r.setRenderTarget(z.map),r.clear());const Z=z.getViewport(P);u.set(c.x*Z.x,c.y*Z.y,c.x*Z.z,c.y*Z.w),X.viewport(u)}if(L.isPointLight){const Z=z.camera,_e=z.matrix,Te=L.distance||Z.far;Te!==Z.far&&(Z.far=Te,Z.updateProjectionMatrix()),Xl.setFromMatrixPosition(L.matrixWorld),Z.position.copy(Xl),rp.copy(Z.position),rp.add(SC[P]),Z.up.copy(EC[P]),Z.lookAt(rp),Z.updateMatrixWorld(),_e.makeTranslation(-Xl.x,-Xl.y,-Xl.z),Dv.multiplyMatrices(Z.projectionMatrix,Z.matrixWorldInverse),z._frustum.setFromProjectionMatrix(Dv,Z.coordinateSystem,Z.reversedDepth)}else z.updateMatrices(L);s=z.getFrustum(),U(B,w,z.camera,L,this.type)}z.isPointLightShadow!==!0&&this.type===Yl&&R(z,w),z.needsUpdate=!1}y=this.type,S.needsUpdate=!1,r.setRenderTarget(F,$,k)};function R(I,B){const w=e.update(A);g.defines.VSM_SAMPLES!==I.blurSamples&&(g.defines.VSM_SAMPLES=I.blurSamples,b.defines.VSM_SAMPLES=I.blurSamples,g.needsUpdate=!0,b.needsUpdate=!0),I.mapPass===null&&(I.mapPass=new za(l.x,l.y,{format:zr,type:xs})),g.uniforms.shadow_pass.value=I.map.depthTexture,g.uniforms.resolution.value=I.mapSize,g.uniforms.radius.value=I.radius,r.setRenderTarget(I.mapPass),r.clear(),r.renderBufferDirect(B,null,w,g,A,null),b.uniforms.shadow_pass.value=I.mapPass.texture,b.uniforms.resolution.value=I.mapSize,b.uniforms.radius.value=I.radius,r.setRenderTarget(I.map),r.clear(),r.renderBufferDirect(B,null,w,b,A,null)}function D(I,B,w,F){let $=null;const k=w.isPointLight===!0?I.customDistanceMaterial:I.customDepthMaterial;if(k!==void 0)$=k;else if($=w.isPointLight===!0?m:h,r.localClippingEnabled&&B.clipShadows===!0&&Array.isArray(B.clippingPlanes)&&B.clippingPlanes.length!==0||B.displacementMap&&B.displacementScale!==0||B.alphaMap&&B.alphaTest>0||B.map&&B.alphaTest>0||B.alphaToCoverage===!0){const X=$.uuid,te=B.uuid;let oe=p[X];oe===void 0&&(oe={},p[X]=oe);let V=oe[te];V===void 0&&(V=$.clone(),oe[te]=V,B.addEventListener("dispose",G)),$=V}if($.visible=B.visible,$.wireframe=B.wireframe,F===Yl?$.side=B.shadowSide!==null?B.shadowSide:B.side:$.side=B.shadowSide!==null?B.shadowSide:v[B.side],$.alphaMap=B.alphaMap,$.alphaTest=B.alphaToCoverage===!0?.5:B.alphaTest,$.map=B.map,$.clipShadows=B.clipShadows,$.clippingPlanes=B.clippingPlanes,$.clipIntersection=B.clipIntersection,$.displacementMap=B.displacementMap,$.displacementScale=B.displacementScale,$.displacementBias=B.displacementBias,$.wireframeLinewidth=B.wireframeLinewidth,$.linewidth=B.linewidth,w.isPointLight===!0&&$.isMeshDistanceMaterial===!0){const X=r.properties.get($);X.light=w}return $}function U(I,B,w,F,$){if(I.visible===!1)return;if(I.layers.test(B.layers)&&(I.isMesh||I.isLine||I.isPoints)&&(I.castShadow||I.receiveShadow&&$===Yl)&&(!I.frustumCulled||s.intersectsObject(I))){I.modelViewMatrix.multiplyMatrices(w.matrixWorldInverse,I.matrixWorld);const te=e.update(I),oe=I.material;if(Array.isArray(oe)){const V=te.groups;for(let L=0,z=V.length;L<z;L++){const W=V[L],ce=oe[W.materialIndex];if(ce&&ce.visible){const ge=D(I,ce,F,$);I.onBeforeShadow(r,I,B,w,te,ge,W),r.renderBufferDirect(w,null,te,ge,I,W),I.onAfterShadow(r,I,B,w,te,ge,W)}}}else if(oe.visible){const V=D(I,oe,F,$);I.onBeforeShadow(r,I,B,w,te,V,null),r.renderBufferDirect(w,null,te,V,I,null),I.onAfterShadow(r,I,B,w,te,V,null)}}const X=I.children;for(let te=0,oe=X.length;te<oe;te++)U(X[te],B,w,F,$)}function G(I){I.target.removeEventListener("dispose",G);for(const w in p){const F=p[w],$=I.target.uuid;$ in F&&(F[$].dispose(),delete F[$])}}}function TC(r,e){function i(){let j=!1;const Le=new Ln;let he=null;const Ue=new Ln(0,0,0,0);return{setMask:function(Fe){he!==Fe&&!j&&(r.colorMask(Fe,Fe,Fe,Fe),he=Fe)},setLocked:function(Fe){j=Fe},setClear:function(Fe,we,We,at,rn){rn===!0&&(Fe*=at,we*=at,We*=at),Le.set(Fe,we,We,at),Ue.equals(Le)===!1&&(r.clearColor(Fe,we,We,at),Ue.copy(Le))},reset:function(){j=!1,he=null,Ue.set(-1,0,0,0)}}}function s(){let j=!1,Le=!1,he=null,Ue=null,Fe=null;return{setReversed:function(we){if(Le!==we){const We=e.get("EXT_clip_control");we?We.clipControlEXT(We.LOWER_LEFT_EXT,We.ZERO_TO_ONE_EXT):We.clipControlEXT(We.LOWER_LEFT_EXT,We.NEGATIVE_ONE_TO_ONE_EXT),Le=we;const at=Fe;Fe=null,this.setClear(at)}},getReversed:function(){return Le},setTest:function(we){we?Ae(r.DEPTH_TEST):Ge(r.DEPTH_TEST)},setMask:function(we){he!==we&&!j&&(r.depthMask(we),he=we)},setFunc:function(we){if(Le&&(we=tT[we]),Ue!==we){switch(we){case gp:r.depthFunc(r.NEVER);break;case xp:r.depthFunc(r.ALWAYS);break;case _p:r.depthFunc(r.LESS);break;case jo:r.depthFunc(r.LEQUAL);break;case vp:r.depthFunc(r.EQUAL);break;case bp:r.depthFunc(r.GEQUAL);break;case yp:r.depthFunc(r.GREATER);break;case Sp:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}Ue=we}},setLocked:function(we){j=we},setClear:function(we){Fe!==we&&(Fe=we,Le&&(we=1-we),r.clearDepth(we))},reset:function(){j=!1,he=null,Ue=null,Fe=null,Le=!1}}}function l(){let j=!1,Le=null,he=null,Ue=null,Fe=null,we=null,We=null,at=null,rn=null;return{setTest:function(Lt){j||(Lt?Ae(r.STENCIL_TEST):Ge(r.STENCIL_TEST))},setMask:function(Lt){Le!==Lt&&!j&&(r.stencilMask(Lt),Le=Lt)},setFunc:function(Lt,Kn,In){(he!==Lt||Ue!==Kn||Fe!==In)&&(r.stencilFunc(Lt,Kn,In),he=Lt,Ue=Kn,Fe=In)},setOp:function(Lt,Kn,In){(we!==Lt||We!==Kn||at!==In)&&(r.stencilOp(Lt,Kn,In),we=Lt,We=Kn,at=In)},setLocked:function(Lt){j=Lt},setClear:function(Lt){rn!==Lt&&(r.clearStencil(Lt),rn=Lt)},reset:function(){j=!1,Le=null,he=null,Ue=null,Fe=null,we=null,We=null,at=null,rn=null}}}const c=new i,u=new s,h=new l,m=new WeakMap,p=new WeakMap;let x={},v={},g={},b=new WeakMap,M=[],A=null,S=!1,y=null,R=null,D=null,U=null,G=null,I=null,B=null,w=new pn(0,0,0),F=0,$=!1,k=null,X=null,te=null,oe=null,V=null;const L=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let z=!1,W=0;const ce=r.getParameter(r.VERSION);ce.indexOf("WebGL")!==-1?(W=parseFloat(/^WebGL (\d)/.exec(ce)[1]),z=W>=1):ce.indexOf("OpenGL ES")!==-1&&(W=parseFloat(/^OpenGL ES (\d)/.exec(ce)[1]),z=W>=2);let ge=null,P={};const Z=r.getParameter(r.SCISSOR_BOX),_e=r.getParameter(r.VIEWPORT),Te=new Ln().fromArray(Z),Ne=new Ln().fromArray(_e);function ee(j,Le,he,Ue){const Fe=new Uint8Array(4),we=r.createTexture();r.bindTexture(j,we),r.texParameteri(j,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(j,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let We=0;We<he;We++)j===r.TEXTURE_3D||j===r.TEXTURE_2D_ARRAY?r.texImage3D(Le,0,r.RGBA,1,1,Ue,0,r.RGBA,r.UNSIGNED_BYTE,Fe):r.texImage2D(Le+We,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,Fe);return we}const Ee={};Ee[r.TEXTURE_2D]=ee(r.TEXTURE_2D,r.TEXTURE_2D,1),Ee[r.TEXTURE_CUBE_MAP]=ee(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),Ee[r.TEXTURE_2D_ARRAY]=ee(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),Ee[r.TEXTURE_3D]=ee(r.TEXTURE_3D,r.TEXTURE_3D,1,1),c.setClear(0,0,0,1),u.setClear(1),h.setClear(0),Ae(r.DEPTH_TEST),u.setFunc(jo),mn(!1),Kt(L_),Ae(r.CULL_FACE),Ft(ms);function Ae(j){x[j]!==!0&&(r.enable(j),x[j]=!0)}function Ge(j){x[j]!==!1&&(r.disable(j),x[j]=!1)}function Ze(j,Le){return g[j]!==Le?(r.bindFramebuffer(j,Le),g[j]=Le,j===r.DRAW_FRAMEBUFFER&&(g[r.FRAMEBUFFER]=Le),j===r.FRAMEBUFFER&&(g[r.DRAW_FRAMEBUFFER]=Le),!0):!1}function Ke(j,Le){let he=M,Ue=!1;if(j){he=b.get(Le),he===void 0&&(he=[],b.set(Le,he));const Fe=j.textures;if(he.length!==Fe.length||he[0]!==r.COLOR_ATTACHMENT0){for(let we=0,We=Fe.length;we<We;we++)he[we]=r.COLOR_ATTACHMENT0+we;he.length=Fe.length,Ue=!0}}else he[0]!==r.BACK&&(he[0]=r.BACK,Ue=!0);Ue&&r.drawBuffers(he)}function wt(j){return A!==j?(r.useProgram(j),A=j,!0):!1}const ft={[Dr]:r.FUNC_ADD,[MM]:r.FUNC_SUBTRACT,[TM]:r.FUNC_REVERSE_SUBTRACT};ft[AM]=r.MIN,ft[wM]=r.MAX;const Ve={[RM]:r.ZERO,[CM]:r.ONE,[NM]:r.SRC_COLOR,[pp]:r.SRC_ALPHA,[PM]:r.SRC_ALPHA_SATURATE,[IM]:r.DST_COLOR,[DM]:r.DST_ALPHA,[OM]:r.ONE_MINUS_SRC_COLOR,[mp]:r.ONE_MINUS_SRC_ALPHA,[UM]:r.ONE_MINUS_DST_COLOR,[LM]:r.ONE_MINUS_DST_ALPHA,[FM]:r.CONSTANT_COLOR,[BM]:r.ONE_MINUS_CONSTANT_COLOR,[zM]:r.CONSTANT_ALPHA,[GM]:r.ONE_MINUS_CONSTANT_ALPHA};function Ft(j,Le,he,Ue,Fe,we,We,at,rn,Lt){if(j===ms){S===!0&&(Ge(r.BLEND),S=!1);return}if(S===!1&&(Ae(r.BLEND),S=!0),j!==EM){if(j!==y||Lt!==$){if((R!==Dr||G!==Dr)&&(r.blendEquation(r.FUNC_ADD),R=Dr,G=Dr),Lt)switch(j){case Go:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case I_:r.blendFunc(r.ONE,r.ONE);break;case U_:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case P_:r.blendFuncSeparate(r.DST_COLOR,r.ONE_MINUS_SRC_ALPHA,r.ZERO,r.ONE);break;default:Jt("WebGLState: Invalid blending: ",j);break}else switch(j){case Go:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case I_:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE,r.ONE,r.ONE);break;case U_:Jt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case P_:Jt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Jt("WebGLState: Invalid blending: ",j);break}D=null,U=null,I=null,B=null,w.set(0,0,0),F=0,y=j,$=Lt}return}Fe=Fe||Le,we=we||he,We=We||Ue,(Le!==R||Fe!==G)&&(r.blendEquationSeparate(ft[Le],ft[Fe]),R=Le,G=Fe),(he!==D||Ue!==U||we!==I||We!==B)&&(r.blendFuncSeparate(Ve[he],Ve[Ue],Ve[we],Ve[We]),D=he,U=Ue,I=we,B=We),(at.equals(w)===!1||rn!==F)&&(r.blendColor(at.r,at.g,at.b,rn),w.copy(at),F=rn),y=j,$=!1}function xt(j,Le){j.side===hs?Ge(r.CULL_FACE):Ae(r.CULL_FACE);let he=j.side===Pi;Le&&(he=!he),mn(he),j.blending===Go&&j.transparent===!1?Ft(ms):Ft(j.blending,j.blendEquation,j.blendSrc,j.blendDst,j.blendEquationAlpha,j.blendSrcAlpha,j.blendDstAlpha,j.blendColor,j.blendAlpha,j.premultipliedAlpha),u.setFunc(j.depthFunc),u.setTest(j.depthTest),u.setMask(j.depthWrite),c.setMask(j.colorWrite);const Ue=j.stencilWrite;h.setTest(Ue),Ue&&(h.setMask(j.stencilWriteMask),h.setFunc(j.stencilFunc,j.stencilRef,j.stencilFuncMask),h.setOp(j.stencilFail,j.stencilZFail,j.stencilZPass)),q(j.polygonOffset,j.polygonOffsetFactor,j.polygonOffsetUnits),j.alphaToCoverage===!0?Ae(r.SAMPLE_ALPHA_TO_COVERAGE):Ge(r.SAMPLE_ALPHA_TO_COVERAGE)}function mn(j){k!==j&&(j?r.frontFace(r.CW):r.frontFace(r.CCW),k=j)}function Kt(j){j!==bM?(Ae(r.CULL_FACE),j!==X&&(j===L_?r.cullFace(r.BACK):j===yM?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):Ge(r.CULL_FACE),X=j}function Yt(j){j!==te&&(z&&r.lineWidth(j),te=j)}function q(j,Le,he){j?(Ae(r.POLYGON_OFFSET_FILL),(oe!==Le||V!==he)&&(oe=Le,V=he,u.getReversed()&&(Le=-Le),r.polygonOffset(Le,he))):Ge(r.POLYGON_OFFSET_FILL)}function vt(j){j?Ae(r.SCISSOR_TEST):Ge(r.SCISSOR_TEST)}function yt(j){j===void 0&&(j=r.TEXTURE0+L-1),ge!==j&&(r.activeTexture(j),ge=j)}function Et(j,Le,he){he===void 0&&(ge===null?he=r.TEXTURE0+L-1:he=ge);let Ue=P[he];Ue===void 0&&(Ue={type:void 0,texture:void 0},P[he]=Ue),(Ue.type!==j||Ue.texture!==Le)&&(ge!==he&&(r.activeTexture(he),ge=he),r.bindTexture(j,Le||Ee[j]),Ue.type=j,Ue.texture=Le)}function Ie(){const j=P[ge];j!==void 0&&j.type!==void 0&&(r.bindTexture(j.type,null),j.type=void 0,j.texture=void 0)}function ot(){try{r.compressedTexImage2D(...arguments)}catch(j){Jt("WebGLState:",j)}}function O(){try{r.compressedTexImage3D(...arguments)}catch(j){Jt("WebGLState:",j)}}function T(){try{r.texSubImage2D(...arguments)}catch(j){Jt("WebGLState:",j)}}function Q(){try{r.texSubImage3D(...arguments)}catch(j){Jt("WebGLState:",j)}}function me(){try{r.compressedTexSubImage2D(...arguments)}catch(j){Jt("WebGLState:",j)}}function Me(){try{r.compressedTexSubImage3D(...arguments)}catch(j){Jt("WebGLState:",j)}}function be(){try{r.texStorage2D(...arguments)}catch(j){Jt("WebGLState:",j)}}function Pe(){try{r.texStorage3D(...arguments)}catch(j){Jt("WebGLState:",j)}}function fe(){try{r.texImage2D(...arguments)}catch(j){Jt("WebGLState:",j)}}function pe(){try{r.texImage3D(...arguments)}catch(j){Jt("WebGLState:",j)}}function Oe(j){return v[j]!==void 0?v[j]:r.getParameter(j)}function Be(j,Le){v[j]!==Le&&(r.pixelStorei(j,Le),v[j]=Le)}function Ce(j){Te.equals(j)===!1&&(r.scissor(j.x,j.y,j.z,j.w),Te.copy(j))}function De(j){Ne.equals(j)===!1&&(r.viewport(j.x,j.y,j.z,j.w),Ne.copy(j))}function it(j,Le){let he=p.get(Le);he===void 0&&(he=new WeakMap,p.set(Le,he));let Ue=he.get(j);Ue===void 0&&(Ue=r.getUniformBlockIndex(Le,j.name),he.set(j,Ue))}function dt(j,Le){const Ue=p.get(Le).get(j);m.get(Le)!==Ue&&(r.uniformBlockBinding(Le,Ue,j.__bindingPointIndex),m.set(Le,Ue))}function lt(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),u.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),r.pixelStorei(r.PACK_ALIGNMENT,4),r.pixelStorei(r.UNPACK_ALIGNMENT,4),r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,!1),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,r.BROWSER_DEFAULT_WEBGL),r.pixelStorei(r.PACK_ROW_LENGTH,0),r.pixelStorei(r.PACK_SKIP_PIXELS,0),r.pixelStorei(r.PACK_SKIP_ROWS,0),r.pixelStorei(r.UNPACK_ROW_LENGTH,0),r.pixelStorei(r.UNPACK_IMAGE_HEIGHT,0),r.pixelStorei(r.UNPACK_SKIP_PIXELS,0),r.pixelStorei(r.UNPACK_SKIP_ROWS,0),r.pixelStorei(r.UNPACK_SKIP_IMAGES,0),x={},v={},ge=null,P={},g={},b=new WeakMap,M=[],A=null,S=!1,y=null,R=null,D=null,U=null,G=null,I=null,B=null,w=new pn(0,0,0),F=0,$=!1,k=null,X=null,te=null,oe=null,V=null,Te.set(0,0,r.canvas.width,r.canvas.height),Ne.set(0,0,r.canvas.width,r.canvas.height),c.reset(),u.reset(),h.reset()}return{buffers:{color:c,depth:u,stencil:h},enable:Ae,disable:Ge,bindFramebuffer:Ze,drawBuffers:Ke,useProgram:wt,setBlending:Ft,setMaterial:xt,setFlipSided:mn,setCullFace:Kt,setLineWidth:Yt,setPolygonOffset:q,setScissorTest:vt,activeTexture:yt,bindTexture:Et,unbindTexture:Ie,compressedTexImage2D:ot,compressedTexImage3D:O,texImage2D:fe,texImage3D:pe,pixelStorei:Be,getParameter:Oe,updateUBOMapping:it,uniformBlockBinding:dt,texStorage2D:be,texStorage3D:Pe,texSubImage2D:T,texSubImage3D:Q,compressedTexSubImage2D:me,compressedTexSubImage3D:Me,scissor:Ce,viewport:De,reset:lt}}function AC(r,e,i,s,l,c,u){const h=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new Dt,x=new WeakMap,v=new Set;let g;const b=new WeakMap;let M=!1;try{M=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function A(O,T){return M?new OffscreenCanvas(O,T):ic("canvas")}function S(O,T,Q){let me=1;const Me=ot(O);if((Me.width>Q||Me.height>Q)&&(me=Q/Math.max(Me.width,Me.height)),me<1)if(typeof HTMLImageElement<"u"&&O instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&O instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&O instanceof ImageBitmap||typeof VideoFrame<"u"&&O instanceof VideoFrame){const be=Math.floor(me*Me.width),Pe=Math.floor(me*Me.height);g===void 0&&(g=A(be,Pe));const fe=T?A(be,Pe):g;return fe.width=be,fe.height=Pe,fe.getContext("2d").drawImage(O,0,0,be,Pe),gt("WebGLRenderer: Texture has been resized from ("+Me.width+"x"+Me.height+") to ("+be+"x"+Pe+")."),fe}else return"data"in O&&gt("WebGLRenderer: Image in DataTexture is too big ("+Me.width+"x"+Me.height+")."),O;return O}function y(O){return O.generateMipmaps}function R(O){r.generateMipmap(O)}function D(O){return O.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:O.isWebGL3DRenderTarget?r.TEXTURE_3D:O.isWebGLArrayRenderTarget||O.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function U(O,T,Q,me,Me,be=!1){if(O!==null){if(r[O]!==void 0)return r[O];gt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+O+"'")}let Pe;me&&(Pe=e.get("EXT_texture_norm16"),Pe||gt("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let fe=T;if(T===r.RED&&(Q===r.FLOAT&&(fe=r.R32F),Q===r.HALF_FLOAT&&(fe=r.R16F),Q===r.UNSIGNED_BYTE&&(fe=r.R8),Q===r.UNSIGNED_SHORT&&Pe&&(fe=Pe.R16_EXT),Q===r.SHORT&&Pe&&(fe=Pe.R16_SNORM_EXT)),T===r.RED_INTEGER&&(Q===r.UNSIGNED_BYTE&&(fe=r.R8UI),Q===r.UNSIGNED_SHORT&&(fe=r.R16UI),Q===r.UNSIGNED_INT&&(fe=r.R32UI),Q===r.BYTE&&(fe=r.R8I),Q===r.SHORT&&(fe=r.R16I),Q===r.INT&&(fe=r.R32I)),T===r.RG&&(Q===r.FLOAT&&(fe=r.RG32F),Q===r.HALF_FLOAT&&(fe=r.RG16F),Q===r.UNSIGNED_BYTE&&(fe=r.RG8),Q===r.UNSIGNED_SHORT&&Pe&&(fe=Pe.RG16_EXT),Q===r.SHORT&&Pe&&(fe=Pe.RG16_SNORM_EXT)),T===r.RG_INTEGER&&(Q===r.UNSIGNED_BYTE&&(fe=r.RG8UI),Q===r.UNSIGNED_SHORT&&(fe=r.RG16UI),Q===r.UNSIGNED_INT&&(fe=r.RG32UI),Q===r.BYTE&&(fe=r.RG8I),Q===r.SHORT&&(fe=r.RG16I),Q===r.INT&&(fe=r.RG32I)),T===r.RGB_INTEGER&&(Q===r.UNSIGNED_BYTE&&(fe=r.RGB8UI),Q===r.UNSIGNED_SHORT&&(fe=r.RGB16UI),Q===r.UNSIGNED_INT&&(fe=r.RGB32UI),Q===r.BYTE&&(fe=r.RGB8I),Q===r.SHORT&&(fe=r.RGB16I),Q===r.INT&&(fe=r.RGB32I)),T===r.RGBA_INTEGER&&(Q===r.UNSIGNED_BYTE&&(fe=r.RGBA8UI),Q===r.UNSIGNED_SHORT&&(fe=r.RGBA16UI),Q===r.UNSIGNED_INT&&(fe=r.RGBA32UI),Q===r.BYTE&&(fe=r.RGBA8I),Q===r.SHORT&&(fe=r.RGBA16I),Q===r.INT&&(fe=r.RGBA32I)),T===r.RGB&&(Q===r.UNSIGNED_SHORT&&Pe&&(fe=Pe.RGB16_EXT),Q===r.SHORT&&Pe&&(fe=Pe.RGB16_SNORM_EXT),Q===r.UNSIGNED_INT_5_9_9_9_REV&&(fe=r.RGB9_E5),Q===r.UNSIGNED_INT_10F_11F_11F_REV&&(fe=r.R11F_G11F_B10F)),T===r.RGBA){const pe=be?af:$t.getTransfer(Me);Q===r.FLOAT&&(fe=r.RGBA32F),Q===r.HALF_FLOAT&&(fe=r.RGBA16F),Q===r.UNSIGNED_BYTE&&(fe=pe===cn?r.SRGB8_ALPHA8:r.RGBA8),Q===r.UNSIGNED_SHORT&&Pe&&(fe=Pe.RGBA16_EXT),Q===r.SHORT&&Pe&&(fe=Pe.RGBA16_SNORM_EXT),Q===r.UNSIGNED_SHORT_4_4_4_4&&(fe=r.RGBA4),Q===r.UNSIGNED_SHORT_5_5_5_1&&(fe=r.RGB5_A1)}return(fe===r.R16F||fe===r.R32F||fe===r.RG16F||fe===r.RG32F||fe===r.RGBA16F||fe===r.RGBA32F)&&e.get("EXT_color_buffer_float"),fe}function G(O,T){let Q;return O?T===null||T===Ha||T===nc?Q=r.DEPTH24_STENCIL8:T===Pa?Q=r.DEPTH32F_STENCIL8:T===tc&&(Q=r.DEPTH24_STENCIL8,gt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):T===null||T===Ha||T===nc?Q=r.DEPTH_COMPONENT24:T===Pa?Q=r.DEPTH_COMPONENT32F:T===tc&&(Q=r.DEPTH_COMPONENT16),Q}function I(O,T){return y(O)===!0||O.isFramebufferTexture&&O.minFilter!==oi&&O.minFilter!==mi?Math.log2(Math.max(T.width,T.height))+1:O.mipmaps!==void 0&&O.mipmaps.length>0?O.mipmaps.length:O.isCompressedTexture&&Array.isArray(O.image)?T.mipmaps.length:1}function B(O){const T=O.target;T.removeEventListener("dispose",B),F(T),T.isVideoTexture&&x.delete(T),T.isHTMLTexture&&v.delete(T)}function w(O){const T=O.target;T.removeEventListener("dispose",w),k(T)}function F(O){const T=s.get(O);if(T.__webglInit===void 0)return;const Q=O.source,me=b.get(Q);if(me){const Me=me[T.__cacheKey];Me.usedTimes--,Me.usedTimes===0&&$(O),Object.keys(me).length===0&&b.delete(Q)}s.remove(O)}function $(O){const T=s.get(O);r.deleteTexture(T.__webglTexture);const Q=O.source,me=b.get(Q);delete me[T.__cacheKey],u.memory.textures--}function k(O){const T=s.get(O);if(O.depthTexture&&(O.depthTexture.dispose(),s.remove(O.depthTexture)),O.isWebGLCubeRenderTarget)for(let me=0;me<6;me++){if(Array.isArray(T.__webglFramebuffer[me]))for(let Me=0;Me<T.__webglFramebuffer[me].length;Me++)r.deleteFramebuffer(T.__webglFramebuffer[me][Me]);else r.deleteFramebuffer(T.__webglFramebuffer[me]);T.__webglDepthbuffer&&r.deleteRenderbuffer(T.__webglDepthbuffer[me])}else{if(Array.isArray(T.__webglFramebuffer))for(let me=0;me<T.__webglFramebuffer.length;me++)r.deleteFramebuffer(T.__webglFramebuffer[me]);else r.deleteFramebuffer(T.__webglFramebuffer);if(T.__webglDepthbuffer&&r.deleteRenderbuffer(T.__webglDepthbuffer),T.__webglMultisampledFramebuffer&&r.deleteFramebuffer(T.__webglMultisampledFramebuffer),T.__webglColorRenderbuffer)for(let me=0;me<T.__webglColorRenderbuffer.length;me++)T.__webglColorRenderbuffer[me]&&r.deleteRenderbuffer(T.__webglColorRenderbuffer[me]);T.__webglDepthRenderbuffer&&r.deleteRenderbuffer(T.__webglDepthRenderbuffer)}const Q=O.textures;for(let me=0,Me=Q.length;me<Me;me++){const be=s.get(Q[me]);be.__webglTexture&&(r.deleteTexture(be.__webglTexture),u.memory.textures--),s.remove(Q[me])}s.remove(O)}let X=0;function te(){X=0}function oe(){return X}function V(O){X=O}function L(){const O=X;return O>=l.maxTextures&&gt("WebGLTextures: Trying to use "+O+" texture units while this GPU supports only "+l.maxTextures),X+=1,O}function z(O){const T=[];return T.push(O.wrapS),T.push(O.wrapT),T.push(O.wrapR||0),T.push(O.magFilter),T.push(O.minFilter),T.push(O.anisotropy),T.push(O.internalFormat),T.push(O.format),T.push(O.type),T.push(O.generateMipmaps),T.push(O.premultiplyAlpha),T.push(O.flipY),T.push(O.unpackAlignment),T.push(O.colorSpace),T.join()}function W(O,T){const Q=s.get(O);if(O.isVideoTexture&&Et(O),O.isRenderTargetTexture===!1&&O.isExternalTexture!==!0&&O.version>0&&Q.__version!==O.version){const me=O.image;if(me===null)gt("WebGLRenderer: Texture marked for update but no image data found.");else if(me.complete===!1)gt("WebGLRenderer: Texture marked for update but image is incomplete");else{Ge(Q,O,T);return}}else O.isExternalTexture&&(Q.__webglTexture=O.sourceTexture?O.sourceTexture:null);i.bindTexture(r.TEXTURE_2D,Q.__webglTexture,r.TEXTURE0+T)}function ce(O,T){const Q=s.get(O);if(O.isRenderTargetTexture===!1&&O.version>0&&Q.__version!==O.version){Ge(Q,O,T);return}else O.isExternalTexture&&(Q.__webglTexture=O.sourceTexture?O.sourceTexture:null);i.bindTexture(r.TEXTURE_2D_ARRAY,Q.__webglTexture,r.TEXTURE0+T)}function ge(O,T){const Q=s.get(O);if(O.isRenderTargetTexture===!1&&O.version>0&&Q.__version!==O.version){Ge(Q,O,T);return}i.bindTexture(r.TEXTURE_3D,Q.__webglTexture,r.TEXTURE0+T)}function P(O,T){const Q=s.get(O);if(O.isCubeDepthTexture!==!0&&O.version>0&&Q.__version!==O.version){Ze(Q,O,T);return}i.bindTexture(r.TEXTURE_CUBE_MAP,Q.__webglTexture,r.TEXTURE0+T)}const Z={[Ep]:r.REPEAT,[ps]:r.CLAMP_TO_EDGE,[Mp]:r.MIRRORED_REPEAT},_e={[oi]:r.NEAREST,[VM]:r.NEAREST_MIPMAP_NEAREST,[gu]:r.NEAREST_MIPMAP_LINEAR,[mi]:r.LINEAR,[Nh]:r.LINEAR_MIPMAP_NEAREST,[Ir]:r.LINEAR_MIPMAP_LINEAR},Te={[YM]:r.NEVER,[ZM]:r.ALWAYS,[WM]:r.LESS,[xm]:r.LEQUAL,[qM]:r.EQUAL,[_m]:r.GEQUAL,[$M]:r.GREATER,[KM]:r.NOTEQUAL};function Ne(O,T){if(T.type===Pa&&e.has("OES_texture_float_linear")===!1&&(T.magFilter===mi||T.magFilter===Nh||T.magFilter===gu||T.magFilter===Ir||T.minFilter===mi||T.minFilter===Nh||T.minFilter===gu||T.minFilter===Ir)&&gt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(O,r.TEXTURE_WRAP_S,Z[T.wrapS]),r.texParameteri(O,r.TEXTURE_WRAP_T,Z[T.wrapT]),(O===r.TEXTURE_3D||O===r.TEXTURE_2D_ARRAY)&&r.texParameteri(O,r.TEXTURE_WRAP_R,Z[T.wrapR]),r.texParameteri(O,r.TEXTURE_MAG_FILTER,_e[T.magFilter]),r.texParameteri(O,r.TEXTURE_MIN_FILTER,_e[T.minFilter]),T.compareFunction&&(r.texParameteri(O,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(O,r.TEXTURE_COMPARE_FUNC,Te[T.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(T.magFilter===oi||T.minFilter!==gu&&T.minFilter!==Ir||T.type===Pa&&e.has("OES_texture_float_linear")===!1)return;if(T.anisotropy>1||s.get(T).__currentAnisotropy){const Q=e.get("EXT_texture_filter_anisotropic");r.texParameterf(O,Q.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(T.anisotropy,l.getMaxAnisotropy())),s.get(T).__currentAnisotropy=T.anisotropy}}}function ee(O,T){let Q=!1;O.__webglInit===void 0&&(O.__webglInit=!0,T.addEventListener("dispose",B));const me=T.source;let Me=b.get(me);Me===void 0&&(Me={},b.set(me,Me));const be=z(T);if(be!==O.__cacheKey){Me[be]===void 0&&(Me[be]={texture:r.createTexture(),usedTimes:0},u.memory.textures++,Q=!0),Me[be].usedTimes++;const Pe=Me[O.__cacheKey];Pe!==void 0&&(Me[O.__cacheKey].usedTimes--,Pe.usedTimes===0&&$(T)),O.__cacheKey=be,O.__webglTexture=Me[be].texture}return Q}function Ee(O,T,Q){return Math.floor(Math.floor(O/Q)/T)}function Ae(O,T,Q,me){const be=O.updateRanges;if(be.length===0)i.texSubImage2D(r.TEXTURE_2D,0,0,0,T.width,T.height,Q,me,T.data);else{be.sort((Be,Ce)=>Be.start-Ce.start);let Pe=0;for(let Be=1;Be<be.length;Be++){const Ce=be[Pe],De=be[Be],it=Ce.start+Ce.count,dt=Ee(De.start,T.width,4),lt=Ee(Ce.start,T.width,4);De.start<=it+1&&dt===lt&&Ee(De.start+De.count-1,T.width,4)===dt?Ce.count=Math.max(Ce.count,De.start+De.count-Ce.start):(++Pe,be[Pe]=De)}be.length=Pe+1;const fe=i.getParameter(r.UNPACK_ROW_LENGTH),pe=i.getParameter(r.UNPACK_SKIP_PIXELS),Oe=i.getParameter(r.UNPACK_SKIP_ROWS);i.pixelStorei(r.UNPACK_ROW_LENGTH,T.width);for(let Be=0,Ce=be.length;Be<Ce;Be++){const De=be[Be],it=Math.floor(De.start/4),dt=Math.ceil(De.count/4),lt=it%T.width,j=Math.floor(it/T.width),Le=dt,he=1;i.pixelStorei(r.UNPACK_SKIP_PIXELS,lt),i.pixelStorei(r.UNPACK_SKIP_ROWS,j),i.texSubImage2D(r.TEXTURE_2D,0,lt,j,Le,he,Q,me,T.data)}O.clearUpdateRanges(),i.pixelStorei(r.UNPACK_ROW_LENGTH,fe),i.pixelStorei(r.UNPACK_SKIP_PIXELS,pe),i.pixelStorei(r.UNPACK_SKIP_ROWS,Oe)}}function Ge(O,T,Q){let me=r.TEXTURE_2D;(T.isDataArrayTexture||T.isCompressedArrayTexture)&&(me=r.TEXTURE_2D_ARRAY),T.isData3DTexture&&(me=r.TEXTURE_3D);const Me=ee(O,T),be=T.source;i.bindTexture(me,O.__webglTexture,r.TEXTURE0+Q);const Pe=s.get(be);if(be.version!==Pe.__version||Me===!0){if(i.activeTexture(r.TEXTURE0+Q),(typeof ImageBitmap<"u"&&T.image instanceof ImageBitmap)===!1){const he=$t.getPrimaries($t.workingColorSpace),Ue=T.colorSpace===Qs?null:$t.getPrimaries(T.colorSpace),Fe=T.colorSpace===Qs||he===Ue?r.NONE:r.BROWSER_DEFAULT_WEBGL;i.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,T.flipY),i.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),i.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Fe)}i.pixelStorei(r.UNPACK_ALIGNMENT,T.unpackAlignment);let pe=S(T.image,!1,l.maxTextureSize);pe=Ie(T,pe);const Oe=c.convert(T.format,T.colorSpace),Be=c.convert(T.type);let Ce=U(T.internalFormat,Oe,Be,T.normalized,T.colorSpace,T.isVideoTexture);Ne(me,T);let De;const it=T.mipmaps,dt=T.isVideoTexture!==!0,lt=Pe.__version===void 0||Me===!0,j=be.dataReady,Le=I(T,pe);if(T.isDepthTexture)Ce=G(T.format===Ur,T.type),lt&&(dt?i.texStorage2D(r.TEXTURE_2D,1,Ce,pe.width,pe.height):i.texImage2D(r.TEXTURE_2D,0,Ce,pe.width,pe.height,0,Oe,Be,null));else if(T.isDataTexture)if(it.length>0){dt&&lt&&i.texStorage2D(r.TEXTURE_2D,Le,Ce,it[0].width,it[0].height);for(let he=0,Ue=it.length;he<Ue;he++)De=it[he],dt?j&&i.texSubImage2D(r.TEXTURE_2D,he,0,0,De.width,De.height,Oe,Be,De.data):i.texImage2D(r.TEXTURE_2D,he,Ce,De.width,De.height,0,Oe,Be,De.data);T.generateMipmaps=!1}else dt?(lt&&i.texStorage2D(r.TEXTURE_2D,Le,Ce,pe.width,pe.height),j&&Ae(T,pe,Oe,Be)):i.texImage2D(r.TEXTURE_2D,0,Ce,pe.width,pe.height,0,Oe,Be,pe.data);else if(T.isCompressedTexture)if(T.isCompressedArrayTexture){dt&&lt&&i.texStorage3D(r.TEXTURE_2D_ARRAY,Le,Ce,it[0].width,it[0].height,pe.depth);for(let he=0,Ue=it.length;he<Ue;he++)if(De=it[he],T.format!==Aa)if(Oe!==null)if(dt){if(j)if(T.layerUpdates.size>0){const Fe=cv(De.width,De.height,T.format,T.type);for(const we of T.layerUpdates){const We=De.data.subarray(we*Fe/De.data.BYTES_PER_ELEMENT,(we+1)*Fe/De.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,he,0,0,we,De.width,De.height,1,Oe,We)}T.clearLayerUpdates()}else i.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,he,0,0,0,De.width,De.height,pe.depth,Oe,De.data)}else i.compressedTexImage3D(r.TEXTURE_2D_ARRAY,he,Ce,De.width,De.height,pe.depth,0,De.data,0,0);else gt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else dt?j&&i.texSubImage3D(r.TEXTURE_2D_ARRAY,he,0,0,0,De.width,De.height,pe.depth,Oe,Be,De.data):i.texImage3D(r.TEXTURE_2D_ARRAY,he,Ce,De.width,De.height,pe.depth,0,Oe,Be,De.data)}else{dt&&lt&&i.texStorage2D(r.TEXTURE_2D,Le,Ce,it[0].width,it[0].height);for(let he=0,Ue=it.length;he<Ue;he++)De=it[he],T.format!==Aa?Oe!==null?dt?j&&i.compressedTexSubImage2D(r.TEXTURE_2D,he,0,0,De.width,De.height,Oe,De.data):i.compressedTexImage2D(r.TEXTURE_2D,he,Ce,De.width,De.height,0,De.data):gt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):dt?j&&i.texSubImage2D(r.TEXTURE_2D,he,0,0,De.width,De.height,Oe,Be,De.data):i.texImage2D(r.TEXTURE_2D,he,Ce,De.width,De.height,0,Oe,Be,De.data)}else if(T.isDataArrayTexture)if(dt){if(lt&&i.texStorage3D(r.TEXTURE_2D_ARRAY,Le,Ce,pe.width,pe.height,pe.depth),j)if(T.layerUpdates.size>0){const he=cv(pe.width,pe.height,T.format,T.type);for(const Ue of T.layerUpdates){const Fe=pe.data.subarray(Ue*he/pe.data.BYTES_PER_ELEMENT,(Ue+1)*he/pe.data.BYTES_PER_ELEMENT);i.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,Ue,pe.width,pe.height,1,Oe,Be,Fe)}T.clearLayerUpdates()}else i.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,pe.width,pe.height,pe.depth,Oe,Be,pe.data)}else i.texImage3D(r.TEXTURE_2D_ARRAY,0,Ce,pe.width,pe.height,pe.depth,0,Oe,Be,pe.data);else if(T.isData3DTexture)dt?(lt&&i.texStorage3D(r.TEXTURE_3D,Le,Ce,pe.width,pe.height,pe.depth),j&&i.texSubImage3D(r.TEXTURE_3D,0,0,0,0,pe.width,pe.height,pe.depth,Oe,Be,pe.data)):i.texImage3D(r.TEXTURE_3D,0,Ce,pe.width,pe.height,pe.depth,0,Oe,Be,pe.data);else if(T.isFramebufferTexture){if(lt)if(dt)i.texStorage2D(r.TEXTURE_2D,Le,Ce,pe.width,pe.height);else{let he=pe.width,Ue=pe.height;for(let Fe=0;Fe<Le;Fe++)i.texImage2D(r.TEXTURE_2D,Fe,Ce,he,Ue,0,Oe,Be,null),he>>=1,Ue>>=1}}else if(T.isHTMLTexture){if("texElementImage2D"in r){const he=r.canvas;if(he.hasAttribute("layoutsubtree")||he.setAttribute("layoutsubtree","true"),pe.parentNode!==he){he.appendChild(pe),v.add(T),he.onpaint=at=>{const rn=at.changedElements;for(const Lt of v)rn.includes(Lt.image)&&(Lt.needsUpdate=!0)},he.requestPaint();return}const Ue=0,Fe=r.RGBA,we=r.RGBA,We=r.UNSIGNED_BYTE;r.texElementImage2D(r.TEXTURE_2D,Ue,Fe,we,We,pe),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MIN_FILTER,r.LINEAR),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_S,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_T,r.CLAMP_TO_EDGE)}}else if(it.length>0){if(dt&&lt){const he=ot(it[0]);i.texStorage2D(r.TEXTURE_2D,Le,Ce,he.width,he.height)}for(let he=0,Ue=it.length;he<Ue;he++)De=it[he],dt?j&&i.texSubImage2D(r.TEXTURE_2D,he,0,0,Oe,Be,De):i.texImage2D(r.TEXTURE_2D,he,Ce,Oe,Be,De);T.generateMipmaps=!1}else if(dt){if(lt){const he=ot(pe);i.texStorage2D(r.TEXTURE_2D,Le,Ce,he.width,he.height)}j&&i.texSubImage2D(r.TEXTURE_2D,0,0,0,Oe,Be,pe)}else i.texImage2D(r.TEXTURE_2D,0,Ce,Oe,Be,pe);y(T)&&R(me),Pe.__version=be.version,T.onUpdate&&T.onUpdate(T)}O.__version=T.version}function Ze(O,T,Q){if(T.image.length!==6)return;const me=ee(O,T),Me=T.source;i.bindTexture(r.TEXTURE_CUBE_MAP,O.__webglTexture,r.TEXTURE0+Q);const be=s.get(Me);if(Me.version!==be.__version||me===!0){i.activeTexture(r.TEXTURE0+Q);const Pe=$t.getPrimaries($t.workingColorSpace),fe=T.colorSpace===Qs?null:$t.getPrimaries(T.colorSpace),pe=T.colorSpace===Qs||Pe===fe?r.NONE:r.BROWSER_DEFAULT_WEBGL;i.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,T.flipY),i.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),i.pixelStorei(r.UNPACK_ALIGNMENT,T.unpackAlignment),i.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,pe);const Oe=T.isCompressedTexture||T.image[0].isCompressedTexture,Be=T.image[0]&&T.image[0].isDataTexture,Ce=[];for(let we=0;we<6;we++)!Oe&&!Be?Ce[we]=S(T.image[we],!0,l.maxCubemapSize):Ce[we]=Be?T.image[we].image:T.image[we],Ce[we]=Ie(T,Ce[we]);const De=Ce[0],it=c.convert(T.format,T.colorSpace),dt=c.convert(T.type),lt=U(T.internalFormat,it,dt,T.normalized,T.colorSpace),j=T.isVideoTexture!==!0,Le=be.__version===void 0||me===!0,he=Me.dataReady;let Ue=I(T,De);Ne(r.TEXTURE_CUBE_MAP,T);let Fe;if(Oe){j&&Le&&i.texStorage2D(r.TEXTURE_CUBE_MAP,Ue,lt,De.width,De.height);for(let we=0;we<6;we++){Fe=Ce[we].mipmaps;for(let We=0;We<Fe.length;We++){const at=Fe[We];T.format!==Aa?it!==null?j?he&&i.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+we,We,0,0,at.width,at.height,it,at.data):i.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+we,We,lt,at.width,at.height,0,at.data):gt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):j?he&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+we,We,0,0,at.width,at.height,it,dt,at.data):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+we,We,lt,at.width,at.height,0,it,dt,at.data)}}}else{if(Fe=T.mipmaps,j&&Le){Fe.length>0&&Ue++;const we=ot(Ce[0]);i.texStorage2D(r.TEXTURE_CUBE_MAP,Ue,lt,we.width,we.height)}for(let we=0;we<6;we++)if(Be){j?he&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+we,0,0,0,Ce[we].width,Ce[we].height,it,dt,Ce[we].data):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+we,0,lt,Ce[we].width,Ce[we].height,0,it,dt,Ce[we].data);for(let We=0;We<Fe.length;We++){const rn=Fe[We].image[we].image;j?he&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+we,We+1,0,0,rn.width,rn.height,it,dt,rn.data):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+we,We+1,lt,rn.width,rn.height,0,it,dt,rn.data)}}else{j?he&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+we,0,0,0,it,dt,Ce[we]):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+we,0,lt,it,dt,Ce[we]);for(let We=0;We<Fe.length;We++){const at=Fe[We];j?he&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+we,We+1,0,0,it,dt,at.image[we]):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+we,We+1,lt,it,dt,at.image[we])}}}y(T)&&R(r.TEXTURE_CUBE_MAP),be.__version=Me.version,T.onUpdate&&T.onUpdate(T)}O.__version=T.version}function Ke(O,T,Q,me,Me,be){const Pe=c.convert(Q.format,Q.colorSpace),fe=c.convert(Q.type),pe=U(Q.internalFormat,Pe,fe,Q.normalized,Q.colorSpace),Oe=s.get(T),Be=s.get(Q);if(Be.__renderTarget=T,!Oe.__hasExternalTextures){const Ce=Math.max(1,T.width>>be),De=Math.max(1,T.height>>be);Me===r.TEXTURE_3D||Me===r.TEXTURE_2D_ARRAY?i.texImage3D(Me,be,pe,Ce,De,T.depth,0,Pe,fe,null):i.texImage2D(Me,be,pe,Ce,De,0,Pe,fe,null)}i.bindFramebuffer(r.FRAMEBUFFER,O),yt(T)?h.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,me,Me,Be.__webglTexture,0,vt(T)):(Me===r.TEXTURE_2D||Me>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&Me<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,me,Me,Be.__webglTexture,be),i.bindFramebuffer(r.FRAMEBUFFER,null)}function wt(O,T,Q){if(r.bindRenderbuffer(r.RENDERBUFFER,O),T.depthBuffer){const me=T.depthTexture,Me=me&&me.isDepthTexture?me.type:null,be=G(T.stencilBuffer,Me),Pe=T.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;yt(T)?h.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,vt(T),be,T.width,T.height):Q?r.renderbufferStorageMultisample(r.RENDERBUFFER,vt(T),be,T.width,T.height):r.renderbufferStorage(r.RENDERBUFFER,be,T.width,T.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,Pe,r.RENDERBUFFER,O)}else{const me=T.textures;for(let Me=0;Me<me.length;Me++){const be=me[Me],Pe=c.convert(be.format,be.colorSpace),fe=c.convert(be.type),pe=U(be.internalFormat,Pe,fe,be.normalized,be.colorSpace);yt(T)?h.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,vt(T),pe,T.width,T.height):Q?r.renderbufferStorageMultisample(r.RENDERBUFFER,vt(T),pe,T.width,T.height):r.renderbufferStorage(r.RENDERBUFFER,pe,T.width,T.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function ft(O,T,Q){const me=T.isWebGLCubeRenderTarget===!0;if(i.bindFramebuffer(r.FRAMEBUFFER,O),!(T.depthTexture&&T.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Me=s.get(T.depthTexture);if(Me.__renderTarget=T,(!Me.__webglTexture||T.depthTexture.image.width!==T.width||T.depthTexture.image.height!==T.height)&&(T.depthTexture.image.width=T.width,T.depthTexture.image.height=T.height,T.depthTexture.needsUpdate=!0),me){if(Me.__webglInit===void 0&&(Me.__webglInit=!0,T.depthTexture.addEventListener("dispose",B)),Me.__webglTexture===void 0){Me.__webglTexture=r.createTexture(),i.bindTexture(r.TEXTURE_CUBE_MAP,Me.__webglTexture),Ne(r.TEXTURE_CUBE_MAP,T.depthTexture);const Oe=c.convert(T.depthTexture.format),Be=c.convert(T.depthTexture.type);let Ce;T.depthTexture.format===_s?Ce=r.DEPTH_COMPONENT24:T.depthTexture.format===Ur&&(Ce=r.DEPTH24_STENCIL8);for(let De=0;De<6;De++)r.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+De,0,Ce,T.width,T.height,0,Oe,Be,null)}}else W(T.depthTexture,0);const be=Me.__webglTexture,Pe=vt(T),fe=me?r.TEXTURE_CUBE_MAP_POSITIVE_X+Q:r.TEXTURE_2D,pe=T.depthTexture.format===Ur?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;if(T.depthTexture.format===_s)yt(T)?h.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,pe,fe,be,0,Pe):r.framebufferTexture2D(r.FRAMEBUFFER,pe,fe,be,0);else if(T.depthTexture.format===Ur)yt(T)?h.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,pe,fe,be,0,Pe):r.framebufferTexture2D(r.FRAMEBUFFER,pe,fe,be,0);else throw new Error("Unknown depthTexture format")}function Ve(O){const T=s.get(O),Q=O.isWebGLCubeRenderTarget===!0;if(T.__boundDepthTexture!==O.depthTexture){const me=O.depthTexture;if(T.__depthDisposeCallback&&T.__depthDisposeCallback(),me){const Me=()=>{delete T.__boundDepthTexture,delete T.__depthDisposeCallback,me.removeEventListener("dispose",Me)};me.addEventListener("dispose",Me),T.__depthDisposeCallback=Me}T.__boundDepthTexture=me}if(O.depthTexture&&!T.__autoAllocateDepthBuffer)if(Q)for(let me=0;me<6;me++)ft(T.__webglFramebuffer[me],O,me);else{const me=O.texture.mipmaps;me&&me.length>0?ft(T.__webglFramebuffer[0],O,0):ft(T.__webglFramebuffer,O,0)}else if(Q){T.__webglDepthbuffer=[];for(let me=0;me<6;me++)if(i.bindFramebuffer(r.FRAMEBUFFER,T.__webglFramebuffer[me]),T.__webglDepthbuffer[me]===void 0)T.__webglDepthbuffer[me]=r.createRenderbuffer(),wt(T.__webglDepthbuffer[me],O,!1);else{const Me=O.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,be=T.__webglDepthbuffer[me];r.bindRenderbuffer(r.RENDERBUFFER,be),r.framebufferRenderbuffer(r.FRAMEBUFFER,Me,r.RENDERBUFFER,be)}}else{const me=O.texture.mipmaps;if(me&&me.length>0?i.bindFramebuffer(r.FRAMEBUFFER,T.__webglFramebuffer[0]):i.bindFramebuffer(r.FRAMEBUFFER,T.__webglFramebuffer),T.__webglDepthbuffer===void 0)T.__webglDepthbuffer=r.createRenderbuffer(),wt(T.__webglDepthbuffer,O,!1);else{const Me=O.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,be=T.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,be),r.framebufferRenderbuffer(r.FRAMEBUFFER,Me,r.RENDERBUFFER,be)}}i.bindFramebuffer(r.FRAMEBUFFER,null)}function Ft(O,T,Q){const me=s.get(O);T!==void 0&&Ke(me.__webglFramebuffer,O,O.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),Q!==void 0&&Ve(O)}function xt(O){const T=O.texture,Q=s.get(O),me=s.get(T);O.addEventListener("dispose",w);const Me=O.textures,be=O.isWebGLCubeRenderTarget===!0,Pe=Me.length>1;if(Pe||(me.__webglTexture===void 0&&(me.__webglTexture=r.createTexture()),me.__version=T.version,u.memory.textures++),be){Q.__webglFramebuffer=[];for(let fe=0;fe<6;fe++)if(T.mipmaps&&T.mipmaps.length>0){Q.__webglFramebuffer[fe]=[];for(let pe=0;pe<T.mipmaps.length;pe++)Q.__webglFramebuffer[fe][pe]=r.createFramebuffer()}else Q.__webglFramebuffer[fe]=r.createFramebuffer()}else{if(T.mipmaps&&T.mipmaps.length>0){Q.__webglFramebuffer=[];for(let fe=0;fe<T.mipmaps.length;fe++)Q.__webglFramebuffer[fe]=r.createFramebuffer()}else Q.__webglFramebuffer=r.createFramebuffer();if(Pe)for(let fe=0,pe=Me.length;fe<pe;fe++){const Oe=s.get(Me[fe]);Oe.__webglTexture===void 0&&(Oe.__webglTexture=r.createTexture(),u.memory.textures++)}if(O.samples>0&&yt(O)===!1){Q.__webglMultisampledFramebuffer=r.createFramebuffer(),Q.__webglColorRenderbuffer=[],i.bindFramebuffer(r.FRAMEBUFFER,Q.__webglMultisampledFramebuffer);for(let fe=0;fe<Me.length;fe++){const pe=Me[fe];Q.__webglColorRenderbuffer[fe]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,Q.__webglColorRenderbuffer[fe]);const Oe=c.convert(pe.format,pe.colorSpace),Be=c.convert(pe.type),Ce=U(pe.internalFormat,Oe,Be,pe.normalized,pe.colorSpace,O.isXRRenderTarget===!0),De=vt(O);r.renderbufferStorageMultisample(r.RENDERBUFFER,De,Ce,O.width,O.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+fe,r.RENDERBUFFER,Q.__webglColorRenderbuffer[fe])}r.bindRenderbuffer(r.RENDERBUFFER,null),O.depthBuffer&&(Q.__webglDepthRenderbuffer=r.createRenderbuffer(),wt(Q.__webglDepthRenderbuffer,O,!0)),i.bindFramebuffer(r.FRAMEBUFFER,null)}}if(be){i.bindTexture(r.TEXTURE_CUBE_MAP,me.__webglTexture),Ne(r.TEXTURE_CUBE_MAP,T);for(let fe=0;fe<6;fe++)if(T.mipmaps&&T.mipmaps.length>0)for(let pe=0;pe<T.mipmaps.length;pe++)Ke(Q.__webglFramebuffer[fe][pe],O,T,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+fe,pe);else Ke(Q.__webglFramebuffer[fe],O,T,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0);y(T)&&R(r.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(Pe){for(let fe=0,pe=Me.length;fe<pe;fe++){const Oe=Me[fe],Be=s.get(Oe);let Ce=r.TEXTURE_2D;(O.isWebGL3DRenderTarget||O.isWebGLArrayRenderTarget)&&(Ce=O.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),i.bindTexture(Ce,Be.__webglTexture),Ne(Ce,Oe),Ke(Q.__webglFramebuffer,O,Oe,r.COLOR_ATTACHMENT0+fe,Ce,0),y(Oe)&&R(Ce)}i.unbindTexture()}else{let fe=r.TEXTURE_2D;if((O.isWebGL3DRenderTarget||O.isWebGLArrayRenderTarget)&&(fe=O.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),i.bindTexture(fe,me.__webglTexture),Ne(fe,T),T.mipmaps&&T.mipmaps.length>0)for(let pe=0;pe<T.mipmaps.length;pe++)Ke(Q.__webglFramebuffer[pe],O,T,r.COLOR_ATTACHMENT0,fe,pe);else Ke(Q.__webglFramebuffer,O,T,r.COLOR_ATTACHMENT0,fe,0);y(T)&&R(fe),i.unbindTexture()}O.depthBuffer&&Ve(O)}function mn(O){const T=O.textures;for(let Q=0,me=T.length;Q<me;Q++){const Me=T[Q];if(y(Me)){const be=D(O),Pe=s.get(Me).__webglTexture;i.bindTexture(be,Pe),R(be),i.unbindTexture()}}}const Kt=[],Yt=[];function q(O){if(O.samples>0){if(yt(O)===!1){const T=O.textures,Q=O.width,me=O.height;let Me=r.COLOR_BUFFER_BIT;const be=O.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Pe=s.get(O),fe=T.length>1;if(fe)for(let Oe=0;Oe<T.length;Oe++)i.bindFramebuffer(r.FRAMEBUFFER,Pe.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Oe,r.RENDERBUFFER,null),i.bindFramebuffer(r.FRAMEBUFFER,Pe.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Oe,r.TEXTURE_2D,null,0);i.bindFramebuffer(r.READ_FRAMEBUFFER,Pe.__webglMultisampledFramebuffer);const pe=O.texture.mipmaps;pe&&pe.length>0?i.bindFramebuffer(r.DRAW_FRAMEBUFFER,Pe.__webglFramebuffer[0]):i.bindFramebuffer(r.DRAW_FRAMEBUFFER,Pe.__webglFramebuffer);for(let Oe=0;Oe<T.length;Oe++){if(O.resolveDepthBuffer&&(O.depthBuffer&&(Me|=r.DEPTH_BUFFER_BIT),O.stencilBuffer&&O.resolveStencilBuffer&&(Me|=r.STENCIL_BUFFER_BIT)),fe){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,Pe.__webglColorRenderbuffer[Oe]);const Be=s.get(T[Oe]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,Be,0)}r.blitFramebuffer(0,0,Q,me,0,0,Q,me,Me,r.NEAREST),m===!0&&(Kt.length=0,Yt.length=0,Kt.push(r.COLOR_ATTACHMENT0+Oe),O.depthBuffer&&O.resolveDepthBuffer===!1&&(Kt.push(be),Yt.push(be),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,Yt)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,Kt))}if(i.bindFramebuffer(r.READ_FRAMEBUFFER,null),i.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),fe)for(let Oe=0;Oe<T.length;Oe++){i.bindFramebuffer(r.FRAMEBUFFER,Pe.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Oe,r.RENDERBUFFER,Pe.__webglColorRenderbuffer[Oe]);const Be=s.get(T[Oe]).__webglTexture;i.bindFramebuffer(r.FRAMEBUFFER,Pe.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Oe,r.TEXTURE_2D,Be,0)}i.bindFramebuffer(r.DRAW_FRAMEBUFFER,Pe.__webglMultisampledFramebuffer)}else if(O.depthBuffer&&O.resolveDepthBuffer===!1&&m){const T=O.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[T])}}}function vt(O){return Math.min(l.maxSamples,O.samples)}function yt(O){const T=s.get(O);return O.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&T.__useRenderToTexture!==!1}function Et(O){const T=u.render.frame;x.get(O)!==T&&(x.set(O,T),O.update())}function Ie(O,T){const Q=O.colorSpace,me=O.format,Me=O.type;return O.isCompressedTexture===!0||O.isVideoTexture===!0||Q!==nf&&Q!==Qs&&($t.getTransfer(Q)===cn?(me!==Aa||Me!==ma)&&gt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Jt("WebGLTextures: Unsupported texture color space:",Q)),T}function ot(O){return typeof HTMLImageElement<"u"&&O instanceof HTMLImageElement?(p.width=O.naturalWidth||O.width,p.height=O.naturalHeight||O.height):typeof VideoFrame<"u"&&O instanceof VideoFrame?(p.width=O.displayWidth,p.height=O.displayHeight):(p.width=O.width,p.height=O.height),p}this.allocateTextureUnit=L,this.resetTextureUnits=te,this.getTextureUnits=oe,this.setTextureUnits=V,this.setTexture2D=W,this.setTexture2DArray=ce,this.setTexture3D=ge,this.setTextureCube=P,this.rebindTextures=Ft,this.setupRenderTarget=xt,this.updateRenderTargetMipmap=mn,this.updateMultisampleRenderTarget=q,this.setupDepthRenderbuffer=Ve,this.setupFrameBufferTexture=Ke,this.useMultisampledRTT=yt,this.isReversedDepthBuffer=function(){return i.buffers.depth.getReversed()}}function wC(r,e){function i(s,l=Qs){let c;const u=$t.getTransfer(l);if(s===ma)return r.UNSIGNED_BYTE;if(s===dm)return r.UNSIGNED_SHORT_4_4_4_4;if(s===hm)return r.UNSIGNED_SHORT_5_5_5_1;if(s===lb)return r.UNSIGNED_INT_5_9_9_9_REV;if(s===cb)return r.UNSIGNED_INT_10F_11F_11F_REV;if(s===rb)return r.BYTE;if(s===ob)return r.SHORT;if(s===tc)return r.UNSIGNED_SHORT;if(s===fm)return r.INT;if(s===Ha)return r.UNSIGNED_INT;if(s===Pa)return r.FLOAT;if(s===xs)return r.HALF_FLOAT;if(s===ub)return r.ALPHA;if(s===fb)return r.RGB;if(s===Aa)return r.RGBA;if(s===_s)return r.DEPTH_COMPONENT;if(s===Ur)return r.DEPTH_STENCIL;if(s===db)return r.RED;if(s===pm)return r.RED_INTEGER;if(s===zr)return r.RG;if(s===mm)return r.RG_INTEGER;if(s===gm)return r.RGBA_INTEGER;if(s===ju||s===Xu||s===Yu||s===Wu)if(u===cn)if(c=e.get("WEBGL_compressed_texture_s3tc_srgb"),c!==null){if(s===ju)return c.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===Xu)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===Yu)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===Wu)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(c=e.get("WEBGL_compressed_texture_s3tc"),c!==null){if(s===ju)return c.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===Xu)return c.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===Yu)return c.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===Wu)return c.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===Tp||s===Ap||s===wp||s===Rp)if(c=e.get("WEBGL_compressed_texture_pvrtc"),c!==null){if(s===Tp)return c.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===Ap)return c.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===wp)return c.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===Rp)return c.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===Cp||s===Np||s===Op||s===Dp||s===Lp||s===ef||s===Ip)if(c=e.get("WEBGL_compressed_texture_etc"),c!==null){if(s===Cp||s===Np)return u===cn?c.COMPRESSED_SRGB8_ETC2:c.COMPRESSED_RGB8_ETC2;if(s===Op)return u===cn?c.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:c.COMPRESSED_RGBA8_ETC2_EAC;if(s===Dp)return c.COMPRESSED_R11_EAC;if(s===Lp)return c.COMPRESSED_SIGNED_R11_EAC;if(s===ef)return c.COMPRESSED_RG11_EAC;if(s===Ip)return c.COMPRESSED_SIGNED_RG11_EAC}else return null;if(s===Up||s===Pp||s===Fp||s===Bp||s===zp||s===Gp||s===Hp||s===kp||s===Vp||s===jp||s===Xp||s===Yp||s===Wp||s===qp)if(c=e.get("WEBGL_compressed_texture_astc"),c!==null){if(s===Up)return u===cn?c.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:c.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===Pp)return u===cn?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:c.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===Fp)return u===cn?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:c.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===Bp)return u===cn?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:c.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===zp)return u===cn?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:c.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===Gp)return u===cn?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:c.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===Hp)return u===cn?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:c.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===kp)return u===cn?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:c.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===Vp)return u===cn?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:c.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===jp)return u===cn?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:c.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===Xp)return u===cn?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:c.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===Yp)return u===cn?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:c.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===Wp)return u===cn?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:c.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===qp)return u===cn?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:c.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===$p||s===Kp||s===Zp)if(c=e.get("EXT_texture_compression_bptc"),c!==null){if(s===$p)return u===cn?c.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:c.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===Kp)return c.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===Zp)return c.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===Qp||s===Jp||s===tf||s===em)if(c=e.get("EXT_texture_compression_rgtc"),c!==null){if(s===Qp)return c.COMPRESSED_RED_RGTC1_EXT;if(s===Jp)return c.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===tf)return c.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===em)return c.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===nc?r.UNSIGNED_INT_24_8:r[s]!==void 0?r[s]:null}return{convert:i}}const RC=`
void main() {
...
}`;class NC{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,i){if(this.texture===null){const s=new Sb(e.texture);(e.depthNear!==i.depthNear||e.depthFar!==i.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=s}}getMesh(e){if(this.texture!==null&&this.mesh===null){const i=e.cameras[0].viewport,s=new Va({vertexShader:RC,fragmentShader:CC,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new ka(new cf(20,20),s)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class OC extends ir{constructor(e,i){super();const s=this;let l=null,c=1,u=null,h="local-floor",m=1,p=null,x=null,v=null,g=null,b=null,M=null;const A=typeof XRWebGLBinding<"u",S=new NC,y={},R=i.getContextAttributes();let D=null,U=null;const G=[],I=[],B=new Dt;let w=null;const F=new pa;F.viewport=new Ln;const $=new pa;$.viewport=new Ln;const k=[F,$],X=new GT;let te=null,oe=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(ee){let Ee=G[ee];return Ee===void 0&&(Ee=new Fh,G[ee]=Ee),Ee.getTargetRaySpace()},this.getControllerGrip=function(ee){let Ee=G[ee];return Ee===void 0&&(Ee=new Fh,G[ee]=Ee),Ee.getGripSpace()},this.getHand=function(ee){let Ee=G[ee];return Ee===void 0&&(Ee=new Fh,G[ee]=Ee),Ee.getHandSpace()};function V(ee){const Ee=I.indexOf(ee.inputSource);if(Ee===-1)return;const Ae=G[Ee];Ae!==void 0&&(Ae.update(ee.inputSource,ee.frame,p||u),Ae.dispatchEvent({type:ee.type,data:ee.inputSource}))}function L(){l.removeEventListener("select",V),l.removeEventListener("selectstart",V),l.removeEventListener("selectend",V),l.removeEventListener("squeeze",V),l.removeEventListener("squeezestart",V),l.removeEventListener("squeezeend",V),l.removeEventListener("end",L),l.removeEventListener("inputsourceschange",z);for(let ee=0;ee<G.length;ee++){const Ee=I[ee];Ee!==null&&(I[ee]=null,G[ee].disconnect(Ee))}te=null,oe=null,S.reset();for(const ee in y)delete y[ee];e.setRenderTarget(D),b=null,g=null,v=null,l=null,U=null,Ne.stop(),s.isPresenting=!1,e.setPixelRatio(w),e.setSize(B.width,B.height,!1),s.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(ee){c=ee,s.isPresenting===!0&&gt("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(ee){h=ee,s.isPresenting===!0&&gt("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||u},this.setReferenceSpace=function(ee){p=ee},this.getBaseLayer=function(){return g!==null?g:b},this.getBinding=function(){return v===null&&A&&(v=new XRWebGLBinding(l,i)),v},this.getFrame=function(){return M},this.getSession=function(){return l},this.setSession=async function(ee){if(l=ee,l!==null){if(D=e.getRenderTarget(),l.addEventListener("select",V),l.addEventListener("selectstart",V),l.addEventListener("selectend",V),l.addEventListener("squeeze",V),l.addEventListener("squeezestart",V),l.addEventListener("squeezeend",V),l.addEventListener("end",L),l.addEventListener("inputsourceschange",z),R.xrCompatible!==!0&&await i.makeXRCompatible(),w=e.getPixelRatio(),e.getSize(B),A&&"createProjectionLayer"in XRWebGLBinding.prototype){let Ae=null,Ge=null,Ze=null;R.depth&&(Ze=R.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,Ae=R.stencil?Ur:_s,Ge=R.stencil?nc:Ha);const Ke={colorFormat:i.RGBA8,depthFormat:Ze,scaleFactor:c};v=this.getBinding(),g=v.createProjectionLayer(Ke),l.updateRenderState({layers:[g]}),e.setPixelRatio(1),e.setSize(g.textureWidth,g.textureHeight,!1),U=new za(g.textureWidth,g.textureHeight,{format:Aa,type:ma,depthTexture:new Yo(g.textureWidth,g.textureHeight,Ge,void 0,void 0,void 0,void 0,void 0,void 0,Ae),stencilBuffer:R.stencil,colorSpace:e.outputColorSpace,samples:R.antialias?4:0,resolveDepthBuffer:g.ignoreDepthValues===!1,resolveStencilBuffer:g.ignoreDepthValues===!1})}else{const Ae={antialias:R.antialias,alpha:!0,depth:R.depth,stencil:R.stencil,framebufferScaleFactor:c};b=new XRWebGLLayer(l,i,Ae),l.updateRenderState({baseLayer:b}),e.setPixelRatio(1),e.setSize(b.framebufferWidth,b.framebufferHeight,!1),U=new za(b.framebufferWidth,b.framebufferHeight,{format:Aa,type:ma,colorSpace:e.outputColorSpace,stencilBuffer:R.stencil,resolveDepthBuffer:b.ignoreDepthValues===!1,resolveStencilBuffer:b.ignoreDepthValues===!1})}U.isXRRenderTarget=!0,this.setFoveation(m),p=null,u=await l.requestReferenceSpace(h),Ne.setContext(l),Ne.start(),s.isPresenting=!0,s.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode},this.getDepthTexture=function(){return S.getDepthTexture()};function z(ee){for(let Ee=0;Ee<ee.removed.length;Ee++){const Ae=ee.removed[Ee],Ge=I.indexOf(Ae);Ge>=0&&(I[Ge]=null,G[Ge].disconnect(Ae))}for(let Ee=0;Ee<ee.added.length;Ee++){const Ae=ee.added[Ee];let Ge=I.indexOf(Ae);if(Ge===-1){for(let Ke=0;Ke<G.length;Ke++)if(Ke>=I.length){I.push(Ae),Ge=Ke;break}else if(I[Ke]===null){I[Ke]=Ae,Ge=Ke;break}if(Ge===-1)break}const Ze=G[Ge];Ze&&Ze.connect(Ae)}}const W=new ae,ce=new ae;function ge(ee,Ee,Ae){W.setFromMatrixPosition(Ee.matrixWorld),ce.setFromMatrixPosition(Ae.matrixWorld);const Ge=W.distanceTo(ce),Ze=Ee.projectionMatrix.elements,Ke=Ae.projectionMatrix.elements,wt=Ze[14]/(Ze[10]-1),ft=Ze[14]/(Ze[10]+1),Ve=(Ze[9]+1)/Ze[5],Ft=(Ze[9]-1)/Ze[5],xt=(Ze[8]-1)/Ze[0],mn=(Ke[8]+1)/Ke[0],Kt=wt*xt,Yt=wt*mn,q=Ge/(-xt+mn),vt=q*-xt;if(Ee.matrixWorld.decompose(ee.position,ee.quaternion,ee.scale),ee.translateX(vt),ee.translateZ(q),ee.matrixWorld.compose(ee.position,ee.quaternion,ee.scale),ee.matrixWorldInverse.copy(ee.matrixWorld).invert(),Ze[10]===-1)ee.projectionMatrix.copy(Ee.projectionMatrix),ee.projectionMatrixInverse.copy(Ee.projectionMatrixInverse);else{const yt=wt+q,Et=ft+q,Ie=Kt-vt,ot=Yt+(Ge-vt),O=Ve*ft/Et*yt,T=Ft*ft/Et*yt;ee.projectionMatrix.makePerspective(Ie,ot,O,T,yt,Et),ee.projectionMatrixInverse.copy(ee.projectionMatrix).invert()}}function P(ee,Ee){Ee===null?ee.matrixWorld.copy(ee.matrix):ee.matrixWorld.multiplyMatrices(Ee.matrixWorld,ee.matrix),ee.matrixWorldInverse.copy(ee.matrixWorld).invert()}this.updateCamera=function(ee){if(l===null)return;let Ee=ee.near,Ae=ee.far;S.texture!==null&&(S.depthNear>0&&(Ee=S.depthNear),S.depthFar>0&&(Ae=S.depthFar)),X.near=$.near=F.near=Ee,X.far=$.far=F.far=Ae,(te!==X.near||oe!==X.far)&&(l.updateRenderState({depthNear:X.near,depthFar:X.far}),te=X.near,oe=X.far),X.layers.mask=ee.layers.mask|6,F.layers.mask=X.layers.mask&-5,$.layers.mask=X.layers.mask&-3;const Ge=ee.parent,Ze=X.cameras;P(X,Ge);for(let Ke=0;Ke<Ze.length;Ke++)P(Ze[Ke],Ge);Ze.length===2?ge(X,F,$):X.projectionMatrix.copy(F.projectionMatrix),Z(ee,X,Ge)};function Z(ee,Ee,Ae){Ae===null?ee.matrix.copy(Ee.matrixWorld):(ee.matrix.copy(Ae.matrixWorld),ee.matrix.invert(),ee.matrix.multiply(Ee.matrixWorld)),ee.matrix.decompose(ee.position,ee.quaternion,ee.scale),ee.updateMatrixWorld(!0),ee.projectionMatrix.copy(Ee.projectionMatrix),ee.projectionMatrixInverse.copy(Ee.projectionMatrixInverse),ee.isPerspectiveCamera&&(ee.fov=nm*2*Math.atan(1/ee.projectionMatrix.elements[5]),ee.zoom=1)}this.getCamera=function(){return X},this.getFoveation=function(){if(!(g===null&&b===null))return m},this.setFoveation=function(ee){m=ee,g!==null&&(g.fixedFoveation=ee),b!==null&&b.fixedFoveation!==void 0&&(b.fixedFoveation=ee)},this.hasDepthSensing=function(){return S.texture!==null},this.getDepthSensingMesh=function(){return S.getMesh(X)},this.getCameraTexture=function(ee){return y[ee]};let _e=null;function Te(ee,Ee){if(x=Ee.getViewerPose(p||u),M=Ee,x!==null){const Ae=x.views;b!==null&&(e.setRenderTargetFramebuffer(U,b.framebuffer),e.setRenderTarget(U));let Ge=!1;Ae.length!==X.cameras.length&&(X.cameras.length=0,Ge=!0);for(let ft=0;ft<Ae.length;ft++){const Ve=Ae[ft];let Ft=null;if(b!==null)Ft=b.getViewport(Ve);else{const mn=v.getViewSubImage(g,Ve);Ft=mn.viewport,ft===0&&(e.setRenderTargetTextures(U,mn.colorTexture,mn.depthStencilTexture),e.setRenderTarget(U))}let xt=k[ft];xt===void 0&&(xt=new pa,xt.layers.enable(ft),xt.viewport=new Ln,k[ft]=xt),xt.matrix.fromArray(Ve.transform.matrix),xt.matrix.decompose(xt.position,xt.quaternion,xt.scale),xt.projectionMatrix.fromArray(Ve.projectionMatrix),xt.projectionMatrixInverse.copy(xt.projectionMatrix).invert(),xt.viewport.set(Ft.x,Ft.y,Ft.width,Ft.height),ft===0&&(X.matrix.copy(xt.matrix),X.matrix.decompose(X.position,X.quaternion,X.scale)),Ge===!0&&X.cameras.push(xt)}const Ze=l.enabledFeatures;if(Ze&&Ze.includes("depth-sensing")&&l.depthUsage=="gpu-optimized"&&A){v=s.getBinding();const ft=v.getDepthInformation(Ae[0]);ft&&ft.isValid&&ft.texture&&S.init(ft,l.renderState)}if(Ze&&Ze.includes("camera-access")&&A){e.state.unbindTexture(),v=s.getBinding();for(let ft=0;ft<Ae.length;ft++){const Ve=Ae[ft].camera;if(Ve){let Ft=y[Ve];Ft||(Ft=new Sb,y[Ve]=Ft);const xt=v.getCameraImage(Ve);Ft.sourceTexture=xt}}}}for(let Ae=0;Ae<G.length;Ae++){const Ge=I[Ae],Ze=G[Ae];Ge!==null&&Ze!==void 0&&Ze.update(Ge,Ee,p||u)}_e&&_e(ee,Ee),Ee.detectedPlanes&&s.dispatchEvent({type:"planesdetected",data:Ee}),M=null}const Ne=new Ab;Ne.setAnimationLoop(Te),this.setAnimationLoop=function(ee){_e=ee},this.dispose=function(){}}}const DC=new Wn,Lb=new Mt;Lb.set(-1,0,0,0,1,0,0,0,1);function LC(r,e){function i(S,y){S.matrixAutoUpdate===!0&&S.updateMatrix(),y.value.copy(S.matrix)}function s(S,y){y.color.getRGB(S.fogColor.value,Eb(r)),y.isFog?(S.fogNear.value=y.near,S.fogFar.value=y.far):y.isFogExp2&&(S.fogDensity.value=y.density)}function l(S,y,R,D,U){y.isNodeMaterial?y.uniformsNeedUpdate=!1:y.isMeshBasicMaterial?c(S,y):y.isMeshLambertMaterial?(c(S,y),y.envMap&&(S.envMapIntensity.value=y.envMapIntensity)):y.isMeshToonMaterial?(c(S,y),v(S,y)):y.isMeshPhongMaterial?(c(S,y),x(S,y),y.envMap&&(S.envMapIntensity.value=y.envMapIntensity)):y.isMeshStandardMaterial?(c(S,y),g(S,y),y.isMeshPhysicalMaterial&&b(S,y,U)):y.isMeshMatcapMaterial?(c(S,y),M(S,y)):y.isMeshDepthMaterial?c(S,y):y.isMeshDistanceMaterial?(c(S,y),A(S,y)):y.isMeshNormalMaterial?c(S,y):y.isLineBasicMaterial?(u(S,y),y.isLineDashedMaterial&&h(S,y)):y.isPointsMaterial?m(S,y,R,D):y.isSpriteMaterial?p(S,y):y.isShadowMaterial?(S.color.value.copy(y.color),S.opacity.value=y.opacity):y.isShaderMaterial&&(y.uniformsNeedUpdate=!1)}function c(S,y){S.opacity.value=y.opacity,y.color&&S.diffuse.value.copy(y.color),y.emissive&&S.emissive.value.copy(y.emissive).multiplyScalar(y.emissiveIntensity),y.map&&(S.map.value=y.map,i(y.map,S.mapTransform)),y.alphaMap&&(S.alphaMap.value=y.alphaMap,i(y.alphaMap,S.alphaMapTransform)),y.bumpMap&&(S.bumpMap.value=y.bumpMap,i(y.bumpMap,S.bumpMapTransform),S.bumpScale.value=y.bumpScale,y.side===Pi&&(S.bumpScale.value*=-1)),y.normalMap&&(S.normalMap.value=y.normalMap,i(y.normalMap,S.normalMapTransform),S.normalScale.value.copy(y.normalScale),y.side===Pi&&S.normalScale.value.negate()),y.displacementMap&&(S.displacementMap.value=y.displacementMap,i(y.displacementMap,S.displacementMapTransform),S.displacementScale.value=y.displacementScale,S.displacementBias.value=y.displacementBias),y.emissiveMap&&(S.emissiveMap.value=y.emissiveMap,i(y.emissiveMap,S.emissiveMapTransform)),y.specularMap&&(S.specularMap.value=y.specularMap,i(y.specularMap,S.specularMapTransform)),y.alphaTest>0&&(S.alphaTest.value=y.alphaTest);const R=e.get(y),D=R.envMap,U=R.envMapRotation;D&&(S.envMap.value=D,S.envMapRotation.value.setFromMatrix4(DC.makeRotationFromEuler(U)).transpose(),D.isCubeTexture&&D.isRenderTargetTexture===!1&&S.envMapRotation.value.premultiply(Lb),S.reflectivity.value=y.reflectivity,S.ior.value=y.ior,S.refractionRatio.value=y.refractionRatio),y.lightMap&&(S.lightMap.value=y.lightMap,S.lightMapIntensity.value=y.lightMapIntensity,i(y.lightMap,S.lightMapTransform)),y.aoMap&&(S.aoMap.value=y.aoMap,S.aoMapIntensity.value=y.aoMapIntensity,i(y.aoMap,S.aoMapTransform))}function u(S,y){S.diffuse.value.copy(y.color),S.opacity.value=y.opacity,y.map&&(S.map.value=y.map,i(y.map,S.mapTransform))}function h(S,y){S.dashSize.value=y.dashSize,S.totalSize.value=y.dashSize+y.gapSize,S.scale.value=y.scale}function m(S,y,R,D){S.diffuse.value.copy(y.color),S.opacity.value=y.opacity,S.size.value=y.size*R,S.scale.value=D*.5,y.map&&(S.map.value=y.map,i(y.map,S.uvTransform)),y.alphaMap&&(S.alphaMap.value=y.alphaMap,i(y.alphaMap,S.alphaMapTransform)),y.alphaTest>0&&(S.alphaTest.value=y.alphaTest)}function p(S,y){S.diffuse.value.copy(y.color),S.opacity.value=y.opacity,S.rotation.value=y.rotation,y.map&&(S.map.value=y.map,i(y.map,S.mapTransform)),y.alphaMap&&(S.alphaMap.value=y.alphaMap,i(y.alphaMap,S.alphaMapTransform)),y.alphaTest>0&&(S.alphaTest.value=y.alphaTest)}function x(S,y){S.specular.value.copy(y.specular),S.shininess.value=Math.max(y.shininess,1e-4)}function v(S,y){y.gradientMap&&(S.gradientMap.value=y.gradientMap)}function g(S,y){S.metalness.value=y.metalness,y.metalnessMap&&(S.metalnessMap.value=y.metalnessMap,i(y.metalnessMap,S.metalnessMapTransform)),S.roughness.value=y.roughness,y.roughnessMap&&(S.roughnessMap.value=y.roughnessMap,i(y.roughnessMap,S.roughnessMapTransform)),y.envMap&&(S.envMapIntensity.value=y.envMapIntensity)}function b(S,y,R){S.ior.value=y.ior,y.sheen>0&&(S.sheenColor.value.copy(y.sheenColor).multiplyScalar(y.sheen),S.sheenRoughness.value=y.sheenRoughness,y.sheenColorMap&&(S.sheenColorMap.value=y.sheenColorMap,i(y.sheenColorMap,S.sheenColorMapTransform)),y.sheenRoughnessMap&&(S.sheenRoughnessMap.value=y.sheenRoughnessMap,i(y.sheenRoughnessMap,S.sheenRoughnessMapTransform))),y.clearcoat>0&&(S.clearcoat.value=y.clearcoat,S.clearcoatRoughness.value=y.clearcoatRoughness,y.clearcoatMap&&(S.clearcoatMap.value=y.clearcoatMap,i(y.clearcoatMap,S.clearcoatMapTransform)),y.clearcoatRoughnessMap&&(S.clearcoatRoughnessMap.value=y.clearcoatRoughnessMap,i(y.clearcoatRoughnessMap,S.clearcoatRoughnessMapTransform)),y.clearcoatNormalMap&&(S.clearcoatNormalMap.value=y.clearcoatNormalMap,i(y.clearcoatNormalMap,S.clearcoatNormalMapTransform),S.clearcoatNormalScale.value.copy(y.clearcoatNormalScale),y.side===Pi&&S.clearcoatNormalScale.value.negate())),y.dispersion>0&&(S.dispersion.value=y.dispersion),y.iridescence>0&&(S.iridescence.value=y.iridescence,S.iridescenceIOR.value=y.iridescenceIOR,S.iridescenceThicknessMinimum.value=y.iridescenceThicknessRange[0],S.iridescenceThicknessMaximum.value=y.iridescenceThicknessRange[1],y.iridescenceMap&&(S.iridescenceMap.value=y.iridescenceMap,i(y.iridescenceMap,S.iridescenceMapTransform)),y.iridescenceThicknessMap&&(S.iridescenceThicknessMap.value=y.iridescenceThicknessMap,i(y.iridescenceThicknessMap,S.iridescenceThicknessMapTransform))),y.transmission>0&&(S.transmission.value=y.transmission,S.transmissionSamplerMap.value=R.texture,S.transmissionSamplerSize.value.set(R.width,R.height),y.transmissionMap&&(S.transmissionMap.value=y.transmissionMap,i(y.transmissionMap,S.transmissionMapTransform)),S.thickness.value=y.thickness,y.thicknessMap&&(S.thicknessMap.value=y.thicknessMap,i(y.thicknessMap,S.thicknessMapTransform)),S.attenuationDistance.value=y.attenuationDistance,S.attenuationColor.value.copy(y.attenuationColor)),y.anisotropy>0&&(S.anisotropyVector.value.set(y.anisotropy*Math.cos(y.anisotropyRotation),y.anisotropy*Math.sin(y.anisotropyRotation)),y.anisotropyMap&&(S.anisotropyMap.value=y.anisotropyMap,i(y.anisotropyMap,S.anisotropyMapTransform))),S.specularIntensity.value=y.specularIntensity,S.specularColor.value.copy(y.specularColor),y.specularColorMap&&(S.specularColorMap.value=y.specularColorMap,i(y.specularColorMap,S.specularColorMapTransform)),y.specularIntensityMap&&(S.specularIntensityMap.value=y.specularIntensityMap,i(y.specularIntensityMap,S.specularIntensityMapTransform))}function M(S,y){y.matcap&&(S.matcap.value=y.matcap)}function A(S,y){const R=e.get(y).light;S.referencePosition.value.setFromMatrixPosition(R.matrixWorld),S.nearDistance.value=R.shadow.camera.near,S.farDistance.value=R.shadow.camera.far}return{refreshFogUniforms:s,refreshMaterialUniforms:l}}function IC(r,e,i,s){let l={},c={},u=[];const h=r.getParameter(r.MAX_UNIFORM_BUFFER_BINDINGS);function m(R,D){const U=D.program;s.uniformBlockBinding(R,U)}function p(R,D){let U=l[R.id];U===void 0&&(M(R),U=x(R),l[R.id]=U,R.addEventListener("dispose",S));const G=D.program;s.updateUBOMapping(R,G);const I=e.render.frame;c[R.id]!==I&&(g(R),c[R.id]=I)}function x(R){const D=v();R.__bindingPointIndex=D;const U=r.createBuffer(),G=R.__size,I=R.usage;return r.bindBuffer(r.UNIFORM_BUFFER,U),r.bufferData(r.UNIFORM_BUFFER,G,I),r.bindBuffer(r.UNIFORM_BUFFER,null),r.bindBufferBase(r.UNIFORM_BUFFER,D,U),U}function v(){for(let R=0;R<h;R++)if(u.indexOf(R)===-1)return u.push(R),R;return Jt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function g(R){const D=l[R.id],U=R.uniforms,G=R.__cache;r.bindBuffer(r.UNIFORM_BUFFER,D);for(let I=0,B=U.length;I<B;I++){const w=Array.isArray(U[I])?U[I]:[U[I]];for(let F=0,$=w.length;F<$;F++){const k=w[F];if(b(k,I,F,G)===!0){const X=k.__offset,te=Array.isArray(k.value)?k.value:[k.value];let oe=0;for(let V=0;V<te.length;V++){const L=te[V],z=A(L);typeof L=="number"||typeof L=="boolean"?(k.__data[0]=L,r.bufferSubData(r.UNIFORM_BUFFER,X+oe,k.__data)):L.isMatrix3?(k.__data[0]=L.elements[0],k.__data[1]=L.elements[1],k.__data[2]=L.elements[2],k.__data[3]=0,k.__data[4]=L.elements[3],k.__data[5]=L.elements[4],k.__data[6]=L.elements[5],k.__data[7]=0,k.__data[8]=L.elements[6],k.__data[9]=L.elements[7],k.__data[10]=L.elements[8],k.__data[11]=0):ArrayBuffer.isView(L)?k.__data.set(new L.constructor(L.buffer,L.byteOffset,k.__data.length)):(L.toArray(k.__data,oe),oe+=z.storage/Float32Array.BYTES_PER_ELEMENT)}r.bufferSubData(r.UNIFORM_BUFFER,X,k.__data)}}}r.bindBuffer(r.UNIFORM_BUFFER,null)}function b(R,D,U,G){const I=R.value,B=D+"_"+U;if(G[B]===void 0)return typeof I=="number"||typeof I=="boolean"?G[B]=I:ArrayBuffer.isView(I)?G[B]=I.slice():G[B]=I.clone(),!0;{const w=G[B];if(typeof I=="number"||typeof I=="boolean"){if(w!==I)return G[B]=I,!0}else{if(ArrayBuffer.isView(I))return!0;if(w.equals(I)===!1)return w.copy(I),!0}}return!1}function M(R){const D=R.uniforms;let U=0;const G=16;for(let B=0,w=D.length;B<w;B++){const F=Array.isArray(D[B])?D[B]:[D[B]];for(let $=0,k=F.length;$<k;$++){const X=F[$],te=Array.isArray(X.value)?X.value:[X.value];for(let oe=0,V=te.length;oe<V;oe++){const L=te[oe],z=A(L),W=U%G,ce=W%z.boundary,ge=W+ce;U+=ce,ge!==0&&G-ge<z.storage&&(U+=G-ge),X.__data=new Float32Array(z.storage/Float32Array.BYTES_PER_ELEMENT),X.__offset=U,U+=z.storage}}}const I=U%G;return I>0&&(U+=G-I),R.__size=U,R.__cache={},this}function A(R){const D={boundary:0,storage:0};return typeof R=="number"||typeof R=="boolean"?(D.boundary=4,D.storage=4):R.isVector2?(D.boundary=8,D.storage=8):R.isVector3||R.isColor?(D.boundary=16,D.storage=12):R.isVector4?(D.boundary=16,D.storage=16):R.isMatrix3?(D.boundary=48,D.storage=48):R.isMatrix4?(D.boundary=64,D.storage=64):R.isTexture?gt("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(R)?(D.boundary=16,D.storage=R.byteLength):gt("WebGLRenderer: Unsupported uniform value type.",R),D}function S(R){const D=R.target;D.removeEventListener("dispose",S);const U=u.indexOf(D.__bindingPointIndex);u.splice(U,1),r.deleteBuffer(l[D.id]),delete l[D.id],delete c[D.id]}function y(){for(const R in l)r.deleteBuffer(l[R]);u=[],l={},c={}}return{bind:m,update:p,dispose:y}}const UC=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Ia=null;function PC(){return Ia===null&&(Ia=new ET(UC,16,16,zr,xs),Ia.name="DFG_LUT",Ia.minFilter=mi,Ia.magFilter=mi,Ia.wrapS=ps,Ia.wrapT=ps,Ia.generateMipmaps=!1,Ia.needsUpdate=!0),Ia}class FC{constructor(e={}){const{canvas:i=JM(),context:s=null,depth:l=!0,stencil:c=!1,alpha:u=!1,antialias:h=!1,premultipliedAlpha:m=!0,preserveDrawingBuffer:p=!1,powerPreference:x="default",failIfMajorPerformanceCaveat:v=!1,reversedDepthBuffer:g=!1,outputBufferType:b=ma}=e;this.isWebGLRenderer=!0;let M;if(s!==null){if(typeof WebGLRenderingContext<"u"&&s instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");M=s.getContextAttributes().alpha}else M=u;const A=b,S=new Set([gm,mm,pm]),y=new Set([ma,Ha,tc,nc,dm,hm]),R=new Uint32Array(4),D=new Int32Array(4),U=new ae;let G=null,I=null;const B=[],w=[];let F=null;this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Ba,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const $=this;let k=!1,X=null;this._outputColorSpace=Zi;let te=0,oe=0,V=null,L=-1,z=null;const W=new Ln,ce=new Ln;let ge=null;const P=new pn(0);let Z=0,_e=i.width,Te=i.height,Ne=1,ee=null,Ee=null;const Ae=new Ln(0,0,_e,Te),Ge=new Ln(0,0,_e,Te);let Ze=!1;const Ke=new bb;let wt=!1,ft=!1;const Ve=new Wn,Ft=new ae,xt=new Ln,mn={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Kt=!1;function Yt(){return V===null?Ne:1}let q=s;function vt(C,K){return i.getContext(C,K)}try{const C={alpha:!0,depth:l,stencil:c,antialias:h,premultipliedAlpha:m,preserveDrawingBuffer:p,powerPreference:x,failIfMajorPerformanceCaveat:v};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${um}`),i.addEventListener("webglcontextlost",we,!1),i.addEventListener("webglcontextrestored",We,!1),i.addEventListener("webglcontextcreationerror",at,!1),q===null){const K="webgl2";if(q=vt(K,C),q===null)throw vt(K)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(C){throw Jt("WebGLRenderer: "+C.message),C}let yt,Et,Ie,ot,O,T,Q,me,Me,be,Pe,fe,pe,Oe,Be,Ce,De,it,dt,lt,j,Le,he;function Ue(){yt=new Pw(q),yt.init(),j=new wC(q,yt),Et=new Rw(q,yt,e,j),Ie=new TC(q,yt),Et.reversedDepthBuffer&&g&&Ie.buffers.depth.setReversed(!0),ot=new zw(q),O=new fC,T=new AC(q,yt,Ie,O,Et,j,ot),Q=new Uw($),me=new VT(q),Le=new Aw(q,me),Me=new Fw(q,me,ot,Le),be=new Hw(q,Me,me,Le,ot),it=new Gw(q,Et,T),Be=new Cw(O),Pe=new uC($,Q,yt,Et,Le,Be),fe=new LC($,O),pe=new hC,Oe=new vC(yt),De=new Tw($,Q,Ie,be,M,m),Ce=new MC($,be,Et),he=new IC(q,ot,Et,Ie),dt=new ww(q,yt,ot),lt=new Bw(q,yt,ot),ot.programs=Pe.programs,$.capabilities=Et,$.extensions=yt,$.properties=O,$.renderLists=pe,$.shadowMap=Ce,$.state=Ie,$.info=ot}Ue(),A!==ma&&(F=new Vw(A,i.width,i.height,l,c));const Fe=new OC($,q);this.xr=Fe,this.getContext=function(){return q},this.getContextAttributes=function(){return q.getContextAttributes()},this.forceContextLoss=function(){const C=yt.get("WEBGL_lose_context");C&&C.loseContext()},this.forceContextRestore=function(){const C=yt.get("WEBGL_lose_context");C&&C.restoreContext()},this.getPixelRatio=function(){return Ne},this.setPixelRatio=function(C){C!==void 0&&(Ne=C,this.setSize(_e,Te,!1))},this.getSize=function(C){return C.set(_e,Te)},this.setSize=function(C,K,le=!0){if(Fe.isPresenting){gt("WebGLRenderer: Can't change size while VR device is presenting.");return}_e=C,Te=K,i.width=Math.floor(C*Ne),i.height=Math.floor(K*Ne),le===!0&&(i.style.width=C+"px",i.style.height=K+"px"),F!==null&&F.setSize(i.width,i.height),this.setViewport(0,0,C,K)},this.getDrawingBufferSize=function(C){return C.set(_e*Ne,Te*Ne).floor()},this.setDrawingBufferSize=function(C,K,le){_e=C,Te=K,Ne=le,i.width=Math.floor(C*le),i.height=Math.floor(K*le),this.setViewport(0,0,C,K)},this.setEffects=function(C){if(A===ma){Jt("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(C){for(let K=0;K<C.length;K++)if(C[K].isOutputPass===!0){gt("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}F.setEffects(C||[])},this.getCurrentViewport=function(C){return C.copy(W)},this.getViewport=function(C){return C.copy(Ae)},this.setViewport=function(C,K,le,ne){C.isVector4?Ae.set(C.x,C.y,C.z,C.w):Ae.set(C,K,le,ne),Ie.viewport(W.copy(Ae).multiplyScalar(Ne).round())},this.getScissor=function(C){return C.copy(Ge)},this.setScissor=function(C,K,le,ne){C.isVector4?Ge.set(C.x,C.y,C.z,C.w):Ge.set(C,K,le,ne),Ie.scissor(ce.copy(Ge).multiplyScalar(Ne).round())},this.getScissorTest=function(){return Ze},this.setScissorTest=function(C){Ie.setScissorTest(Ze=C)},this.setOpaqueSort=function(C){ee=C},this.setTransparentSort=function(C){Ee=C},this.getClearColor=function(C){return C.copy(De.getClearColor())},this.setClearColor=function(){De.setClearColor(...arguments)},this.getClearAlpha=function(){return De.getClearAlpha()},this.setClearAlpha=function(){De.setClearAlpha(...arguments)},this.clear=function(C=!0,K=!0,le=!0){let ne=0;if(C){let ie=!1;if(V!==null){const He=V.texture.format;ie=S.has(He)}if(ie){const He=V.texture.type,Xe=y.has(He),ze=De.getClearColor(),qe=De.getClearAlpha(),Ye=ze.r,Qe=ze.g,mt=ze.b;Xe?(R[0]=Ye,R[1]=Qe,R[2]=mt,R[3]=qe,q.clearBufferuiv(q.COLOR,0,R)):(D[0]=Ye,D[1]=Qe,D[2]=mt,D[3]=qe,q.clearBufferiv(q.COLOR,0,D))}else ne|=q.COLOR_BUFFER_BIT}K&&(ne|=q.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),le&&(ne|=q.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),ne!==0&&q.clear(ne)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(C){C.setRenderer(this),X=C},this.dispose=function(){i.removeEventListener("webglcontextlost",we,!1),i.removeEventListener("webglcontextrestored",We,!1),i.removeEventListener("webglcontextcreationerror",at,!1),De.dispose(),pe.dispose(),Oe.dispose(),O.dispose(),Q.dispose(),be.dispose(),Le.dispose(),he.dispose(),Pe.dispose(),Fe.dispose(),Fe.removeEventListener("sessionstart",ta),Fe.removeEventListener("sessionend",zi),Un.stop()};function we(C){C.preventDefault(),k_("WebGLRenderer: Context Lost."),k=!0}function We(){k_("WebGLRenderer: Context Restored."),k=!1;const C=ot.autoReset,K=Ce.enabled,le=Ce.autoUpdate,ne=Ce.needsUpdate,ie=Ce.type;Ue(),ot.autoReset=C,Ce.enabled=K,Ce.autoUpdate=le,Ce.needsUpdate=ne,Ce.type=ie}function at(C){Jt("WebGLRenderer: A WebGL context could not be created. Reason: ",C.statusMessage)}function rn(C){const K=C.target;K.removeEventListener("dispose",rn),Lt(K)}function Lt(C){Kn(C),O.remove(C)}function Kn(C){const K=O.get(C).programs;K!==void 0&&(K.forEach(function(le){Pe.releaseProgram(le)}),C.isShaderMaterial&&Pe.releaseShaderCache(C))}this.renderBufferDirect=function(C,K,le,ne,ie,He){K===null&&(K=mn);const Xe=ie.isMesh&&ie.matrixWorld.determinant()<0,ze=xi(C,K,le,ne,ie);Ie.setMaterial(ne,Xe);let qe=le.index,Ye=1;if(ne.wireframe===!0){if(qe=Me.getWireframeAttribute(le),qe===void 0)return;Ye=2}const Qe=le.drawRange,mt=le.attributes.position;let Je=Qe.start*Ye,It=(Qe.start+Qe.count)*Ye;He!==null&&(Je=Math.max(Je,He.start*Ye),It=Math.min(It,(He.start+He.count)*Ye)),qe!==null?(Je=Math.max(Je,0),It=Math.min(It,qe.count)):mt!=null&&(Je=Math.max(Je,0),It=Math.min(It,mt.count));const Wt=It-Je;if(Wt<0||Wt===1/0)return;Le.setup(ie,ne,ze,le,qe);let Bt,zt=dt;if(qe!==null&&(Bt=me.get(qe),zt=lt,zt.setIndex(Bt)),ie.isMesh)ne.wireframe===!0?(Ie.setLineWidth(ne.wireframeLinewidth*Yt()),zt.setMode(q.LINES)):zt.setMode(q.TRIANGLES);else if(ie.isLine){let Nt=ne.linewidth;Nt===void 0&&(Nt=1),Ie.setLineWidth(Nt*Yt()),ie.isLineSegments?zt.setMode(q.LINES):ie.isLineLoop?zt.setMode(q.LINE_LOOP):zt.setMode(q.LINE_STRIP)}else ie.isPoints?zt.setMode(q.POINTS):ie.isSprite&&zt.setMode(q.TRIANGLES);if(ie.isBatchedMesh)if(yt.get("WEBGL_multi_draw"))zt.renderMultiDraw(ie._multiDrawStarts,ie._multiDrawCounts,ie._multiDrawCount);else{const Nt=ie._multiDrawStarts,je=ie._multiDrawCounts,ei=ie._multiDrawCount,Ut=qe?me.get(qe).bytesPerElement:1,Pn=O.get(ne).currentProgram.getUniforms();for(let jn=0;jn<ei;jn++)Pn.setValue(q,"_gl_DrawID",jn),zt.render(Nt[jn]/Ut,je[jn])}else if(ie.isInstancedMesh)zt.renderInstances(Je,Wt,ie.count);else if(le.isInstancedBufferGeometry){const Nt=le._maxInstanceCount!==void 0?le._maxInstanceCount:1/0,je=Math.min(le.instanceCount,Nt);zt.renderInstances(Je,Wt,je)}else zt.render(Je,Wt)};function In(C,K,le){C.transparent===!0&&C.side===hs&&C.forceSinglePass===!1?(C.side=Pi,C.needsUpdate=!0,wa(C,K,le),C.side=tr,C.needsUpdate=!0,wa(C,K,le),C.side=hs):wa(C,K,le)}this.compile=function(C,K,le=null){le===null&&(le=C),I=Oe.get(le),I.init(K),w.push(I),le.traverseVisible(function(ie){ie.isLight&&ie.layers.test(K.layers)&&(I.pushLight(ie),ie.castShadow&&I.pushShadow(ie))}),C!==le&&C.traverseVisible(function(ie){ie.isLight&&ie.layers.test(K.layers)&&(I.pushLight(ie),ie.castShadow&&I.pushShadow(ie))}),I.setupLights();const ne=new Set;return C.traverse(function(ie){if(!(ie.isMesh||ie.isPoints||ie.isLine||ie.isSprite))return;const He=ie.material;if(He)if(Array.isArray(He))for(let Xe=0;Xe<He.length;Xe++){const ze=He[Xe];In(ze,le,ie),ne.add(ze)}else In(He,le,ie),ne.add(He)}),I=w.pop(),ne},this.compileAsync=function(C,K,le=null){const ne=this.compile(C,K,le);return new Promise(ie=>{function He(){if(ne.forEach(function(Xe){O.get(Xe).currentProgram.isReady()&&ne.delete(Xe)}),ne.size===0){ie(C);return}setTimeout(He,10)}yt.get("KHR_parallel_shader_compile")!==null?He():setTimeout(He,10)})};let Bi=null;function ea(C){Bi&&Bi(C)}function ta(){Un.stop()}function zi(){Un.start()}const Un=new Ab;Un.setAnimationLoop(ea),typeof self<"u"&&Un.setContext(self),this.setAnimationLoop=function(C){Bi=C,Fe.setAnimationLoop(C),C===null?Un.stop():Un.start()},Fe.addEventListener("sessionstart",ta),Fe.addEventListener("sessionend",zi),this.render=function(C,K){if(K!==void 0&&K.isCamera!==!0){Jt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(k===!0)return;X!==null&&X.renderStart(C,K);const le=Fe.enabled===!0&&Fe.isPresenting===!0,ne=F!==null&&(V===null||le)&&F.begin($,V);if(C.matrixWorldAutoUpdate===!0&&C.updateMatrixWorld(),K.parent===null&&K.matrixWorldAutoUpdate===!0&&K.updateMatrixWorld(),Fe.enabled===!0&&Fe.isPresenting===!0&&(F===null||F.isCompositing()===!1)&&(Fe.cameraAutoUpdate===!0&&Fe.updateCamera(K),K=Fe.getCamera()),C.isScene===!0&&C.onBeforeRender($,C,K,V),I=Oe.get(C,w.length),I.init(K),I.state.textureUnits=T.getTextureUnits(),w.push(I),Ve.multiplyMatrices(K.projectionMatrix,K.matrixWorldInverse),Ke.setFromProjectionMatrix(Ve,Fa,K.reversedDepth),ft=this.localClippingEnabled,wt=Be.init(this.clippingPlanes,ft),G=pe.get(C,B.length),G.init(),B.push(G),Fe.enabled===!0&&Fe.isPresenting===!0){const Xe=$.xr.getDepthSensingMesh();Xe!==null&&gn(Xe,K,-1/0,$.sortObjects)}gn(C,K,0,$.sortObjects),G.finish(),$.sortObjects===!0&&G.sort(ee,Ee),Kt=Fe.enabled===!1||Fe.isPresenting===!1||Fe.hasDepthSensing()===!1,Kt&&De.addToRenderList(G,C),this.info.render.frame++,wt===!0&&Be.beginShadows();const ie=I.state.shadowsArray;if(Ce.render(ie,C,K),wt===!0&&Be.endShadows(),this.info.autoReset===!0&&this.info.reset(),(ne&&F.hasRenderPass())===!1){const Xe=G.opaque,ze=G.transmissive;if(I.setupLights(),K.isArrayCamera){const qe=K.cameras;if(ze.length>0)for(let Ye=0,Qe=qe.length;Ye<Qe;Ye++){const mt=qe[Ye];li(Xe,ze,C,mt)}Kt&&De.render(C);for(let Ye=0,Qe=qe.length;Ye<Qe;Ye++){const mt=qe[Ye];En(G,C,mt,mt.viewport)}}else ze.length>0&&li(Xe,ze,C,K),Kt&&De.render(C),En(G,C,K)}V!==null&&oe===0&&(T.updateMultisampleRenderTarget(V),T.updateRenderTargetMipmap(V)),ne&&F.end($),C.isScene===!0&&C.onAfterRender($,C,K),Le.resetDefaultState(),L=-1,z=null,w.pop(),w.length>0?(I=w[w.length-1],T.setTextureUnits(I.state.textureUnits),wt===!0&&Be.setGlobalState($.clippingPlanes,I.state.camera)):I=null,B.pop(),B.length>0?G=B[B.length-1]:G=null,X!==null&&X.renderEnd()};function gn(C,K,le,ne){if(C.visible===!1)return;if(C.layers.test(K.layers)){if(C.isGroup)le=C.renderOrder;else if(C.isLOD)C.autoUpdate===!0&&C.update(K);else if(C.isLightProbeGrid)I.pushLightProbeGrid(C);else if(C.isLight)I.pushLight(C),C.castShadow&&I.pushShadow(C);else if(C.isSprite){if(!C.frustumCulled||Ke.intersectsSprite(C)){ne&&xt.setFromMatrixPosition(C.matrixWorld).applyMatrix4(Ve);const Xe=be.update(C),ze=C.material;ze.visible&&G.push(C,Xe,ze,le,xt.z,null)}}else if((C.isMesh||C.isLine||C.isPoints)&&(!C.frustumCulled||Ke.intersectsObject(C))){const Xe=be.update(C),ze=C.material;if(ne&&(C.boundingSphere!==void 0?(C.boundingSphere===null&&C.computeBoundingSphere(),xt.copy(C.boundingSphere.center)):(Xe.boundingSphere===null&&Xe.computeBoundingSphere(),xt.copy(Xe.boundingSphere.center)),xt.applyMatrix4(C.matrixWorld).applyMatrix4(Ve)),Array.isArray(ze)){const qe=Xe.groups;for(let Ye=0,Qe=qe.length;Ye<Qe;Ye++){const mt=qe[Ye],Je=ze[mt.materialIndex];Je&&Je.visible&&G.push(C,Xe,Je,le,xt.z,mt)}}else ze.visible&&G.push(C,Xe,ze,le,xt.z,null)}}const He=C.children;for(let Xe=0,ze=He.length;Xe<ze;Xe++)gn(He[Xe],K,le,ne)}function En(C,K,le,ne){const{opaque:ie,transmissive:He,transparent:Xe}=C;I.setupLightsView(le),wt===!0&&Be.setGlobalState($.clippingPlanes,le),ne&&Ie.viewport(W.copy(ne)),ie.length>0&&na(ie,K,le),He.length>0&&na(He,K,le),Xe.length>0&&na(Xe,K,le),Ie.buffers.depth.setTest(!0),Ie.buffers.depth.setMask(!0),Ie.buffers.color.setMask(!0),Ie.setPolygonOffset(!1)}function li(C,K,le,ne){if((le.isScene===!0?le.overrideMaterial:null)!==null)return;if(I.state.transmissionRenderTarget[ne.id]===void 0){const Je=yt.has("EXT_color_buffer_half_float")||yt.has("EXT_color_buffer_float");I.state.transmissionRenderTarget[ne.id]=new za(1,1,{generateMipmaps:!0,type:Je?xs:ma,minFilter:Ir,samples:Math.max(4,Et.samples),stencilBuffer:c,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:$t.workingColorSpace})}const He=I.state.transmissionRenderTarget[ne.id],Xe=ne.viewport||W;He.setSize(Xe.z*$.transmissionResolutionScale,Xe.w*$.transmissionResolutionScale);const ze=$.getRenderTarget(),qe=$.getActiveCubeFace(),Ye=$.getActiveMipmapLevel();$.setRenderTarget(He),$.getClearColor(P),Z=$.getClearAlpha(),Z<1&&$.setClearColor(16777215,.5),$.clear(),Kt&&De.render(le);const Qe=$.toneMapping;$.toneMapping=Ba;const mt=ne.viewport;if(ne.viewport!==void 0&&(ne.viewport=void 0),I.setupLightsView(ne),wt===!0&&Be.setGlobalState($.clippingPlanes,ne),na(C,le,ne),T.updateMultisampleRenderTarget(He),T.updateRenderTargetMipmap(He),yt.has("WEBGL_multisampled_render_to_texture")===!1){let Je=!1;for(let It=0,Wt=K.length;It<Wt;It++){const Bt=K[It],{object:zt,geometry:Nt,material:je,group:ei}=Bt;if(je.side===hs&&zt.layers.test(ne.layers)){const Ut=je.side;je.side=Pi,je.needsUpdate=!0,Cn(zt,le,ne,Nt,je,ei),je.side=Ut,je.needsUpdate=!0,Je=!0}}Je===!0&&(T.updateMultisampleRenderTarget(He),T.updateRenderTargetMipmap(He))}$.setRenderTarget(ze,qe,Ye),$.setClearColor(P,Z),mt!==void 0&&(ne.viewport=mt),$.toneMapping=Qe}function na(C,K,le){const ne=K.isScene===!0?K.overrideMaterial:null;for(let ie=0,He=C.length;ie<He;ie++){const Xe=C[ie],{object:ze,geometry:qe,group:Ye}=Xe;let Qe=Xe.material;Qe.allowOverride===!0&&ne!==null&&(Qe=ne),ze.layers.test(le.layers)&&Cn(ze,K,le,qe,Qe,Ye)}}function Cn(C,K,le,ne,ie,He){C.onBeforeRender($,K,le,ne,ie,He),C.modelViewMatrix.multiplyMatrices(le.matrixWorldInverse,C.matrixWorld),C.normalMatrix.getNormalMatrix(C.modelViewMatrix),ie.onBeforeRender($,K,le,ne,C,He),ie.transparent===!0&&ie.side===hs&&ie.forceSinglePass===!1?(ie.side=Pi,ie.needsUpdate=!0,$.renderBufferDirect(le,K,ne,ie,C,He),ie.side=tr,ie.needsUpdate=!0,$.renderBufferDirect(le,K,ne,ie,C,He),ie.side=hs):$.renderBufferDirect(le,K,ne,ie,C,He),C.onAfterRender($,K,le,ne,ie,He)}function wa(C,K,le){K.isScene!==!0&&(K=mn);const ne=O.get(C),ie=I.state.lights,He=I.state.shadowsArray,Xe=ie.state.version,ze=Pe.getParameters(C,ie.state,He,K,le,I.state.lightProbeGridArray),qe=Pe.getProgramCacheKey(ze);let Ye=ne.programs;ne.environment=C.isMeshStandardMaterial||C.isMeshLambertMaterial||C.isMeshPhongMaterial?K.environment:null,ne.fog=K.fog;const Qe=C.isMeshStandardMaterial||C.isMeshLambertMaterial&&!C.envMap||C.isMeshPhongMaterial&&!C.envMap;ne.envMap=Q.get(C.envMap||ne.environment,Qe),ne.envMapRotation=ne.environment!==null&&C.envMap===null?K.environmentRotation:C.envMapRotation,Ye===void 0&&(C.addEventListener("dispose",rn),Ye=new Map,ne.programs=Ye);let mt=Ye.get(qe);if(mt!==void 0){if(ne.currentProgram===mt&&ne.lightsStateVersion===Xe)return ci(C,ze),mt}else ze.uniforms=Pe.getUniforms(C),X!==null&&C.isNodeMaterial&&X.build(C,le,ze),C.onBeforeCompile(ze,$),mt=Pe.acquireProgram(ze,qe),Ye.set(qe,mt),ne.uniforms=ze.uniforms;const Je=ne.uniforms;return(!C.isShaderMaterial&&!C.isRawShaderMaterial||C.clipping===!0)&&(Je.clippingPlanes=Be.uniform),ci(C,ze),ne.needsLights=xn(C),ne.lightsStateVersion=Xe,ne.needsLights&&(Je.ambientLightColor.value=ie.state.ambient,Je.lightProbe.value=ie.state.probe,Je.directionalLights.value=ie.state.directional,Je.directionalLightShadows.value=ie.state.directionalShadow,Je.spotLights.value=ie.state.spot,Je.spotLightShadows.value=ie.state.spotShadow,Je.rectAreaLights.value=ie.state.rectArea,Je.ltc_1.value=ie.state.rectAreaLTC1,Je.ltc_2.value=ie.state.rectAreaLTC2,Je.pointLights.value=ie.state.point,Je.pointLightShadows.value=ie.state.pointShadow,Je.hemisphereLights.value=ie.state.hemi,Je.directionalShadowMatrix.value=ie.state.directionalShadowMatrix,Je.spotLightMatrix.value=ie.state.spotLightMatrix,Je.spotLightMap.value=ie.state.spotLightMap,Je.pointShadowMatrix.value=ie.state.pointShadowMatrix),ne.lightProbeGrid=I.state.lightProbeGridArray.length>0,ne.currentProgram=mt,ne.uniformsList=null,mt}function xa(C){if(C.uniformsList===null){const K=C.currentProgram.getUniforms();C.uniformsList=$u.seqWithValue(K.seq,C.uniforms)}return C.uniformsList}function ci(C,K){const le=O.get(C);le.outputColorSpace=K.outputColorSpace,le.batching=K.batching,le.batchingColor=K.batchingColor,le.instancing=K.instancing,le.instancingColor=K.instancingColor,le.instancingMorph=K.instancingMorph,le.skinning=K.skinning,le.morphTargets=K.morphTargets,le.morphNormals=K.morphNormals,le.morphColors=K.morphColors,le.morphTargetsCount=K.morphTargetsCount,le.numClippingPlanes=K.numClippingPlanes,le.numIntersection=K.numClipIntersection,le.vertexAlphas=K.vertexAlphas,le.vertexTangents=K.vertexTangents,le.toneMapping=K.toneMapping}function Mi(C,K){if(C.length===0)return null;if(C.length===1)return C[0].texture!==null?C[0]:null;U.setFromMatrixPosition(K.matrixWorld);for(let le=0,ne=C.length;le<ne;le++){const ie=C[le];if(ie.texture!==null&&ie.boundingBox.containsPoint(U))return ie}return null}function xi(C,K,le,ne,ie){K.isScene!==!0&&(K=mn),T.resetTextureUnits();const He=K.fog,Xe=ne.isMeshStandardMaterial||ne.isMeshLambertMaterial||ne.isMeshPhongMaterial?K.environment:null,ze=V===null?$.outputColorSpace:V.isXRRenderTarget===!0?V.texture.colorSpace:$t.workingColorSpace,qe=ne.isMeshStandardMaterial||ne.isMeshLambertMaterial&&!ne.envMap||ne.isMeshPhongMaterial&&!ne.envMap,Ye=Q.get(ne.envMap||Xe,qe),Qe=ne.vertexColors===!0&&!!le.attributes.color&&le.attributes.color.itemSize===4,mt=!!le.attributes.tangent&&(!!ne.normalMap||ne.anisotropy>0),Je=!!le.morphAttributes.position,It=!!le.morphAttributes.normal,Wt=!!le.morphAttributes.color;let Bt=Ba;ne.toneMapped&&(V===null||V.isXRRenderTarget===!0)&&(Bt=$.toneMapping);const zt=le.morphAttributes.position||le.morphAttributes.normal||le.morphAttributes.color,Nt=zt!==void 0?zt.length:0,je=O.get(ne),ei=I.state.lights;if(wt===!0&&(ft===!0||C!==z)){const en=C===z&&ne.id===L;Be.setState(ne,C,en)}let Ut=!1;ne.version===je.__version?(je.needsLights&&je.lightsStateVersion!==ei.state.version||je.outputColorSpace!==ze||ie.isBatchedMesh&&je.batching===!1||!ie.isBatchedMesh&&je.batching===!0||ie.isBatchedMesh&&je.batchingColor===!0&&ie.colorTexture===null||ie.isBatchedMesh&&je.batchingColor===!1&&ie.colorTexture!==null||ie.isInstancedMesh&&je.instancing===!1||!ie.isInstancedMesh&&je.instancing===!0||ie.isSkinnedMesh&&je.skinning===!1||!ie.isSkinnedMesh&&je.skinning===!0||ie.isInstancedMesh&&je.instancingColor===!0&&ie.instanceColor===null||ie.isInstancedMesh&&je.instancingColor===!1&&ie.instanceColor!==null||ie.isInstancedMesh&&je.instancingMorph===!0&&ie.morphTexture===null||ie.isInstancedMesh&&je.instancingMorph===!1&&ie.morphTexture!==null||je.envMap!==Ye||ne.fog===!0&&je.fog!==He||je.numClippingPlanes!==void 0&&(je.numClippingPlanes!==Be.numPlanes||je.numIntersection!==Be.numIntersection)||je.vertexAlphas!==Qe||je.vertexTangents!==mt||je.morphTargets!==Je||je.morphNormals!==It||je.morphColors!==Wt||je.toneMapping!==Bt||je.morphTargetsCount!==Nt||!!je.lightProbeGrid!=I.state.lightProbeGridArray.length>0)&&(Ut=!0):(Ut=!0,je.__version=ne.version);let Pn=je.currentProgram;Ut===!0&&(Pn=wa(ne,K,ie),X&&ne.isNodeMaterial&&X.onUpdateProgram(ne,Pn,je));let jn=!1,ui=!1,_i=!1;const Zt=Pn.getUniforms(),sn=je.uniforms;if(Ie.useProgram(Pn.program)&&(jn=!0,ui=!0,_i=!0),ne.id!==L&&(L=ne.id,ui=!0),je.needsLights){const en=Mi(I.state.lightProbeGridArray,ie);je.lightProbeGrid!==en&&(je.lightProbeGrid=en,ui=!0)}if(jn||z!==C){Ie.buffers.depth.getReversed()&&C.reversedDepth!==!0&&(C._reversedDepth=!0,C.updateProjectionMatrix()),Zt.setValue(q,"projectionMatrix",C.projectionMatrix),Zt.setValue(q,"viewMatrix",C.matrixWorldInverse);const Zn=Zt.map.cameraPosition;Zn!==void 0&&Zn.setValue(q,Ft.setFromMatrixPosition(C.matrixWorld)),Et.logarithmicDepthBuffer&&Zt.setValue(q,"logDepthBufFC",2/(Math.log(C.far+1)/Math.LN2)),(ne.isMeshPhongMaterial||ne.isMeshToonMaterial||ne.isMeshLambertMaterial||ne.isMeshBasicMaterial||ne.isMeshStandardMaterial||ne.isShaderMaterial)&&Zt.setValue(q,"isOrthographic",C.isOrthographicCamera===!0),z!==C&&(z=C,ui=!0,_i=!0)}if(je.needsLights&&(ei.state.directionalShadowMap.length>0&&Zt.setValue(q,"directionalShadowMap",ei.state.directionalShadowMap,T),ei.state.spotShadowMap.length>0&&Zt.setValue(q,"spotShadowMap",ei.state.spotShadowMap,T),ei.state.pointShadowMap.length>0&&Zt.setValue(q,"pointShadowMap",ei.state.pointShadowMap,T)),ie.isSkinnedMesh){Zt.setOptional(q,ie,"bindMatrix"),Zt.setOptional(q,ie,"bindMatrixInverse");const en=ie.skeleton;en&&(en.boneTexture===null&&en.computeBoneTexture(),Zt.setValue(q,"boneTexture",en.boneTexture,T))}ie.isBatchedMesh&&(Zt.setOptional(q,ie,"batchingTexture"),Zt.setValue(q,"batchingTexture",ie._matricesTexture,T),Zt.setOptional(q,ie,"batchingIdTexture"),Zt.setValue(q,"batchingIdTexture",ie._indirectTexture,T),Zt.setOptional(q,ie,"batchingColorTexture"),ie._colorsTexture!==null&&Zt.setValue(q,"batchingColorTexture",ie._colorsTexture,T));const vi=le.morphAttributes;if((vi.position!==void 0||vi.normal!==void 0||vi.color!==void 0)&&it.update(ie,le,Pn),(ui||je.receiveShadow!==ie.receiveShadow)&&(je.receiveShadow=ie.receiveShadow,Zt.setValue(q,"receiveShadow",ie.receiveShadow)),(ne.isMeshStandardMaterial||ne.isMeshLambertMaterial||ne.isMeshPhongMaterial)&&ne.envMap===null&&K.environment!==null&&(sn.envMapIntensity.value=K.environmentIntensity),sn.dfgLUT!==void 0&&(sn.dfgLUT.value=PC()),ui){if(Zt.setValue(q,"toneMappingExposure",$.toneMappingExposure),je.needsLights&&Ti(sn,_i),He&&ne.fog===!0&&fe.refreshFogUniforms(sn,He),fe.refreshMaterialUniforms(sn,ne,Ne,Te,I.state.transmissionRenderTarget[C.id]),je.needsLights&&je.lightProbeGrid){const en=je.lightProbeGrid;sn.probesSH.value=en.texture,sn.probesMin.value.copy(en.boundingBox.min),sn.probesMax.value.copy(en.boundingBox.max),sn.probesResolution.value.copy(en.resolution)}$u.upload(q,xa(je),sn,T)}if(ne.isShaderMaterial&&ne.uniformsNeedUpdate===!0&&($u.upload(q,xa(je),sn,T),ne.uniformsNeedUpdate=!1),ne.isSpriteMaterial&&Zt.setValue(q,"center",ie.center),Zt.setValue(q,"modelViewMatrix",ie.modelViewMatrix),Zt.setValue(q,"normalMatrix",ie.normalMatrix),Zt.setValue(q,"modelMatrix",ie.matrixWorld),ne.uniformsGroups!==void 0){const en=ne.uniformsGroups;for(let Zn=0,wi=en.length;Zn<wi;Zn++){const Fn=en[Zn];he.update(Fn,Pn),he.bind(Fn,Pn)}}return Pn}function Ti(C,K){C.ambientLightColor.needsUpdate=K,C.lightProbe.needsUpdate=K,C.directionalLights.needsUpdate=K,C.directionalLightShadows.needsUpdate=K,C.pointLights.needsUpdate=K,C.pointLightShadows.needsUpdate=K,C.spotLights.needsUpdate=K,C.spotLightShadows.needsUpdate=K,C.rectAreaLights.needsUpdate=K,C.hemisphereLights.needsUpdate=K}function xn(C){return C.isMeshLambertMaterial||C.isMeshToonMaterial||C.isMeshPhongMaterial||C.isMeshStandardMaterial||C.isShadowMaterial||C.isShaderMaterial&&C.lights===!0}this.getActiveCubeFace=function(){return te},this.getActiveMipmapLevel=function(){return oe},this.getRenderTarget=function(){return V},this.setRenderTargetTextures=function(C,K,le){const ne=O.get(C);ne.__autoAllocateDepthBuffer=C.resolveDepthBuffer===!1,ne.__autoAllocateDepthBuffer===!1&&(ne.__useRenderToTexture=!1),O.get(C.texture).__webglTexture=K,O.get(C.depthTexture).__webglTexture=ne.__autoAllocateDepthBuffer?void 0:le,ne.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(C,K){const le=O.get(C);le.__webglFramebuffer=K,le.__useDefaultFramebuffer=K===void 0};const Ai=q.createFramebuffer();this.setRenderTarget=function(C,K=0,le=0){V=C,te=K,oe=le;let ne=null,ie=!1,He=!1;if(C){const ze=O.get(C);if(ze.__useDefaultFramebuffer!==void 0){Ie.bindFramebuffer(q.FRAMEBUFFER,ze.__webglFramebuffer),W.copy(C.viewport),ce.copy(C.scissor),ge=C.scissorTest,Ie.viewport(W),Ie.scissor(ce),Ie.setScissorTest(ge),L=-1;return}else if(ze.__webglFramebuffer===void 0)T.setupRenderTarget(C);else if(ze.__hasExternalTextures)T.rebindTextures(C,O.get(C.texture).__webglTexture,O.get(C.depthTexture).__webglTexture);else if(C.depthBuffer){const Qe=C.depthTexture;if(ze.__boundDepthTexture!==Qe){if(Qe!==null&&O.has(Qe)&&(C.width!==Qe.image.width||C.height!==Qe.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");T.setupDepthRenderbuffer(C)}}const qe=C.texture;(qe.isData3DTexture||qe.isDataArrayTexture||qe.isCompressedArrayTexture)&&(He=!0);const Ye=O.get(C).__webglFramebuffer;C.isWebGLCubeRenderTarget?(Array.isArray(Ye[K])?ne=Ye[K][le]:ne=Ye[K],ie=!0):C.samples>0&&T.useMultisampledRTT(C)===!1?ne=O.get(C).__webglMultisampledFramebuffer:Array.isArray(Ye)?ne=Ye[le]:ne=Ye,W.copy(C.viewport),ce.copy(C.scissor),ge=C.scissorTest}else W.copy(Ae).multiplyScalar(Ne).floor(),ce.copy(Ge).multiplyScalar(Ne).floor(),ge=Ze;if(le!==0&&(ne=Ai),Ie.bindFramebuffer(q.FRAMEBUFFER,ne)&&Ie.drawBuffers(C,ne),Ie.viewport(W),Ie.scissor(ce),Ie.setScissorTest(ge),ie){const ze=O.get(C.texture);q.framebufferTexture2D(q.FRAMEBUFFER,q.COLOR_ATTACHMENT0,q.TEXTURE_CUBE_MAP_POSITIVE_X+K,ze.__webglTexture,le)}else if(He){const ze=K;for(let qe=0;qe<C.textures.length;qe++){const Ye=O.get(C.textures[qe]);q.framebufferTextureLayer(q.FRAMEBUFFER,q.COLOR_ATTACHMENT0+qe,Ye.__webglTexture,le,ze)}}else if(C!==null&&le!==0){const ze=O.get(C.texture);q.framebufferTexture2D(q.FRAMEBUFFER,q.COLOR_ATTACHMENT0,q.TEXTURE_2D,ze.__webglTexture,le)}L=-1},this.readRenderTargetPixels=function(C,K,le,ne,ie,He,Xe,ze=0){if(!(C&&C.isWebGLRenderTarget)){Jt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let qe=O.get(C).__webglFramebuffer;if(C.isWebGLCubeRenderTarget&&Xe!==void 0&&(qe=qe[Xe]),qe){Ie.bindFramebuffer(q.FRAMEBUFFER,qe);try{const Ye=C.textures[ze],Qe=Ye.format,mt=Ye.type;if(C.textures.length>1&&q.readBuffer(q.COLOR_ATTACHMENT0+ze),!Et.textureFormatReadable(Qe)){Jt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Et.textureTypeReadable(mt)){Jt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}K>=0&&K<=C.width-ne&&le>=0&&le<=C.height-ie&&q.readPixels(K,le,ne,ie,j.convert(Qe),j.convert(mt),He)}finally{const Ye=V!==null?O.get(V).__webglFramebuffer:null;Ie.bindFramebuffer(q.FRAMEBUFFER,Ye)}}},this.readRenderTargetPixelsAsync=async function(C,K,le,ne,ie,He,Xe,ze=0){if(!(C&&C.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let qe=O.get(C).__webglFramebuffer;if(C.isWebGLCubeRenderTarget&&Xe!==void 0&&(qe=qe[Xe]),qe)if(K>=0&&K<=C.width-ne&&le>=0&&le<=C.height-ie){Ie.bindFramebuffer(q.FRAMEBUFFER,qe);const Ye=C.textures[ze],Qe=Ye.format,mt=Ye.type;if(C.textures.length>1&&q.readBuffer(q.COLOR_ATTACHMENT0+ze),!Et.textureFormatReadable(Qe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Et.textureTypeReadable(mt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Je=q.createBuffer();q.bindBuffer(q.PIXEL_PACK_BUFFER,Je),q.bufferData(q.PIXEL_PACK_BUFFER,He.byteLength,q.STREAM_READ),q.readPixels(K,le,ne,ie,j.convert(Qe),j.convert(mt),0);const It=V!==null?O.get(V).__webglFramebuffer:null;Ie.bindFramebuffer(q.FRAMEBUFFER,It);const Wt=q.fenceSync(q.SYNC_GPU_COMMANDS_COMPLETE,0);return q.flush(),await eT(q,Wt,4),q.bindBuffer(q.PIXEL_PACK_BUFFER,Je),q.getBufferSubData(q.PIXEL_PACK_BUFFER,0,He),q.deleteBuffer(Je),q.deleteSync(Wt),He}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(C,K=null,le=0){const ne=Math.pow(2,-le),ie=Math.floor(C.image.width*ne),He=Math.floor(C.image.height*ne),Xe=K!==null?K.x:0,ze=K!==null?K.y:0;T.setTexture2D(C,0),q.copyTexSubImage2D(q.TEXTURE_2D,le,0,0,Xe,ze,ie,He),Ie.unbindTexture()};const yn=q.createFramebuffer(),Ra=q.createFramebuffer();this.copyTextureToTexture=function(C,K,le=null,ne=null,ie=0,He=0){let Xe,ze,qe,Ye,Qe,mt,Je,It,Wt;const Bt=C.isCompressedTexture?C.mipmaps[He]:C.image;if(le!==null)Xe=le.max.x-le.min.x,ze=le.max.y-le.min.y,qe=le.isBox3?le.max.z-le.min.z:1,Ye=le.min.x,Qe=le.min.y,mt=le.isBox3?le.min.z:0;else{const sn=Math.pow(2,-ie);Xe=Math.floor(Bt.width*sn),ze=Math.floor(Bt.height*sn),C.isDataArrayTexture?qe=Bt.depth:C.isData3DTexture?qe=Math.floor(Bt.depth*sn):qe=1,Ye=0,Qe=0,mt=0}ne!==null?(Je=ne.x,It=ne.y,Wt=ne.z):(Je=0,It=0,Wt=0);const zt=j.convert(K.format),Nt=j.convert(K.type);let je;K.isData3DTexture?(T.setTexture3D(K,0),je=q.TEXTURE_3D):K.isDataArrayTexture||K.isCompressedArrayTexture?(T.setTexture2DArray(K,0),je=q.TEXTURE_2D_ARRAY):(T.setTexture2D(K,0),je=q.TEXTURE_2D),Ie.activeTexture(q.TEXTURE0),Ie.pixelStorei(q.UNPACK_FLIP_Y_WEBGL,K.flipY),Ie.pixelStorei(q.UNPACK_PREMULTIPLY_ALPHA_WEBGL,K.premultiplyAlpha),Ie.pixelStorei(q.UNPACK_ALIGNMENT,K.unpackAlignment);const ei=Ie.getParameter(q.UNPACK_ROW_LENGTH),Ut=Ie.getParameter(q.UNPACK_IMAGE_HEIGHT),Pn=Ie.getParameter(q.UNPACK_SKIP_PIXELS),jn=Ie.getParameter(q.UNPACK_SKIP_ROWS),ui=Ie.getParameter(q.UNPACK_SKIP_IMAGES);Ie.pixelStorei(q.UNPACK_ROW_LENGTH,Bt.width),Ie.pixelStorei(q.UNPACK_IMAGE_HEIGHT,Bt.height),Ie.pixelStorei(q.UNPACK_SKIP_PIXELS,Ye),Ie.pixelStorei(q.UNPACK_SKIP_ROWS,Qe),Ie.pixelStorei(q.UNPACK_SKIP_IMAGES,mt);const _i=C.isDataArrayTexture||C.isData3DTexture,Zt=K.isDataArrayTexture||K.isData3DTexture;if(C.isDepthTexture){const sn=O.get(C),vi=O.get(K),en=O.get(sn.__renderTarget),Zn=O.get(vi.__renderTarget);Ie.bindFramebuffer(q.READ_FRAMEBUFFER,en.__webglFramebuffer),Ie.bindFramebuffer(q.DRAW_FRAMEBUFFER,Zn.__webglFramebuffer);for(let wi=0;wi<qe;wi++)_i&&(q.framebufferTextureLayer(q.READ_FRAMEBUFFER,q.COLOR_ATTACHMENT0,O.get(C).__webglTexture,ie,mt+wi),q.framebufferTextureLayer(q.DRAW_FRAMEBUFFER,q.COLOR_ATTACHMENT0,O.get(K).__webglTexture,He,Wt+wi)),q.blitFramebuffer(Ye,Qe,Xe,ze,Je,It,Xe,ze,q.DEPTH_BUFFER_BIT,q.NEAREST);Ie.bindFramebuffer(q.READ_FRAMEBUFFER,null),Ie.bindFramebuffer(q.DRAW_FRAMEBUFFER,null)}else if(ie!==0||C.isRenderTargetTexture||O.has(C)){const sn=O.get(C),vi=O.get(K);Ie.bindFramebuffer(q.READ_FRAMEBUFFER,yn),Ie.bindFramebuffer(q.DRAW_FRAMEBUFFER,Ra);for(let en=0;en<qe;en++)_i?q.framebufferTextureLayer(q.READ_FRAMEBUFFER,q.COLOR_ATTACHMENT0,sn.__webglTexture,ie,mt+en):q.framebufferTexture2D(q.READ_FRAMEBUFFER,q.COLOR_ATTACHMENT0,q.TEXTURE_2D,sn.__webglTexture,ie),Zt?q.framebufferTextureLayer(q.DRAW_FRAMEBUFFER,q.COLOR_ATTACHMENT0,vi.__webglTexture,He,Wt+en):q.framebufferTexture2D(q.DRAW_FRAMEBUFFER,q.COLOR_ATTACHMENT0,q.TEXTURE_2D,vi.__webglTexture,He),ie!==0?q.blitFramebuffer(Ye,Qe,Xe,ze,Je,It,Xe,ze,q.COLOR_BUFFER_BIT,q.NEAREST):Zt?q.copyTexSubImage3D(je,He,Je,It,Wt+en,Ye,Qe,Xe,ze):q.copyTexSubImage2D(je,He,Je,It,Ye,Qe,Xe,ze);Ie.bindFramebuffer(q.READ_FRAMEBUFFER,null),Ie.bindFramebuffer(q.DRAW_FRAMEBUFFER,null)}else Zt?C.isDataTexture||C.isData3DTexture?q.texSubImage3D(je,He,Je,It,Wt,Xe,ze,qe,zt,Nt,Bt.data):K.isCompressedArrayTexture?q.compressedTexSubImage3D(je,He,Je,It,Wt,Xe,ze,qe,zt,Bt.data):q.texSubImage3D(je,He,Je,It,Wt,Xe,ze,qe,zt,Nt,Bt):C.isDataTexture?q.texSubImage2D(q.TEXTURE_2D,He,Je,It,Xe,ze,zt,Nt,Bt.data):C.isCompressedTexture?q.compressedTexSubImage2D(q.TEXTURE_2D,He,Je,It,Bt.width,Bt.height,zt,Bt.data):q.texSubImage2D(q.TEXTURE_2D,He,Je,It,Xe,ze,zt,Nt,Bt);Ie.pixelStorei(q.UNPACK_ROW_LENGTH,ei),Ie.pixelStorei(q.UNPACK_IMAGE_HEIGHT,Ut),Ie.pixelStorei(q.UNPACK_SKIP_PIXELS,Pn),Ie.pixelStorei(q.UNPACK_SKIP_ROWS,jn),Ie.pixelStorei(q.UNPACK_SKIP_IMAGES,ui),He===0&&K.generateMipmaps&&q.generateMipmap(je),Ie.unbindTexture()},this.initRenderTarget=function(C){O.get(C).__webglFramebuffer===void 0&&T.setupRenderTarget(C)},this.initTexture=function(C){C.isCubeTexture?T.setTextureCube(C,0):C.isData3DTexture?T.setTexture3D(C,0):C.isDataArrayTexture||C.isCompressedArrayTexture?T.setTexture2DArray(C,0):T.setTexture2D(C,0),Ie.unbindTexture()},this.resetState=function(){te=0,oe=0,V=null,Ie.reset(),Le.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Fa}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const i=this.getContext();i.drawingBufferColorSpace=$t._getDrawingBufferColorSpace(e),i.unpackColorSpace=$t._getUnpackColorSpace()}}const Lv={type:"change"},Mm={type:"start"},Ib={type:"end"},zu=new vb,Iv=new Zs,BC=Math.cos(70*iT.DEG2RAD),Yn=new ae,Ui=2*Math.PI,hn={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},op=1e-6;class zC extends HT{constructor(e,i=null){super(e,i),this.state=hn.NONE,this.target=new ae,this.cursor=new ae,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:zo.ROTATE,MIDDLE:zo.DOLLY,RIGHT:zo.PAN},this.touches={ONE:Bo.ROTATE,TWO:Bo.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle="auto",this._domElementKeyEvents=null,this._lastPosition=new ae,this._lastQuaternion=new nr,this._lastTargetPosition=new ae,this._quat=new nr().setFromUnitVectors(e.up,new ae(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new ov,this._sphericalDelta=new ov,this._scale=1,this._panOffset=new ae,this._rotateStart=new Dt,this._rotateEnd=new Dt,this._rotateDelta=new Dt,this._panStart=new Dt,this._panEnd=new Dt,this._panDelta=new Dt,this._dollyStart=new Dt,this._dollyEnd=new Dt,this._dollyDelta=new Dt,this._dollyDirection=new ae,this._mouse=new Dt,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=HC.bind(this),this._onPointerDown=GC.bind(this),this._onPointerUp=kC.bind(this),this._onContextMenu=$C.bind(this),this._onMouseWheel=XC.bind(this),this._onKeyDown=YC.bind(this),this._onTouchStart=WC.bind(this),this._onTouchMove=qC.bind(this),this._onMouseDown=VC.bind(this),this._onMouseMove=jC.bind(this),this._interceptControlDown=KC.bind(this),this._interceptControlUp=ZC.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(e){this._cursorStyle=e,e==="grab"?this.domElement.style.cursor="grab":this.domElement.style.cursor="auto"}get cursorStyle(){return this._cursorStyle}connect(e){super.connect(e),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction=""}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Lv),this.update(),this.state=hn.NONE}pan(e,i){this._pan(e,i),this.update()}dollyIn(e){this._dollyIn(e),this.update()}dollyOut(e){this._dollyOut(e),this.update()}rotateLeft(e){this._rotateLeft(e),this.update()}rotateUp(e){this._rotateUp(e),this.update()}update(e=null){const i=this.object.position;Yn.copy(i).sub(this.target),Yn.applyQuaternion(this._quat),this._spherical.setFromVector3(Yn),this.autoRotate&&this.state===hn.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let s=this.minAzimuthAngle,l=this.maxAzimuthAngle;isFinite(s)&&isFinite(l)&&(s<-Math.PI?s+=Ui:s>Math.PI&&(s-=Ui),l<-Math.PI?l+=Ui:l>Math.PI&&(l-=Ui),s<=l?this._spherical.theta=Math.max(s,Math.min(l,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(s+l)/2?Math.max(s,this._spherical.theta):Math.min(l,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let c=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const u=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),c=u!=this._spherical.radius}if(Yn.setFromSpherical(this._spherical),Yn.applyQuaternion(this._quatInverse),i.copy(this.target).add(Yn),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let u=null;if(this.object.isPerspectiveCamera){const h=Yn.length();u=this._clampDistance(h*this._scale);const m=h-u;this.object.position.addScaledVector(this._dollyDirection,m),this.object.updateMatrixWorld(),c=!!m}else if(this.object.isOrthographicCamera){const h=new ae(this._mouse.x,this._mouse.y,0);h.unproject(this.object);const m=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),c=m!==this.object.zoom;const p=new ae(this._mouse.x,this._mouse.y,0);p.unproject(this.object),this.object.position.sub(p).add(h),this.object.updateMatrixWorld(),u=Yn.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;u!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(u).add(this.object.position):(zu.origin.copy(this.object.position),zu.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(zu.direction))<BC?this.object.lookAt(this.target):(Iv.setFromNormalAndCoplanarPoint(this.object.up,this.target),zu.intersectPlane(Iv,this.target))))}else if(this.object.isOrthographicCamera){const u=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),u!==this.object.zoom&&(this.object.updateProjectionMatrix(),c=!0)}return this._scale=1,this._performCursorZoom=!1,c||this._lastPosition.distanceToSquared(this.object.position)>op||8*(1-this._lastQuaternion.dot(this.object.quaternion))>op||this._lastTargetPosition.distanceToSquared(this.target)>op?(this.dispatchEvent(Lv),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e!==null?Ui/60*this.autoRotateSpeed*e:Ui/60/60*this.autoRotateSpeed}_getZoomScale(e){const i=Math.abs(e*.01);return Math.pow(.95,this.zoomSpeed*i)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,i){Yn.setFromMatrixColumn(i,0),Yn.multiplyScalar(-e),this._panOffset.add(Yn)}_panUp(e,i){this.screenSpacePanning===!0?Yn.setFromMatrixColumn(i,1):(Yn.setFromMatrixColumn(i,0),Yn.crossVectors(this.object.up,Yn)),Yn.multiplyScalar(e),this._panOffset.add(Yn)}_pan(e,i){const s=this.domElement;if(this.object.isPerspectiveCamera){const l=this.object.position;Yn.copy(l).sub(this.target);let c=Yn.length();c*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*c/s.clientHeight,this.object.matrix),this._panUp(2*i*c/s.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/s.clientWidth,this.object.matrix),this._panUp(i*(this.object.top-this.object.bottom)/this.object.zoom/s.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(e,i){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const s=this.domElement.getBoundingClientRect(),l=e-s.left,c=i-s.top,u=s.width,h=s.height;this._mouse.x=l/u*2-1,this._mouse.y=-(c/h)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const i=this.domElement;this._rotateLeft(Ui*this._rotateDelta.x/i.clientHeight),this._rotateUp(Ui*this._rotateDelta.y/i.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let i=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(Ui*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),i=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-Ui*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),i=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(Ui*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),i=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-Ui*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),i=!0;break}i&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{const i=this._getSecondPointerPosition(e),s=.5*(e.pageX+i.x),l=.5*(e.pageY+i.y);this._rotateStart.set(s,l)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{const i=this._getSecondPointerPosition(e),s=.5*(e.pageX+i.x),l=.5*(e.pageY+i.y);this._panStart.set(s,l)}}_handleTouchStartDolly(e){const i=this._getSecondPointerPosition(e),s=e.pageX-i.x,l=e.pageY-i.y,c=Math.sqrt(s*s+l*l);this._dollyStart.set(0,c)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{const s=this._getSecondPointerPosition(e),l=.5*(e.pageX+s.x),c=.5*(e.pageY+s.y);this._rotateEnd.set(l,c)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const i=this.domElement;this._rotateLeft(Ui*this._rotateDelta.x/i.clientHeight),this._rotateUp(Ui*this._rotateDelta.y/i.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{const i=this._getSecondPointerPosition(e),s=.5*(e.pageX+i.x),l=.5*(e.pageY+i.y);this._panEnd.set(s,l)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){const i=this._getSecondPointerPosition(e),s=e.pageX-i.x,l=e.pageY-i.y,c=Math.sqrt(s*s+l*l);this._dollyEnd.set(0,c),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const u=(e.pageX+i.x)*.5,h=(e.pageY+i.y)*.5;this._updateZoomParameters(u,h)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let i=0;i<this._pointers.length;i++)if(this._pointers[i]==e.pointerId){this._pointers.splice(i,1);return}}_isTrackingPointer(e){for(let i=0;i<this._pointers.length;i++)if(this._pointers[i]==e.pointerId)return!0;return!1}_trackPointer(e){let i=this._pointerPositions[e.pointerId];i===void 0&&(i=new Dt,this._pointerPositions[e.pointerId]=i),i.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){const i=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[i]}_customWheelEvent(e){const i=e.deltaMode,s={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(i){case 1:s.deltaY*=16;break;case 2:s.deltaY*=100;break}return e.ctrlKey&&!this._controlActive&&(s.deltaY*=10),s}}function GC(r){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(r.pointerId),this.domElement.ownerDocument.addEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(r)&&(this._addPointer(r),r.pointerType==="touch"?this._onTouchStart(r):this._onMouseDown(r),this._cursorStyle==="grab"&&(this.domElement.style.cursor="grabbing")))}function HC(r){this.enabled!==!1&&(r.pointerType==="touch"?this._onTouchMove(r):this._onMouseMove(r))}function kC(r){switch(this._removePointer(r),this._pointers.length){case 0:this.domElement.releasePointerCapture(r.pointerId),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(Ib),this.state=hn.NONE,this._cursorStyle==="grab"&&(this.domElement.style.cursor="grab");break;case 1:const e=this._pointers[0],i=this._pointerPositions[e];this._onTouchStart({pointerId:e,pageX:i.x,pageY:i.y});break}}function VC(r){let e;switch(r.button){case 0:e=this.mouseButtons.LEFT;break;case 1:e=this.mouseButtons.MIDDLE;break;case 2:e=this.mouseButtons.RIGHT;break;default:e=-1}switch(e){case zo.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(r),this.state=hn.DOLLY;break;case zo.ROTATE:if(r.ctrlKey||r.metaKey||r.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(r),this.state=hn.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(r),this.state=hn.ROTATE}break;case zo.PAN:if(r.ctrlKey||r.metaKey||r.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(r),this.state=hn.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(r),this.state=hn.PAN}break;default:this.state=hn.NONE}this.state!==hn.NONE&&this.dispatchEvent(Mm)}function jC(r){switch(this.state){case hn.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(r);break;case hn.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(r);break;case hn.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(r);break}}function XC(r){this.enabled===!1||this.enableZoom===!1||this.state!==hn.NONE||(r.preventDefault(),this.dispatchEvent(Mm),this._handleMouseWheel(this._customWheelEvent(r)),this.dispatchEvent(Ib))}function YC(r){this.enabled!==!1&&this._handleKeyDown(r)}function WC(r){switch(this._trackPointer(r),this._pointers.length){case 1:switch(this.touches.ONE){case Bo.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(r),this.state=hn.TOUCH_ROTATE;break;case Bo.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(r),this.state=hn.TOUCH_PAN;break;default:this.state=hn.NONE}break;case 2:switch(this.touches.TWO){case Bo.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(r),this.state=hn.TOUCH_DOLLY_PAN;break;case Bo.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(r),this.state=hn.TOUCH_DOLLY_ROTATE;break;default:this.state=hn.NONE}break;default:this.state=hn.NONE}this.state!==hn.NONE&&this.dispatchEvent(Mm)}function qC(r){switch(this._trackPointer(r),this.state){case hn.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(r),this.update();break;case hn.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(r),this.update();break;case hn.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(r),this.update();break;case hn.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(r),this.update();break;default:this.state=hn.NONE}}function $C(r){this.enabled!==!1&&r.preventDefault()}function KC(r){r.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function ZC(r){r.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}const Ub=({imageSrc:r,height:e=200})=>{const i=Re.useRef(null),[s,l]=Uv.useState(!1);return Re.useEffect(()=>{if(!i.current||!r||s)return;const c=i.current,u=new xT,h=75,m=c.clientWidth/c.clientHeight,p=new pa(h,m,.1,1100);p.position.set(0,0,.1);let x;try{x=new FC({antialias:!0})}catch(D){console.error("WebGL Context creation failed:",D),l(!0);return}x.setSize(c.clientWidth,c.clientHeight),x.setPixelRatio(Math.min(window.devicePixelRatio,2)),c.appendChild(x.domElement);const v=new zC(p,x.domElement);v.enableDamping=!0,v.dampingFactor=.08,v.rotateSpeed=-.3,v.enableZoom=!1,v.enablePan=!1,v.autoRotate=!1;const g=new BT;let b=null;g.load(r,D=>{D.mapping=Vu,D.colorSpace=Zi;const U=new Sm(500,60,40);U.scale(-1,1,1);const G=new ym({map:D});b=new ka(U,G),u.add(b)});let M=h;const A=D=>{D.preventDefault();const U=D.deltaY>0?5:-5;M=Math.max(30,Math.min(120,M+U)),p.fov=M,p.updateProjectionMatrix()};c.addEventListener("wheel",A,{passive:!1});const S=new ResizeObserver(()=>{c.clientWidth===0||c.clientHeight===0||(p.aspect=c.clientWidth/c.clientHeight,p.updateProjectionMatrix(),x.setSize(c.clientWidth,c.clientHeight))});S.observe(c);let y=null;const R=()=>{y=requestAnimationFrame(R),v.update(),x.render(u,p)};return R(),()=>{cancelAnimationFrame(y),S.disconnect(),c.removeEventListener("wheel",A),b&&(b.geometry.dispose(),b.material.dispose()),x&&(x.dispose(),x.forceContextLoss(),c.contains(x.domElement)&&c.removeChild(x.domElement))}},[r]),_.jsx("div",{ref:i,style:{width:"100%",height:e+"px",cursor:"grab",borderRadius:"8px",overflow:"hidden",position:"relative"},onMouseDown:c=>c.currentTarget.style.cursor="grabbing",onMouseUp:c=>c.currentTarget.style.cursor="grab",onMouseLeave:c=>c.currentTarget.style.cursor="grab",children:s&&_.jsx("img",{src:r,alt:"360 Panorama Fallback",style:{width:"100%",height:"100%",objectFit:"cover"}})})};function QC({step2Ref:r,currentStep:e,isAnalyzing:i,inputMode:s,setInputMode:l,targetDate:c,setTargetDate:u,categories:h,toggleCategory:m,manualTopic:p,setManualTopic:x,bg360Image:v,bg360Enabled:g,setBg360Enabled:b,bg360Analysis:M,is360Analyzing:A,customLocation:S,setCustomLocation:y,customOutfit:R,setCustomOutfit:D,punchlineType:U,setPunchlineType:G,isSearching:I,generateScenarioFromNews:B,scenarioThought:w,scenario:F,setScenario:$,isScenarioCopied:k,setIsScenarioCopied:X,originalScenario:te,isEnhancePanelOpen:oe,setIsEnhancePanelOpen:V,enhanceExpressions:L,setEnhanceExpressions:z,enhanceBodyLang:W,setEnhanceBodyLang:ce,enhanceEffects:ge,setEnhanceEffects:P,enhanceBackgrounds:Z,setEnhanceBackgrounds:_e,enhanceCameraWork:Te,setEnhanceCameraWork:Ne,enhanceDialogue:ee,setEnhanceDialogue:Ee,isEnhancing:Ae,enhanceScenario:Ge,revertScenario:Ze,enhanceLog:Ke,showStatus:wt,styleJson:ft}){return _.jsxs("section",{ref:r,className:`relative p-8 rounded-xl bg-[#0f1115] border flex flex-col space-y-6 shadow-xl transition-all duration-300
